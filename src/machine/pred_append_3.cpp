...
std::string pred_append_3::string0 = (std::string("cut")).intern();
std::string pred_append_3::string1 = (std::string(".")).intern();
std::string pred_append_3::string2 = (std::string("[]")).intern();
std::string pred_append_3::string3 = (std::string("append")).intern();
std::string pred_append_3::string4 = (std::string("call")).intern();
