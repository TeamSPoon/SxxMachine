#include "pred_termequal_2.h"

Code* pred_termequal_2::entry_code;
Code* pred_termequal_2::cl1 = new pred_termequal_2_1();
Code* pred_termequal_2::compare4cont;
std::string pred_termequal_2::string0 = (std::string("cut")).intern();
std::string pred_termequal_2::string1 = (std::string("=")).intern();
std::string pred_termequal_2::string2 = (std::string("compare")).intern();
std::string pred_termequal_2::string3 = (std::string("termequal")).intern();
