#include "pred_termgreaterthan_2.h"
...
std::string pred_termgreaterthan_2::string0 = (std::string("cut")).intern();
std::string pred_termgreaterthan_2::string1 = (std::string(">")).intern();
std::string pred_termgreaterthan_2::string2 = (std::string("compare")).intern();
std::string pred_termgreaterthan_2::string3 = (std::string("termgreaterthan")).intern();
