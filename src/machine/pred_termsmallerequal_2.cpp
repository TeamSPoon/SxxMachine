#include "pred_termsmallerequal_2.h"
...
std::string pred_termsmallerequal_2::string0 = (std::string("cut")).intern();
std::string pred_termsmallerequal_2::string1 = (std::string("compare")).intern();
std::string pred_termsmallerequal_2::string2 = (std::string("smeq")).intern();
std::string pred_termsmallerequal_2::string3 = (std::string("termsmallerequal")).intern();
