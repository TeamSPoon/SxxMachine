#include "pred_smgr_1.h"

Code* pred_smgr_1::entry_code;
Code* pred_smgr_1::cl1 = new pred_smgr_1_1();
Code* pred_smgr_1::cl2 = new pred_smgr_1_2();
Code* pred_smgr_1::cut2cont;
std::string pred_smgr_1::string0 = (std::string("cut")).intern();
std::string pred_smgr_1::string1 = (std::string("=")).intern();
std::string pred_smgr_1::string2 = (std::string(">")).intern();
std::string pred_smgr_1::string3 = (std::string("call")).intern();
std::string pred_smgr_1::string4 = (std::string("cut")).intern();
std::string pred_smgr_1::string5 = (std::string("smgr")).intern();
