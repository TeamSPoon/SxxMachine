...
Operation* const  reducer::reg_top_0 = PredTable::Register("top",0, new SxxMachine::sxx_library::pred_top_0());
Operation* const  reducer::reg_try_2 = PredTable::Register("try",2, new pred_try_2());
Operation* const  reducer::reg_end_1 = PredTable::Register("end",1, new pred_end_1());
Operation* const  reducer::reg_list_functor_name_1 = PredTable::Register("list_functor_name",1, new pred_list_functor_name_1());
Operation* const  reducer::reg_t_def_3 = PredTable::Register("t_def",3, new pred_t_def_3());
Operation* const  reducer::reg_t_reduce_2 = PredTable::Register("t_reduce",2, new pred_t_reduce_2());
Operation* const  reducer::reg_t_append_4 = PredTable::Register("t_append",4, new pred_t_append_4());
Operation* const  reducer::reg_t_redex_2 = PredTable::Register("t_redex",2, new pred_t_redex_2());
Operation* const  reducer::reg_eval_4 = PredTable::Register("eval",4, new pred_eval_4());
Operation* const  reducer::reg_eval1_3 = PredTable::Register("eval1",3, new pred_eval1_3());
Operation* const  reducer::reg_relop_3 = PredTable::Register("relop",3, new pred_relop_3());
Operation* const  reducer::reg_t_3 = PredTable::Register("t",3, new pred_t_3());
Operation* const  reducer::reg_t_argvars_3 = PredTable::Register("t_argvars",3, new pred_t_argvars_3());
Operation* const  reducer::reg_curry_2 = PredTable::Register("curry",2, new pred_curry_2());
Operation* const  reducer::reg_currylist_3 = PredTable::Register("currylist",3, new pred_currylist_3());
Operation* const  reducer::reg_t_vars_2 = PredTable::Register("t_vars",2, new pred_t_vars_2());
Operation* const  reducer::reg_t_trans_4 = PredTable::Register("t_trans",4, new pred_t_trans_4());
Operation* const  reducer::reg_t_rule1_8 = PredTable::Register("t_rule1",8, new pred_t_rule1_8());
Operation* const  reducer::reg_t_rule2_9 = PredTable::Register("t_rule2",9, new pred_t_rule2_9());
Operation* const  reducer::reg_make_list_2 = PredTable::Register("make_list",2, new pred_make_list_2());
Operation* const  reducer::reg_listify_2 = PredTable::Register("listify",2, new pred_listify_2());
Operation* const  reducer::reg_listify_list_4 = PredTable::Register("listify_list",4, new pred_listify_list_4());
Operation* const  reducer::reg_member_2 = PredTable::Register("member",2, new pred_member_2());
Operation* const  reducer::reg_append_3 = PredTable::Register("append",3, new SxxMachine::sxx_library::pred_append_3());
Operation* const  reducer::reg_intersectv_3 = PredTable::Register("intersectv",3, new pred_intersectv_3());
Operation* const  reducer::reg_intersectv_2_4 = PredTable::Register("intersectv_2",4, new pred_intersectv_2_4());
Operation* const  reducer::reg_intersectv_3_6 = PredTable::Register("intersectv_3",6, new pred_intersectv_3_6());
Operation* const  reducer::reg_intersectv_list_2 = PredTable::Register("intersectv_list",2, new pred_intersectv_list_2());
Operation* const  reducer::reg_$002D$002D$003E_2 = PredTable::Register("-->",2, new SxxMachine::Builtins::pred_$002D$002D$003E_2());
Operation* const  reducer::reg_diffv_3 = PredTable::Register("diffv",3, new pred_diffv_3());
Operation* const  reducer::reg_diffv_2_4 = PredTable::Register("diffv_2",4, new pred_diffv_2_4());
Operation* const  reducer::reg_diffv_3_6 = PredTable::Register("diffv_3",6, new pred_diffv_3_6());
Operation* const  reducer::reg_unionv_3 = PredTable::Register("unionv",3, new pred_unionv_3());
Operation* const  reducer::reg_unionv_2_4 = PredTable::Register("unionv_2",4, new pred_unionv_2_4());
Operation* const  reducer::reg_unionv_3_6 = PredTable::Register("unionv_3",6, new pred_unionv_3_6());
Operation* const  reducer::reg_subsetv_2 = PredTable::Register("subsetv",2, new pred_subsetv_2());
Operation* const  reducer::reg_subsetv_2_4 = PredTable::Register("subsetv_2",4, new pred_subsetv_2_4());
Operation* const  reducer::reg_small_subsetv_2 = PredTable::Register("small_subsetv",2, new pred_small_subsetv_2());
Operation* const  reducer::reg_inv_2 = PredTable::Register("inv",2, new pred_inv_2());
Operation* const  reducer::reg_inv_2_3 = PredTable::Register("inv_2",3, new pred_inv_2_3());
Operation* const  reducer::reg_notinv_2 = PredTable::Register("notinv",2, new pred_notinv_2());
Operation* const  reducer::reg_notinv_2_2 = PredTable::Register("notinv_2",2, new pred_notinv_2_2());
Operation* const  reducer::reg_notinv_3_3 = PredTable::Register("notinv_3",3, new pred_notinv_3_3());
	...
	mach->CUTB = mach->CurrentChoice;
	return static_cast<Operation*>(reducer::s_atom->FindProc(1));
	}
	...
	mach->CUTB = mach->CurrentChoice;
	return static_cast<Operation*>(reducer::s_functor->FindProc(3));
	}
	...
	Term* areg0 = local_aregs[0]->Deref();
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s_fac,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7,var1,Const::Nil),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(reducer::s_cond,Data::F(reducer::s11, { var1->Deref(), reducer::posint0 }),reducer::posint1,Data::F(reducer::s1, { var1->Deref(), Data::F(reducer::s_fac,Data::F(reducer::s4, { var1->Deref(), reducer::posint1 })) })),mach))) {
		return Prolog::Fail0;
	}
	...
	Term* areg0 = local_aregs[0]->Deref();
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s_quick,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7,var1,Const::Nil),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(reducer::s_cond,Data::F(reducer::s11, { var1->Deref(), Const::Nil }),Const::Nil,Data::F(reducer::s_cond,Data::F(reducer::s11,Data::F(reducer::s_tl, { var1->Deref() }),Const::Nil),var1->Deref(),Data::F(reducer::s_quick2,Data::F(reducer::s_split,Data::F(reducer::s_hd, { var1->Deref() }),Data::F(reducer::s_tl, { var1->Deref() }))))),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Term* areg0 = local_aregs[0]->Deref();
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s_quick2,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7,var1,Const::Nil),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(reducer::s_append,Data::F(reducer::s_quick,Data::F(reducer::s_hd, { var1->Deref() })),Data::F(reducer::s_quick,Data::F(reducer::s_tl, { var1->Deref() }))),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s_split,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7,var1,Data::F(reducer::s7,var2,Const::Nil)),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(reducer::s_cond,Data::F(reducer::s11, { var2->Deref(), Const::Nil }),Data::F(reducer::s7,Data::F(reducer::s7, { var1->Deref(), Const::Nil }),Const::Nil),Data::F(reducer::s_cond,Data::F(reducer::s13,Data::F(reducer::s_hd, { var2->Deref() }),var1->Deref()),Data::F(reducer::s_inserthead,Data::F(reducer::s_hd, { var2->Deref() }),Data::F(reducer::s_split, { var1->Deref(), Data::F(reducer::s_tl, { var2->Deref() }) })),Data::F(reducer::s_inserttail,Data::F(reducer::s_hd, { var2->Deref() }),Data::F(reducer::s_split, { var1->Deref(), Data::F(reducer::s_tl, { var2->Deref() }) })))),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s_inserthead,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7,var1,Data::F(reducer::s7,var2,Const::Nil)),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(reducer::s7,Data::F(reducer::s7, { var1->Deref(), Data::F(reducer::s_hd, { var2->Deref() }) }),Data::F(reducer::s_tl, { var2->Deref() })),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s_inserttail,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7,var1,Data::F(reducer::s7,var2,Const::Nil)),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(reducer::s7,Data::F(reducer::s_hd, { var2->Deref() }),Data::F(reducer::s7, { var1->Deref(), Data::F(reducer::s_tl, { var2->Deref() }) })),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s_append,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7,var1,Data::F(reducer::s7,var2,Const::Nil)),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(reducer::s_cond,Data::F(reducer::s11, { var1->Deref(), Const::Nil }),var2->Deref(),Data::F(reducer::s7,Data::F(reducer::s_hd, { var1->Deref() }),Data::F(reducer::s_append,Data::F(reducer::s_tl, { var1->Deref() }),var2->Deref()))),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	return static_cast<Operation*>(reducer::s_atomic->FindProc(1));
	}
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,Data::F(reducer::s7,var2,var3)),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7,var4,Data::F(reducer::s7,var5,var3->Deref())),mach))) {
		return Prolog::Fail0;
	}
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,var2),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg3)->Unify(Data::F(reducer::s7, { var1->Deref(), var5 }),mach))) {
		return Prolog::Fail0;
	}
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,Data::F(reducer::s7,var2,Data::F(reducer::s7,var3,Data::F(reducer::s7,var4,reducer::s_sp)))),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7,Data::F(reducer::s7,var5,var2->Deref()),Data::F(reducer::s7,Data::F(reducer::s7, { var5->Deref(), var3->Deref() }),var4->Deref())),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,Data::F(reducer::s7,var2,Data::F(reducer::s7,var3,Data::F(reducer::s7,var4,reducer::s_bp)))),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7,Data::F(reducer::s7, { var1->Deref(), var2->Deref() }),Data::F(reducer::s7, { var3->Deref(), var4->Deref() })),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,Data::F(reducer::s7,var2,Data::F(reducer::s7,var3,Data::F(reducer::s7,var4,reducer::s_cp)))),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7, { var2->Deref(), Data::F(reducer::s7,Data::F(reducer::s7, { var1->Deref(), var3->Deref() }),var4->Deref()) }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,Data::F(reducer::s7,var2,Data::F(reducer::s7,var3,reducer::s_s))),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7,Data::F(reducer::s7,var4,var2->Deref()),Data::F(reducer::s7, { var4->Deref(), var3->Deref() })),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,Data::F(reducer::s7,var2,Data::F(reducer::s7,var3,reducer::s_b))),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7,Data::F(reducer::s7, { var1->Deref(), var2->Deref() }),var3->Deref()),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,Data::F(reducer::s7,var2,Data::F(reducer::s7,var3,reducer::s_c))),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7, { var2->Deref(), Data::F(reducer::s7, { var1->Deref(), var3->Deref() }) }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,Data::F(reducer::s7,var2,reducer::s_k)),mach))) {
		return Prolog::Fail0;
	}
	...
	Term* areg0 = local_aregs[0]->Deref();
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,reducer::s_i),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1->Deref(),mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,Data::F(reducer::s7,var2,Data::F(reducer::s7,var3,reducer::s_cond))),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var2->Deref(),mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,reducer::s_apply),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var2,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,reducer::s_hd),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var2,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,reducer::s_tl),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var2,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,Data::F(reducer::s7,var2,reducer::s11)),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var3,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s2,mach))) {
		return Prolog::Fail0;
	}
	...
	return static_cast<Operation*>(reducer::s_is->FindProc(2));
	}
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s4,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s1,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s8,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s_mod,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s10,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s15,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s13,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s16,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s14,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	mach->CUTB = mach->CurrentChoice;
	local_aregs[3] = nullptr;
	return static_cast<Operation*>(reducer::s14->FindProc(2));
	}
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s12,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	if(!((areg1)->Unify(Data::F(reducer::s7,Data::F(reducer::s7, { var1->Deref(), Const::Nil }),Const::Nil),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = mach->HC(continuation);
	mach->CUTB = mach->CurrentChoice;
	local_aregs[2] = nullptr;
	return static_cast<Operation*>(reducer::s_var->FindProc(1));
	}
	...
	if(!((areg1)->Unify(Data::F(reducer::s7, { Const::Nil, Const::Nil }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = mach->HC(continuation);
	...
	Term* areg0 = local_aregs[0]->Deref();
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s7,var1,Const::Nil),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s7, { Const::Nil, Const::Nil }),mach))) {
		return Prolog::Fail0;
	...
	if(!((areg1)->Unify(Data::F(reducer::s7,var3,Data::F(reducer::s7,Data::F(reducer::s7,var4,var5),Data::F(reducer::s7,Data::F(reducer::s7,var6,var7),Const::Nil))),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	...
	if(!((areg3)->Unify(Data::F(reducer::s7, { var2->Deref(), reducer::s_k }),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg3)->Unify(reducer::s_i,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var2->Deref();
	...
	if(!((areg2)->Unify(Data::F(reducer::s7,var3,var4),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg3)->Unify(Data::F(reducer::s7, { var2->Deref(), reducer::s_k }),mach))) {
		return Prolog::Fail0;
	...
	if(!((areg1)->Unify(Data::F(reducer::s7,var2,var3),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(reducer::s7,var4,Data::F(reducer::s7,var5,Data::F(reducer::s7,var6,Const::Nil))),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg1)->Unify(Data::F(reducer::s7,var2,Data::F(reducer::s7,var3,var4)),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(reducer::s7,var5,Data::F(reducer::s7,var6,Data::F(reducer::s7,var7,Const::Nil))),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg3)->Unify(var8,mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg7)->Unify(var2->Deref(),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var3->Deref();
	...
	if(!((areg7)->Unify(Data::F(reducer::s7,var8,Data::F(reducer::s7, { var2->Deref(), reducer::s_b })),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var3->Deref();
	...
	if(!((areg7)->Unify(Data::F(reducer::s7, { var5->Deref(), Data::F(reducer::s7,var8,reducer::s_c) }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var6->Deref();
	...
	if(!((areg7)->Unify(Data::F(reducer::s7,var8,Data::F(reducer::s7,var9,reducer::s_s)),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var2->Deref();
	...
	if(!((areg8)->Unify(Data::F(reducer::s7, { var6->Deref(), Data::F(reducer::s7, { var2->Deref(), reducer::s_c }) }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var3->Deref();
	...
	if(!((areg8)->Unify(Data::F(reducer::s7,var9,Data::F(reducer::s7, { var2->Deref(), reducer::s_s })),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var3->Deref();
	...
	if(!((areg8)->Unify(Data::F(reducer::s7, { var6->Deref(), Data::F(reducer::s7,var9,Data::F(reducer::s7, { var2->Deref(), reducer::s_cp })) }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var4->Deref();
	...
	if(!((areg8)->Unify(Data::F(reducer::s7,var9,Data::F(reducer::s7,var10,Data::F(reducer::s7, { var2->Deref(), reducer::s_sp }))),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var4->Deref();
	...
	if(!((areg8)->Unify(Data::F(reducer::s7, { var3->Deref(), var2->Deref() }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var6->Deref();
	...
	if(!((areg8)->Unify(Data::F(reducer::s7,var9,Data::F(reducer::s7, { var3->Deref(), Data::F(reducer::s7, { var2->Deref(), reducer::s_bp }) })),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var6->Deref();
	...
	if(!((areg1)->Unify(Data::F(reducer::s7, { var2->Deref(), var4 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var3->Deref();
	...
	if(!((areg3)->Unify(Data::F(reducer::s7,var4,var5),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var2->Deref();
	...
	if(!((areg1)->Unify(Data::F(reducer::s7, { var1->Deref(), var2 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(Data::F(reducer::s7, { var1->Deref(), var4 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var2->Deref();
	local_aregs[1] = var3->Deref();
	...
	return static_cast<Operation*>(reducer::s_compare->FindProc(3));
	}
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(reducer::s11,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	if(!((areg5)->Unify(Data::F(reducer::s7, { var1->Deref(), var5 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var2->Deref();
	local_aregs[1] = var4->Deref();
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(Data::F(reducer::s_intersectv_list, { Const::Nil }),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Const::Nil,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(reducer::s_intersectv_list,Data::F(reducer::s7,var1,var2)),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(reducer::s3,Data::F(reducer::s_intersectv, { var1->Deref() }),Data::F(reducer::s_intersectv_list, { var2->Deref() })),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg3)->Unify(Data::F(reducer::s7, { var1->Deref(), var2->Deref() }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg5)->Unify(Data::F(reducer::s7, { var3->Deref(), var5 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var4->Deref();
	local_aregs[1] = var1->Deref();
	...
	if(!((areg1)->Unify(Data::F(reducer::s7,var3,var4),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var5;
	local_aregs[1] = var1->Deref();
