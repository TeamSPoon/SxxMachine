...
Operation* const  zebra::reg_top_0 = PredTable::Register("top",0, new SxxMachine::sxx_library::pred_top_0());
Operation* const  zebra::reg_houses_1 = PredTable::Register("houses",1, new pred_houses_1());
Operation* const  zebra::reg_right_of_3 = PredTable::Register("right_of",3, new pred_right_of_3());
Operation* const  zebra::reg_next_to_3 = PredTable::Register("next_to",3, new pred_next_to_3());
Operation* const  zebra::reg_member_2 = PredTable::Register("member",2, new pred_member_2());
Operation* const  zebra::reg_print_houses_1 = PredTable::Register("print_houses",1, new pred_print_houses_1());
	...
	if(!((areg2)->Unify(Data::F(zebra::s1, { var2->Deref(), Data::F(zebra::s1, { var1->Deref(), var3 }) }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(Data::F(zebra::s1,var3,var4),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg2)->Unify(Data::F(zebra::s1, { var1->Deref(), Data::F(zebra::s1, { var2->Deref(), var3 }) }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg1)->Unify(Data::F(zebra::s1, { var1->Deref(), var2 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg1)->Unify(Data::F(zebra::s1,var2,var3),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(zebra::s1,var1,var2),mach))) {
		return Prolog::Fail0;
	}
