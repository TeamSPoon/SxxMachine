...
const Operation mu::reg_top_0 = PredTable::Register("top", 0, new SxxMachine::sxx_library::pred_top_0());
const Operation mu::reg_mu_0 = PredTable::Register("mu", 0, new pred_mu_0());
const Operation mu::reg_theorem_3 = PredTable::Register("theorem", 3, new pred_theorem_3());
const Operation mu::reg_rule_3 = PredTable::Register("rule", 3, new pred_rule_3());
const Operation mu::reg_rule1_2 = PredTable::Register("rule1", 2, new pred_rule1_2());
const Operation mu::reg_rule2_2 = PredTable::Register("rule2", 2, new pred_rule2_2());
const Operation mu::reg_rule3_2 = PredTable::Register("rule3", 2, new pred_rule3_2());
const Operation mu::reg_rule4_2 = PredTable::Register("rule4", 2, new pred_rule4_2());
const Operation mu::reg_append_3 = PredTable::Register("append", 3, new SxxMachine::sxx_library::pred_append_3());
	...
	Operation mu::pred_theorem_3::exec_pred_theorem_3__1(Prolog* mach) {
		...
		if(!((areg2)->Unify(Data::F(mu::s2, Data::F(mu::s2, mu::s_a, Data::F(mu::s2, mu::s_m, Data::F(mu::s2, mu::s_i, Const::Nil))), Const::Nil)))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
