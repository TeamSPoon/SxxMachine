...
Operation* const  poly_10::reg_on_load_poly_10_0 = PredTable::Register("on_load_poly_10",0, new pred_on_load_poly_10_0());
Operation* const  poly_10::reg_top_0 = PredTable::Register("top",0, new SxxMachine::sxx_library::pred_top_0());
Operation* const  poly_10::reg_poly_10_0 = PredTable::Register("poly_10",0, new pred_poly_10_0());
Operation* const  poly_10::reg_test_poly_1 = PredTable::Register("test_poly",1, new pred_test_poly_1());
Operation* const  poly_10::reg_less_than_2 = PredTable::Register("less_than",2, new pred_less_than_2());
Operation* const  poly_10::reg_poly_add_3 = PredTable::Register("poly_add",3, new pred_poly_add_3());
Operation* const  poly_10::reg_term_add_3 = PredTable::Register("term_add",3, new pred_term_add_3());
Operation* const  poly_10::reg_add_to_order_zero_term_3 = PredTable::Register("add_to_order_zero_term",3, new pred_add_to_order_zero_term_3());
Operation* const  poly_10::reg_poly_exp_3 = PredTable::Register("poly_exp",3, new pred_poly_exp_3());
Operation* const  poly_10::reg_poly_mul_3 = PredTable::Register("poly_mul",3, new pred_poly_mul_3());
Operation* const  poly_10::reg_term_mul_3 = PredTable::Register("term_mul",3, new pred_term_mul_3());
Operation* const  poly_10::reg_single_term_mul_3 = PredTable::Register("single_term_mul",3, new pred_single_term_mul_3());
Operation* const  poly_10::reg_mul_through_3 = PredTable::Register("mul_through",3, new pred_mul_through_3());
	...
	return static_cast<Operation*>(poly_10::s_write->FindProc(1));
	}
	...
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(poly_10::s_x,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(poly_10::s_y,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(poly_10::s_y,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(poly_10::s_z,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(poly_10::s_poly,var1,var2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(poly_10::s_poly, { var1->Deref(), var3 }),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(poly_10::s_poly, { var1->Deref(), var4 }),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg1)->Unify(Data::F(poly_10::s_poly,var3,var4),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(poly_10::s_poly, { var1->Deref(), var5 }),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg1)->Unify(Data::F(poly_10::s_poly,var2,var3),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(poly_10::s_poly, { var2->Deref(), var4 }),mach))) {
		return Prolog::Fail0;
	}
	mach->DoCut(mach->CUTB);
	...
	mach->CUTB = mach->CurrentChoice;
	local_aregs[3] = nullptr;
	return static_cast<Operation*>(poly_10::s_is->FindProc(2));
	}
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(poly_10::s4,Data::F(poly_10::s_term,var1,var2),var3),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(poly_10::s4,Data::F(poly_10::s_term, { var1->Deref(), var4 }),var5),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(poly_10::s4,Data::F(poly_10::s_term, { var1->Deref(), var6 }),var7),mach))) {
		return Prolog::Fail0;
	}
	mach->DoCut(mach->CUTB);
	...
	if(!((areg1)->Unify(Data::F(poly_10::s4,Data::F(poly_10::s_term,var4,var5),var6),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(poly_10::s4,Data::F(poly_10::s_term, { var1->Deref(), var2->Deref() }),var7),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	...
	if(!((areg1)->Unify(Data::F(poly_10::s4,Data::F(poly_10::s_term,var2,var3),var4),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(poly_10::s4,Data::F(poly_10::s_term, { var2->Deref(), var3->Deref() }),var5),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var4->Deref();
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(poly_10::s4,Data::F(poly_10::s_term,poly_10::posint0,var1),var2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var3,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(poly_10::s4,Data::F(poly_10::s_term,poly_10::posint0,var4),var2->Deref()),mach))) {
		return Prolog::Fail0;
	}
	mach->DoCut(mach->CUTB);
	...
	if(!((areg2)->Unify(Data::F(poly_10::s4,Data::F(poly_10::s_term,poly_10::posint0,var2->Deref()),var1->Deref()),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Term* areg0 = local_aregs[0]->Deref();
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(poly_10::posint0,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(poly_10::posint1,mach))) {
		return Prolog::Fail0;
	}
	mach->DoCut(mach->CUTB);
	local_aregs[0] = continuation;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(poly_10::s4,var1,var2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var3,mach))) {
		return Prolog::Fail0;
	...
	if(!((areg1)->Unify(Data::F(poly_10::s_term,var4,var5),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(poly_10::s4,Data::F(poly_10::s_term,var6,var7),var8),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg2)->Unify(Data::F(poly_10::s4,Data::F(poly_10::s_term, { var1->Deref(), var5 }),var6),mach))) {
		return Prolog::Fail0;
	}
