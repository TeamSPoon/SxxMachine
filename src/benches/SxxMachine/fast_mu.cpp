...
Operation* const  fast_mu::reg_top_0 = PredTable::Register("top",0, new SxxMachine::sxx_library::pred_top_0());
Operation* const  fast_mu::reg_theorem_1 = PredTable::Register("theorem",1, new pred_theorem_1());
Operation* const  fast_mu::reg_derive_6 = PredTable::Register("derive",6, new pred_derive_6());
Operation* const  fast_mu::reg_derive2_7 = PredTable::Register("derive2",7, new pred_derive2_7());
Operation* const  fast_mu::reg_rule_7 = PredTable::Register("rule",7, new pred_rule_7());
Operation* const  fast_mu::reg_rule_11 = PredTable::Register("rule",11, new pred_rule_11());
Operation* const  fast_mu::reg_lower_bound_3 = PredTable::Register("lower_bound",3, new pred_lower_bound_3());
	...
	mach->CUTB = mach->CurrentChoice;
	return static_cast<Operation*>(fast_mu::s_length->FindProc(2));
	}
	...
	return static_cast<Operation*>(fast_mu::s_is->FindProc(2));
	}
	...
	if(!((areg5)->Unify(Data::F(fast_mu::s4,Data::F(fast_mu::s_rule,var6,var7),var8),mach))) {
		return Prolog::Fail0;
	}
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(fast_mu::s4,fast_mu::s_m,var1),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(fast_mu::s4,fast_mu::s_m,var2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(var3,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(fast_mu::s4,fast_mu::s_i,Const::Nil),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(fast_mu::s4,fast_mu::s_i,Data::F(fast_mu::s4,fast_mu::s_u,Const::Nil)),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg8)->Unify(fast_mu::posint1,mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg5)->Unify(fast_mu::posint1,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg6)->Unify(var5,mach))) {
		return Prolog::Fail0;
	...
	if(!((areg8)->Unify(fast_mu::posint2,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg9)->Unify(var1->Deref(),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg10)->Unify(Const::Nil,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var3->Deref();
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(fast_mu::s4,fast_mu::s_i,Data::F(fast_mu::s4,fast_mu::s_i,Data::F(fast_mu::s4,fast_mu::s_i,var1))),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(fast_mu::s4,fast_mu::s_u,var1->Deref()),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(var2,mach))) {
		return Prolog::Fail0;
	...
	if(!((areg8)->Unify(fast_mu::posint3,mach))) {
		return Prolog::Fail0;
	}
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(fast_mu::s4,fast_mu::s_u,Data::F(fast_mu::s4,fast_mu::s_u,var1)),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1->Deref(),mach))) {
		return Prolog::Fail0;
	...
	if(!((areg7)->Unify(fast_mu::s_i,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg8)->Unify(fast_mu::posint4,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg9)->Unify(var7,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(fast_mu::s4,var1,var2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(fast_mu::s4, { var1->Deref(), var3 }),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg10)->Unify(Data::F(fast_mu::s4, { var1->Deref(), var12 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var13;
	...
	if(!((areg2)->Unify(fast_mu::posint1,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var2->Deref();
	...
	if(!((areg2)->Unify(fast_mu::posint2,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
