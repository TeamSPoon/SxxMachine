...
const Operation divide10::reg_top_0 = PredTable::Register("top", 0, new SxxMachine::sxx_library::pred_top_0());
const Operation divide10::reg_divide10_0 = PredTable::Register("divide10", 0, new pred_divide10_0());
const Operation divide10::reg_d_3 = PredTable::Register("d", 3, new pred_d_3());
	...
	Operation divide10::pred_d_3::exec_pred_d_3__3(Prolog* mach) {
		...
		if(!((areg2)->Unify(Data::F(divide10::s2, Data::F(divide10::s1, var4, var2->Deref()), Data::F(divide10::s1, { var1->Deref(), var5 }))))) {
			return Prolog::Fail0;
		}
		mach->DoCut(mach->CUTB);
		local_aregs[0] = Data::F(divide10::s_d, { var1->Deref(), var3->Deref(), var4->Deref(), Data::F(divide10::s_d, { var2->Deref(), var3->Deref(), var5->Deref(), continuation }) });
	...
	Operation divide10::pred_d_3::exec_pred_d_3__4(Prolog* mach) {
		...
		if(!((areg2)->Unify(Data::F(divide10::s5, Data::F(divide10::s3, Data::F(divide10::s1, var4, var2->Deref()), Data::F(divide10::s1, { var1->Deref(), var5 })), Data::F(divide10::s7, { var2->Deref(), divide10::posint2 }))))) {
			return Prolog::Fail0;
		}
		mach->DoCut(mach->CUTB);
		local_aregs[0] = Data::F(divide10::s_d, { var1->Deref(), var3->Deref(), var4->Deref(), Data::F(divide10::s_d, { var2->Deref(), var3->Deref(), var5->Deref(), continuation }) });
	...
	Operation divide10::pred_d_3::exec_pred_d_3__5(Prolog* mach) {
		...
		if(!((areg2)->Unify(Data::F(divide10::s1, Data::F(divide10::s1, var4, var2->Deref()), Data::F(divide10::s7, { var1->Deref(), var5 }))))) {
			return Prolog::Fail0;
		}
		mach->DoCut(mach->CUTB);
