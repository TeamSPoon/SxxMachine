...
Operation* const  perfect::reg_top_0 = PredTable::Register("top",0, new SxxMachine::sxx_library::pred_top_0());
Operation* const  perfect::reg_ok_1 = PredTable::Register("ok",1, new pred_ok_1());
Operation* const  perfect::reg_divisible_2 = PredTable::Register("divisible",2, new pred_divisible_2());
Operation* const  perfect::reg_isprime_2 = PredTable::Register("isprime",2, new pred_isprime_2());
Operation* const  perfect::reg_power_3 = PredTable::Register("power",3, new pred_power_3());
Operation* const  perfect::reg_calc_3 = PredTable::Register("calc",3, new pred_calc_3());
Operation* const  perfect::reg_listperf_2 = PredTable::Register("listperf",2, new pred_listperf_2());
Operation* const  perfect::reg_generateList_2 = PredTable::Register("generateList",2, new pred_generateList_2());
Operation* const  perfect::reg_perfect_2 = PredTable::Register("perfect",2, new pred_perfect_2());
	...
	return static_cast<Operation*>(perfect::s_findall->FindProc(3));
	}
	...
	mach->CUTB = mach->CurrentChoice;
	return static_cast<Operation*>(perfect::s_is->FindProc(2));
	}
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(perfect::s4,var1,var2),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg1)->Unify(perfect::posint0,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(perfect::posint1,mach))) {
		return Prolog::Fail0;
	}
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(perfect::posint2,mach))) {
		return Prolog::Fail0;
	}
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(perfect::posint0,mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg1)->Unify(Data::F(perfect::s4,var2,var3),mach))) {
		return Prolog::Fail0;
	}
