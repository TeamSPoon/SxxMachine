...
const Operation qsort::reg_top_0 = PredTable::Register("top", 0, new SxxMachine::sxx_library::pred_top_0());
const Operation qsort::reg_qsort_0 = PredTable::Register("qsort", 0, new pred_qsort_0());
const Operation qsort::reg_qsort_3 = PredTable::Register("qsort", 3, new pred_qsort_3());
const Operation qsort::reg_partition_4 = PredTable::Register("partition", 4, new pred_partition_4());
