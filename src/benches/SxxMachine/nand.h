...
public:
	...
	static Operation* const  reg_init_state_4;
	static Operation* const  reg_search_3;
	static Operation* const  reg_select_vector_5;
	static Operation* const  reg_select_vector_12;
	static Operation* const  reg_select_vector_13;
	static Operation* const  reg_vector_cover_type_6;
	static Operation* const  reg_cover_type1_7;
	static Operation* const  reg_cover_type2_9;
	static Operation* const  reg_best_vector_12;
	static Operation* const  reg_max_type_3;
	static Operation* const  reg_type_order_2;
	static Operation* const  reg_cover_vector_7;
	static Operation* const  reg_vector_types_1;
	static Operation* const  reg_cover_vector_10;
	static Operation* const  reg_update_circuit_6;
	static Operation* const  reg_exclude_if_vector_in_false_set_4;
	static Operation* const  reg_add_necessary_functions_5;
	static Operation* const  reg_add_necessary_functions_6;
	static Operation* const  reg_new_function_CIs_5;
	static Operation* const  reg_new_function_CIs_7;
	static Operation* const  reg_function_type_6;
	static Operation* const  reg_test_bounds_3;
	static Operation* const  reg_update_bounds_3;
	static Operation* const  reg_set_2;
	static Operation* const  reg_access_2;
	static Operation* const  reg_write_gates_1;
	static Operation* const  reg_function_3;
	static Operation* const  reg_function_number_2;
	static Operation* const  reg_true_set_2;
	static Operation* const  reg_false_set_2;
	static Operation* const  reg_conceivable_inputs_2;
	static Operation* const  reg_immediate_predecessors_2;
	static Operation* const  reg_immediate_successors_2;
	static Operation* const  reg_predecessors_2;
	static Operation* const  reg_successors_2;
	static Operation* const  reg_set_union_3;
	static Operation* const  reg_set_intersection_3;
	static Operation* const  reg_set_difference_3;
	static Operation* const  reg_set_subset_2;
	static Operation* const  reg_set_member_2;
public:
