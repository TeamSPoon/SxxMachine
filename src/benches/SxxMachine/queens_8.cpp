...
Operation* const  queens_8::reg_top_0 = PredTable::Register("top",0, new SxxMachine::sxx_library::pred_top_0());
Operation* const  queens_8::reg_queens_2 = PredTable::Register("queens",2, new pred_queens_2());
Operation* const  queens_8::reg_queens_3 = PredTable::Register("queens",3, new pred_queens_3());
Operation* const  queens_8::reg_not_attack_2 = PredTable::Register("not_attack",2, new pred_not_attack_2());
Operation* const  queens_8::reg_not_attack_3 = PredTable::Register("not_attack",3, new pred_not_attack_3());
Operation* const  queens_8::reg_select_3 = PredTable::Register("select",3, new pred_select_3());
Operation* const  queens_8::reg_range_3 = PredTable::Register("range",3, new pred_range_3());
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(queens_8::s3,var1,var2),mach))) {
		return Prolog::Fail0;
	}
	...
	return static_cast<Operation*>(queens_8::s5->FindProc(2));
	}
	...
	if(!((areg1)->Unify(Data::F(queens_8::s3, { var1->Deref(), var3 }),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(var4,mach))) {
		return Prolog::Fail0;
	...
	if(!((areg2)->Unify(Data::F(queens_8::s3, { var1->Deref(), Const::Nil }),mach))) {
		return Prolog::Fail0;
	}
	mach->DoCut(mach->CUTB);
	local_aregs[0] = continuation;
	...
	if(!((areg2)->Unify(Data::F(queens_8::s3, { var1->Deref(), var3 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var2->Deref();
