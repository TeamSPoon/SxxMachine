...
const Operation meta_qsort::reg_top_0 = PredTable::Register("top", 0, new SxxMachine::sxx_library::pred_top_0());
const Operation meta_qsort::reg_meta_qsort_0 = PredTable::Register("meta_qsort", 0, new pred_meta_qsort_0());
const Operation meta_qsort::reg_interpret_1 = PredTable::Register("interpret", 1, new pred_interpret_1());
const Operation meta_qsort::reg_interpret_2 = PredTable::Register("interpret", 2, new pred_interpret_2());
const Operation meta_qsort::reg_interpret_disjunction_3 = PredTable::Register("interpret_disjunction", 3, new pred_interpret_disjunction_3());
const Operation meta_qsort::reg_is_built_in_1 = PredTable::Register("is_built_in", 1, new pred_is_built_in_1());
const Operation meta_qsort::reg_interpret_built_in_1 = PredTable::Register("interpret_built_in", 1, new pred_interpret_built_in_1());
const Operation meta_qsort::reg_define_2 = PredTable::Register("define", 2, new pred_define_2());
	...
	Operation meta_qsort::pred_interpret_2::exec_pred_interpret_2__7(Prolog* mach) {
		...
		mach->CUTB = mach->CurrentChoice;
		local_aregs[2] = nullptr;
		return static_cast<Operation>(SxxMachine::Builtins::pred_number_1::exec_static);
	}
	...
	Operation meta_qsort::pred_define_2::exec_pred_define_2__2(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(meta_qsort::s2, Data::F(meta_qsort::s_partition, { var2->Deref(), var1->Deref(), var5, var6 }), Data::F(meta_qsort::s2, Data::F(meta_qsort::s_qsort, { var6->Deref(), var7, var4->Deref() }), Data::F(meta_qsort::s_qsort, { var5->Deref(), var3->Deref(), Data::F(meta_qsort::s4, { var1->Deref(), var7->Deref() }) })))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation meta_qsort::pred_define_2::exec_pred_define_2__4(Prolog* mach) {
		...
		Var* var2 = Data::V(mach);
		Var* var1 = Data::V(mach);
		if(!((areg0)->Unify(Data::F(meta_qsort::s_partition, Data::F(meta_qsort::s4, var1, var2), var3, Data::F(meta_qsort::s4, { var1->Deref(), var4 }), var5)))) {
			return Prolog::Fail0;
		}
		if(!((areg1)->Unify(Data::F(meta_qsort::s2, Data::F(meta_qsort::s8, { var1->Deref(), var3->Deref() }), Data::F(meta_qsort::s2, meta_qsort::s1, Data::F(meta_qsort::s_partition, { var2->Deref(), var3->Deref(), var4->Deref(), var5->Deref() })))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation meta_qsort::pred_define_2::exec_pred_define_2__5(Prolog* mach) {
		...
		Var* var2 = Data::V(mach);
		Var* var1 = Data::V(mach);
		if(!((areg0)->Unify(Data::F(meta_qsort::s_partition, Data::F(meta_qsort::s4, var1, var2), var3, var4, Data::F(meta_qsort::s4, { var1->Deref(), var5 }))))) {
			return Prolog::Fail0;
		}
		if(!((areg1)->Unify(Data::F(meta_qsort::s_partition, { var2->Deref(), var3->Deref(), var4->Deref(), var5->Deref() })))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
