...
Operation* const  tak::reg_top_0 = PredTable::Register("top",0, new SxxMachine::sxx_library::pred_top_0());
Operation* const  tak::reg_tak_0 = PredTable::Register("tak",0, new pred_tak_0());
Operation* const  tak::reg_tak_4 = PredTable::Register("tak",4, new pred_tak_4());
