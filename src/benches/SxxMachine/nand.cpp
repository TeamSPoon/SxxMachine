...
const Operation nand::reg_top_0 = PredTable::Register("top", 0, new SxxMachine::sxx_library::pred_top_0());
const Operation nand::reg_main_1 = PredTable::Register("main", 1, new pred_main_1());
const Operation nand::reg_init_state_4 = PredTable::Register("init_state", 4, new pred_init_state_4());
const Operation nand::reg_search_3 = PredTable::Register("search", 3, new pred_search_3());
const Operation nand::reg_select_vector_5 = PredTable::Register("select_vector", 5, new pred_select_vector_5());
const Operation nand::reg_select_vector_12 = PredTable::Register("select_vector", 12, new pred_select_vector_12());
const Operation nand::reg_select_vector_13 = PredTable::Register("select_vector", 13, new pred_select_vector_13());
const Operation nand::reg_vector_cover_type_6 = PredTable::Register("vector_cover_type", 6, new pred_vector_cover_type_6());
const Operation nand::reg_cover_type1_7 = PredTable::Register("cover_type1", 7, new pred_cover_type1_7());
const Operation nand::reg_cover_type2_9 = PredTable::Register("cover_type2", 9, new pred_cover_type2_9());
const Operation nand::reg_best_vector_12 = PredTable::Register("best_vector", 12, new pred_best_vector_12());
const Operation nand::reg_max_type_3 = PredTable::Register("max_type", 3, new pred_max_type_3());
const Operation nand::reg_type_order_2 = PredTable::Register("type_order", 2, new pred_type_order_2());
const Operation nand::reg_cover_vector_7 = PredTable::Register("cover_vector", 7, new pred_cover_vector_7());
const Operation nand::reg_vector_types_1 = PredTable::Register("vector_types", 1, new pred_vector_types_1());
const Operation nand::reg_cover_vector_10 = PredTable::Register("cover_vector", 10, new pred_cover_vector_10());
const Operation nand::reg_update_circuit_6 = PredTable::Register("update_circuit", 6, new pred_update_circuit_6());
const Operation nand::reg_exclude_if_vector_in_false_set_4 = PredTable::Register("exclude_if_vector_in_false_set", 4, new pred_exclude_if_vector_in_false_set_4());
const Operation nand::reg_add_necessary_functions_5 = PredTable::Register("add_necessary_functions", 5, new pred_add_necessary_functions_5());
const Operation nand::reg_add_necessary_functions_6 = PredTable::Register("add_necessary_functions", 6, new pred_add_necessary_functions_6());
const Operation nand::reg_new_function_CIs_5 = PredTable::Register("new_function_CIs", 5, new pred_new_function_CIs_5());
const Operation nand::reg_new_function_CIs_7 = PredTable::Register("new_function_CIs", 7, new pred_new_function_CIs_7());
const Operation nand::reg_function_type_6 = PredTable::Register("function_type", 6, new pred_function_type_6());
const Operation nand::reg_test_bounds_3 = PredTable::Register("test_bounds", 3, new pred_test_bounds_3());
const Operation nand::reg_update_bounds_3 = PredTable::Register("update_bounds", 3, new pred_update_bounds_3());
const Operation nand::reg_set_2 = PredTable::Register("set", 2, new pred_set_2());
const Operation nand::reg_access_2 = PredTable::Register("access", 2, new pred_access_2());
const Operation nand::reg_write_gates_1 = PredTable::Register("write_gates", 1, new pred_write_gates_1());
const Operation nand::reg_function_3 = PredTable::Register("function", 3, new pred_function_3());
const Operation nand::reg_function_number_2 = PredTable::Register("function_number", 2, new pred_function_number_2());
const Operation nand::reg_true_set_2 = PredTable::Register("true_set", 2, new pred_true_set_2());
const Operation nand::reg_false_set_2 = PredTable::Register("false_set", 2, new pred_false_set_2());
const Operation nand::reg_conceivable_inputs_2 = PredTable::Register("conceivable_inputs", 2, new pred_conceivable_inputs_2());
const Operation nand::reg_immediate_predecessors_2 = PredTable::Register("immediate_predecessors", 2, new pred_immediate_predecessors_2());
const Operation nand::reg_immediate_successors_2 = PredTable::Register("immediate_successors", 2, new pred_immediate_successors_2());
const Operation nand::reg_predecessors_2 = PredTable::Register("predecessors", 2, new pred_predecessors_2());
const Operation nand::reg_successors_2 = PredTable::Register("successors", 2, new pred_successors_2());
const Operation nand::reg_set_union_3 = PredTable::Register("set_union", 3, new pred_set_union_3());
const Operation nand::reg_set_intersection_3 = PredTable::Register("set_intersection", 3, new pred_set_intersection_3());
const Operation nand::reg_set_difference_3 = PredTable::Register("set_difference", 3, new pred_set_difference_3());
const Operation nand::reg_set_subset_2 = PredTable::Register("set_subset", 2, new pred_set_subset_2());
const Operation nand::reg_set_member_2 = PredTable::Register("set_member", 2, new pred_set_member_2());
	...
	Operation nand::pred_init_state_4::exec_pred_init_state_4__1(Prolog* mach) {
		...
		if(!((areg3)->Unify(Data::F(nand::s5, Data::F(nand::s_function, nand::posint2, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint2, Const::Nil)), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint3, Const::Nil)), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint1, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint3, Const::Nil)), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint1, Const::Nil)), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint3, Const::Nil)), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint2, Const::Nil)), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Const::Nil)))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = var1;
	...
	Operation nand::pred_init_state_4::exec_pred_init_state_4__2(Prolog* mach) {
		...
		if(!((areg3)->Unify(Data::F(nand::s5, Data::F(nand::s_function, nand::posint3, Data::F(nand::s5, nand::posint3, Data::F(nand::s5, nand::posint5, Data::F(nand::s5, nand::posint6, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint4, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint2, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint5, Data::F(nand::s5, nand::posint6, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint3, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint1, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint3, Data::F(nand::s5, nand::posint6, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint5, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint3, Data::F(nand::s5, nand::posint5, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint6, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Const::Nil))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = var1;
		local_aregs[1] = nand::posint100;
	...
	Operation nand::pred_init_state_4::exec_pred_init_state_4__3(Prolog* mach) {
		...
		if(!((areg3)->Unify(Data::F(nand::s5, Data::F(nand::s_function, nand::posint3, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint6, Data::F(nand::s5, nand::posint7, Const::Nil))))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint3, Data::F(nand::s5, nand::posint5, Const::Nil))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint2, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint5, Data::F(nand::s5, nand::posint6, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint3, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint1, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint3, Data::F(nand::s5, nand::posint6, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint5, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint3, Data::F(nand::s5, nand::posint5, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint6, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Const::Nil))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = var1;
		local_aregs[1] = nand::posint100;
	...
	Operation nand::pred_init_state_4::exec_pred_init_state_4__4(Prolog* mach) {
		...
		if(!((areg3)->Unify(Data::F(nand::s5, Data::F(nand::s_function, nand::posint3, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint3, Data::F(nand::s5, nand::posint5, Data::F(nand::s5, nand::posint6, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint2, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint5, Data::F(nand::s5, nand::posint6, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint3, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint1, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint3, Data::F(nand::s5, nand::posint6, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint5, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint3, Data::F(nand::s5, nand::posint5, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint6, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Const::Nil))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = var1;
		local_aregs[1] = nand::posint100;
	...
	Operation nand::pred_init_state_4::exec_pred_init_state_4__5(Prolog* mach) {
		...
		if(!((areg3)->Unify(Data::F(nand::s5, Data::F(nand::s_function, nand::posint4, Data::F(nand::s5, nand::posint3, Data::F(nand::s5, nand::posint5, Data::F(nand::s5, nand::posint6, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint4, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint3, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint3, Data::F(nand::s5, nand::posint5, Data::F(nand::s5, nand::posint6, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint2, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint5, Data::F(nand::s5, nand::posint6, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint3, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint1, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint3, Data::F(nand::s5, nand::posint6, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint5, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Data::F(nand::s5, Data::F(nand::s_function, nand::posint0, Data::F(nand::s5, nand::posint1, Data::F(nand::s5, nand::posint3, Data::F(nand::s5, nand::posint5, Data::F(nand::s5, nand::posint7, Const::Nil)))), Data::F(nand::s5, nand::posint0, Data::F(nand::s5, nand::posint2, Data::F(nand::s5, nand::posint4, Data::F(nand::s5, nand::posint6, Const::Nil)))), Const::Nil, Const::Nil, Const::Nil, Const::Nil, Const::Nil), Const::Nil)))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = var1;
		local_aregs[1] = nand::posint100;
	...
	Operation nand::pred_update_circuit_6::exec_pred_update_circuit_6__2(Prolog* mach) {
		...
		Var* var2 = Data::V(mach);
		Var* var1 = Data::V(mach);
		if(!((areg0)->Unify(Data::F(nand::s5, Data::F(nand::s_function, var1, var2, var3, var4, var5, var6, var7, var8), var9)))) {
			return Prolog::Fail0;
		}
		...
		if(!((areg5)->Unify(Data::F(nand::s5, Data::F(nand::s_function, { var1->Deref(), var14, var15, var16, var17, var18, var19, var20 }), var21)))) {
			return Prolog::Fail0;
		}
	...
	Operation nand::pred_new_function_CIs_7::exec_pred_new_function_CIs_7__2(Prolog* mach) {
		...
		if(!((areg4)->Unify(Data::F(nand::s5, Data::F(nand::s_function, { var1->Deref(), var2->Deref(), var3->Deref(), var13, var5->Deref(), var6->Deref(), var7->Deref(), var8->Deref() }), var14)))) {
			return Prolog::Fail0;
		}
