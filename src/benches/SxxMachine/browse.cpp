...
Operation* const  browse::reg_top_0 = PredTable::Register("top",0, new SxxMachine::sxx_library::pred_top_0());
Operation* const  browse::reg_init_5 = PredTable::Register("init",5, new pred_init_5());
Operation* const  browse::reg_init_6 = PredTable::Register("init",6, new pred_init_6());
Operation* const  browse::reg_fill_3 = PredTable::Register("fill",3, new pred_fill_3());
Operation* const  browse::reg_randomize_3 = PredTable::Register("randomize",3, new pred_randomize_3());
Operation* const  browse::reg_split_4 = PredTable::Register("split",4, new SxxMachine::sxx_library::pred_split_4());
Operation* const  browse::reg_investigate_2 = PredTable::Register("investigate",2, new pred_investigate_2());
Operation* const  browse::reg_get_pats_3 = PredTable::Register("get_pats",3, new pred_get_pats_3());
Operation* const  browse::reg_get_pats_4 = PredTable::Register("get_pats",4, new pred_get_pats_4());
Operation* const  browse::reg_property_3 = PredTable::Register("property",3, new pred_property_3());
Operation* const  browse::reg_p_investigate_2 = PredTable::Register("p_investigate",2, new pred_p_investigate_2());
Operation* const  browse::reg_p_match_2 = PredTable::Register("p_match",2, new pred_p_match_2());
Operation* const  browse::reg_match_2 = PredTable::Register("match",2, new pred_match_2());
Operation* const  browse::reg_$0024concat_3 = PredTable::Register("$concat",3, new pred_$0024concat_3());
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(browse::posint0,mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg5)->Unify(Data::F(browse::s6,var6,var7),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg2)->Unify(Data::F(browse::s6,Data::F(browse::s_dummy, { Const::Nil }),var3),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var4;
	...
	return static_cast<Operation*>(browse::s_is->FindProc(2));
	}
	...
	if(!((areg1)->Unify(Data::F(browse::s6,var2,var3),mach))) {
		return Prolog::Fail0;
	}
	...
	mach->CUTB = mach->CurrentChoice;
	local_aregs[3] = nullptr;
	return static_cast<Operation*>(browse::s_length->FindProc(2));
	}
	...
	if(!((areg1)->Unify(Data::F(browse::s6,var1,var2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(var1->Deref(),mach))) {
		return Prolog::Fail0;
	...
	if(!((areg3)->Unify(Data::F(browse::s6, { var2->Deref(), var5 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var6;
	local_aregs[1] = Data::F(browse::s4, { var1->Deref(), browse::posint1 });
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(browse::s6,var1,var2),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg2)->Unify(Data::F(browse::s6, { var2->Deref(), var4 }),mach))) {
		return Prolog::Fail0;
	}
	...
	return static_cast<Operation*>(browse::s_fail->FindProc(0));
	}
	...
	mach->CUTB = mach->CurrentChoice;
	return static_cast<Operation*>(browse::s_functor->FindProc(3));
	}
	...
	if(!((areg1)->Unify(Data::F(browse::s6,var3,var4),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var3->Deref();
	...
	mach->CUTB = mach->CurrentChoice;
	local_aregs[2] = nullptr;
	return static_cast<Operation*>(browse::s_var->FindProc(1));
	}
	...
	mach->CUTB = mach->CurrentChoice;
	local_aregs[2] = nullptr;
	return static_cast<Operation*>(browse::s_nonvar->FindProc(1));
	}
	...
	if(!((areg2)->Unify(Data::F(browse::s6, { var1->Deref(), var4 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var2->Deref();
	local_aregs[1] = var3->Deref();
