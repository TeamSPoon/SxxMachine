...
const Operation serialise::reg_top_0 = PredTable::Register("top", 0, new SxxMachine::sxx_library::pred_top_0());
const Operation serialise::reg_serialise_0 = PredTable::Register("serialise", 0, new pred_serialise_0());
const Operation serialise::reg_serialise_2 = PredTable::Register("serialise", 2, new pred_serialise_2());
const Operation serialise::reg_pairlists_3 = PredTable::Register("pairlists", 3, new pred_pairlists_3());
const Operation serialise::reg_arrange_2 = PredTable::Register("arrange", 2, new pred_arrange_2());
const Operation serialise::reg_split_4 = PredTable::Register("split", 4, new SxxMachine::sxx_library::pred_split_4());
const Operation serialise::reg_before_2 = PredTable::Register("before", 2, new pred_before_2());
const Operation serialise::reg_numbered_3 = PredTable::Register("numbered", 3, new pred_numbered_3());
