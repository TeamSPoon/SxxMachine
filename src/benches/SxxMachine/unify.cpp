...
const Operation unify::reg_top_0 = PredTable::Register("top", 0, new SxxMachine::sxx_library::pred_top_0());
const Operation unify::reg_main_1 = PredTable::Register("main", 1, new pred_main_1());
const Operation unify::reg_u_4 = PredTable::Register("u", 4, new pred_u_4());
const Operation unify::reg_$002D$002D$003E_2 = PredTable::Register("-->", 2, new SxxMachine::Builtins::pred_$002D$002D$003E_2());
const Operation unify::reg_make_word_3 = PredTable::Register("make_word", 3, new pred_make_word_3());
const Operation unify::reg_add_3 = PredTable::Register("add", 3, new pred_add_3());
const Operation unify::reg_myin_2 = PredTable::Register("myin", 2, new pred_myin_2());
const Operation unify::reg_in_2_3 = PredTable::Register("in_2", 3, new pred_in_2_3());
const Operation unify::reg_incl_3 = PredTable::Register("incl", 3, new pred_incl_3());
const Operation unify::reg_incl_2_3 = PredTable::Register("incl_2", 3, new pred_incl_2_3());
const Operation unify::reg_incl_3_5 = PredTable::Register("incl_3", 5, new pred_incl_3_5());
const Operation unify::reg_my_compound_1 = PredTable::Register("my_compound", 1, new pred_my_compound_1());
const Operation unify::reg_cons_1 = PredTable::Register("cons", 1, new pred_cons_1());
const Operation unify::reg_structure_1 = PredTable::Register("structure", 1, new pred_structure_1());
const Operation unify::reg_termtag_2 = PredTable::Register("termtag", 2, new pred_termtag_2());
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__1(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s13, Data::F(unify::s_myin, { var1->Deref(), var3->Deref() }))), Data::F(unify::s3, unify::s1, Data::F(unify::s_uninit, { var1->Deref(), var2->Deref(), var3->Deref(), var4->Deref() })))))) {
			return Prolog::Fail0;
		}
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__2(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_myin, { var1->Deref(), var3->Deref() })), Data::F(unify::s3, unify::s1, Data::F(unify::s_init, { var1->Deref(), var2->Deref(), var3->Deref(), var4->Deref(), unify::s_nonlast, var5 })))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__3(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_my_compound, { var2->Deref() })), Data::F(unify::s3, unify::s1, Data::F(unify::s3, Data::F(unify::s6, Data::F(unify::s_move, Data::F(unify::s14, var5, unify::s_h), var1->Deref()), Const::Nil), Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_termtag, { var2->Deref(), var5->Deref() })), Data::F(unify::s3, Data::F(unify::s_unify_block, unify::s_nonlast, var2->Deref(), var6, var3->Deref(), var7, var8), Data::F(unify::s69, Data::F(unify::s_incl, { var1->Deref(), var7->Deref(), var4->Deref() })))))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__4(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_atomic, { var2->Deref() })), Data::F(unify::s3, unify::s1, Data::F(unify::s3, Data::F(unify::s6, Data::F(unify::s_move, Data::F(unify::s14, unify::s_tatm, var2->Deref()), var1->Deref()), Const::Nil), Data::F(unify::s69, Data::F(unify::s_incl, { var1->Deref(), var3->Deref(), var4->Deref() })))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__5(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_var, { var2->Deref() })), Data::F(unify::s3, unify::s1, Data::F(unify::s_unify_var, { var1->Deref(), var2->Deref(), var3->Deref(), var4->Deref() })))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__8(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s3, Data::F(unify::s_myin, { var1->Deref(), var3->Deref() }), Data::F(unify::s_myin, { var2->Deref(), var3->Deref() }))), Data::F(unify::s3, unify::s1, Data::F(unify::s6, Data::F(unify::s_unify, { var1->Deref(), var2->Deref(), unify::s_fail }), Const::Nil)))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__9(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s3, Data::F(unify::s_myin, { var1->Deref(), var3->Deref() }), Data::F(unify::s13, Data::F(unify::s_myin, { var2->Deref(), var3->Deref() })))), Data::F(unify::s3, unify::s1, Data::F(unify::s3, Data::F(unify::s6, Data::F(unify::s_move, { var1->Deref(), var2->Deref() }), Const::Nil), Data::F(unify::s69, Data::F(unify::s_incl, { var2->Deref(), var3->Deref(), var4->Deref() })))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__10(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s3, Data::F(unify::s13, Data::F(unify::s_myin, { var1->Deref(), var3->Deref() })), Data::F(unify::s_myin, { var2->Deref(), var3->Deref() }))), Data::F(unify::s3, unify::s1, Data::F(unify::s3, Data::F(unify::s6, Data::F(unify::s_move, { var2->Deref(), var1->Deref() }), Const::Nil), Data::F(unify::s69, Data::F(unify::s_incl, { var1->Deref(), var3->Deref(), var4->Deref() })))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__11(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s3, Data::F(unify::s13, Data::F(unify::s_myin, { var1->Deref(), var3->Deref() })), Data::F(unify::s13, Data::F(unify::s_myin, { var2->Deref(), var3->Deref() })))), Data::F(unify::s3, unify::s1, Data::F(unify::s3, Data::F(unify::s6, Data::F(unify::s_move, Data::F(unify::s14, unify::s_tvar, unify::s_h), var1->Deref()), Data::F(unify::s6, Data::F(unify::s_move, Data::F(unify::s14, unify::s_tvar, unify::s_h), var2->Deref()), Data::F(unify::s6, Data::F(unify::s_add, unify::posint1, unify::s_h), Data::F(unify::s6, Data::F(unify::s_move, { var2->Deref(), Data::F(unify::s6, Data::F(unify::s4, unify::s_h, unify::posint1), Const::Nil) }), Const::Nil)))), Data::F(unify::s69, Data::F(unify::s3, Data::F(unify::s_incl, { var1->Deref(), var3->Deref(), var5 }), Data::F(unify::s_incl, { var2->Deref(), var5->Deref(), var4->Deref() }))))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__13(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_cons, { var2->Deref() })), Data::F(unify::s3, unify::s1, Data::F(unify::s_unify_args, unify::posint1, unify::posint2, var2->Deref(), var3->Deref(), var4->Deref(), unify::negint1, var1->Deref(), var5->Deref())))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__14(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_atomic, { var2->Deref() })), Data::F(unify::s3, unify::s1, Data::F(unify::s6, Data::F(unify::s_equal, { var1->Deref(), Data::F(unify::s14, unify::s_tatm, var2->Deref()), unify::s_fail }), Const::Nil)))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__15(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s12, { var1->Deref(), var2->Deref() })), unify::s1)))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__16(Prolog* mach) {
		...
		Var* var2 = Data::V(mach);
		Var* var1 = Data::V(mach);
		if(!((areg0)->Unify(Data::F(unify::s_unify_args, var1, var2, var3, var4, var5, var6, var7, Data::F(unify::s6, var8, var9))))) {
			return Prolog::Fail0;
		}
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s10, { var1->Deref(), var2->Deref() })), Data::F(unify::s3, unify::s1, Data::F(unify::s_unify_arg, { var1->Deref(), var3->Deref(), var4->Deref(), var5->Deref(), var6->Deref(), var7->Deref(), unify::s_last, var9->Deref() })))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__17(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s9, { var1->Deref(), var2->Deref() })), Data::F(unify::s3, unify::s1, Data::F(unify::s3, Data::F(unify::s_unify_arg, { var1->Deref(), var3->Deref(), var4->Deref(), var9, var6->Deref(), var7->Deref(), unify::s_nonlast, var10 }), Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_is, var11, Data::F(unify::s2, { var1->Deref(), unify::posint1 }))), Data::F(unify::s_unify_args, { var11->Deref(), var2->Deref(), var3->Deref(), var9->Deref(), var5->Deref(), var6->Deref(), var7->Deref(), var8->Deref() })))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__20(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_atomic, { var2->Deref() })), Data::F(unify::s3, unify::s1, Data::F(unify::s6, Data::F(unify::s_move, Data::F(unify::s14, unify::s_tatm, var2->Deref()), Data::F(unify::s6, { var1->Deref(), Const::Nil })), Const::Nil)))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__21(Prolog* mach) {
		...
		Var* var2 = Data::V(mach);
		Var* var1 = Data::V(mach);
		if(!((areg0)->Unify(Data::F(unify::s_unify_block, unify::s_last, var1, var2, var3, var3->Deref(), Data::F(unify::s6, var4, var5))))) {
			return Prolog::Fail0;
		}
		if(!((areg1)->Unify(Data::F(unify::s3, unify::s1, Data::F(unify::s3, Data::F(unify::s6, Data::F(unify::s_add, { var2->Deref(), unify::s_h }), Data::F(unify::s6, Data::F(unify::s_jump, { var4->Deref() }), Const::Nil)), Data::F(unify::s69, Data::F(unify::s_size, { var1->Deref(), unify::posint0, var2->Deref() }))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__24(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_cons, { var1->Deref() })), Data::F(unify::s3, unify::s1, Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_is, var7, Data::F(unify::s2, { var2->Deref(), unify::posint2 }))), Data::F(unify::s3, Data::F(unify::s_make_slots, unify::posint1, unify::posint2, var1->Deref(), var2->Deref(), var8, var4->Deref(), var9), Data::F(unify::s_block_args, unify::posint1, unify::posint2, var1->Deref(), var7->Deref(), var3->Deref(), var8->Deref(), var9->Deref(), var5->Deref(), var6->Deref())))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__27(Prolog* mach) {
		...
		Var* var2 = Data::V(mach);
		Var* var1 = Data::V(mach);
		if(!((areg0)->Unify(Data::F(unify::s_block_args, var1, var2, var3, var4, var4->Deref(), Const::Nil, var5, var5->Deref(), Const::Nil)))) {
			return Prolog::Fail0;
		}
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s12, { var1->Deref(), var2->Deref() })), unify::s1)))) {
			return Prolog::Fail0;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__29(Prolog* mach) {
		...
		Var* var2 = Data::V(mach);
		Var* var1 = Data::V(mach);
		if(!((areg0)->Unify(Data::F(unify::s_block_args, var1, var2, var3, var4, var5, Data::F(unify::s6, { var4->Deref(), var6 }), var7, var8, var9)))) {
			return Prolog::Fail0;
		}
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s9, { var1->Deref(), var2->Deref() })), Data::F(unify::s3, unify::s1, Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_arg, { var1->Deref(), var3->Deref(), var10 })), Data::F(unify::s3, Data::F(unify::s_block, { var10->Deref(), var4->Deref(), var11, var7->Deref(), var12, var13 }), Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_is, var14, Data::F(unify::s2, { var1->Deref(), unify::posint1 }))), Data::F(unify::s_block_args, { var14->Deref(), var2->Deref(), var3->Deref(), var11->Deref(), var5->Deref(), var6->Deref(), var12->Deref(), var8->Deref(), var9->Deref() }))))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__31(Prolog* mach) {
		...
		Var* var2 = Data::V(mach);
		Var* var1 = Data::V(mach);
		if(!((areg0)->Unify(Data::F(unify::s_make_slots, var1, var2, var3, var4, Data::F(unify::s6, var5, var6), var7, var8)))) {
			return Prolog::Fail0;
		}
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__32(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s3, Data::F(unify::s_var, { var1->Deref() }), Data::F(unify::s13, Data::F(unify::s_myin, { var1->Deref(), var3->Deref() })))), Data::F(unify::s3, unify::s1, Data::F(unify::s6, Data::F(unify::s_move, Data::F(unify::s14, unify::s_tvar, Data::F(unify::s2, unify::s_h, var2->Deref())), var1->Deref()), Const::Nil)))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__33(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s3, Data::F(unify::s_var, { var1->Deref() }), Data::F(unify::s_myin, { var1->Deref(), var3->Deref() }))), unify::s1)))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__35(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_structure, { var1->Deref() })), Data::F(unify::s3, unify::s1, Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_functor, { var1->Deref(), var2, var3 })), Data::F(unify::s3, Data::F(unify::s_add, unify::posint1), Data::F(unify::s3, Data::F(unify::s_add, { var3->Deref() }), Data::F(unify::s_size_args, unify::posint1, var3->Deref(), var1->Deref()))))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__36(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_cons, { var1->Deref() })), Data::F(unify::s3, unify::s1, Data::F(unify::s3, Data::F(unify::s_add, unify::posint2), Data::F(unify::s_size_args, unify::posint1, unify::posint2, var1->Deref()))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation unify::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__40(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s11, { var1->Deref(), var2->Deref() })), Data::F(unify::s3, unify::s1, Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_arg, { var1->Deref(), var3->Deref(), var4 })), Data::F(unify::s3, Data::F(unify::s_size, { var4->Deref() }), Data::F(unify::s3, Data::F(unify::s69, Data::F(unify::s_is, var5, Data::F(unify::s2, { var1->Deref(), unify::posint1 }))), Data::F(unify::s_size_args, { var5->Deref(), var2->Deref(), var3->Deref() }))))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
