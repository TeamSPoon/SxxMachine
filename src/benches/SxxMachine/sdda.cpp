...
Operation* const  sdda::reg_top_0 = PredTable::Register("top",0, new SxxMachine::sxx_library::pred_top_0());
Operation* const  sdda::reg_do_sdda_4 = PredTable::Register("do_sdda",4, new pred_do_sdda_4());
Operation* const  sdda::reg_read_procedures_3 = PredTable::Register("read_procedures",3, new pred_read_procedures_3());
Operation* const  sdda::reg_entry_exit_modes_list_3 = PredTable::Register("entry_exit_modes_list",3, new pred_entry_exit_modes_list_3());
Operation* const  sdda::reg_proc_exit_mode_6 = PredTable::Register("proc_exit_mode",6, new pred_proc_exit_mode_6());
Operation* const  sdda::reg_clause_exit_modes_list_6 = PredTable::Register("clause_exit_modes_list",6, new pred_clause_exit_modes_list_6());
Operation* const  sdda::reg_clause_exit_mode_5 = PredTable::Register("clause_exit_mode",5, new pred_clause_exit_mode_5());
Operation* const  sdda::reg_body_exit_mode_4 = PredTable::Register("body_exit_mode",4, new pred_body_exit_mode_4());
Operation* const  sdda::reg_unify_2 = PredTable::Register("unify",2, new SxxMachine::Builtins::pred_unify_2());
Operation* const  sdda::reg_equiv_2 = PredTable::Register("equiv",2, new pred_equiv_2());
Operation* const  sdda::reg_equiv_3 = PredTable::Register("equiv",3, new pred_equiv_3());
Operation* const  sdda::reg_equiv_vars_3 = PredTable::Register("equiv_vars",3, new pred_equiv_vars_3());
Operation* const  sdda::reg_dup_2 = PredTable::Register("dup",2, new pred_dup_2());
Operation* const  sdda::reg_dup_3 = PredTable::Register("dup",3, new pred_dup_3());
Operation* const  sdda::reg_dup_var_3 = PredTable::Register("dup_var",3, new pred_dup_var_3());
Operation* const  sdda::reg_built_in_3 = PredTable::Register("built_in",3, new pred_built_in_3());
Operation* const  sdda::reg_worst_case_2 = PredTable::Register("worst_case",2, new pred_worst_case_2());
Operation* const  sdda::reg_look_up_act_2 = PredTable::Register("look_up_act",2, new pred_look_up_act_2());
Operation* const  sdda::reg_all_shared_2 = PredTable::Register("all_shared",2, new pred_all_shared_2());
Operation* const  sdda::reg_bind_all_2 = PredTable::Register("bind_all",2, new pred_bind_all_2());
Operation* const  sdda::reg_add_to_list_2 = PredTable::Register("add_to_list",2, new pred_add_to_list_2());
Operation* const  sdda::reg_umember_2 = PredTable::Register("umember",2, new pred_umember_2());
Operation* const  sdda::reg_sumember_2 = PredTable::Register("sumember",2, new pred_sumember_2());
Operation* const  sdda::reg_member_2 = PredTable::Register("member",2, new pred_member_2());
Operation* const  sdda::reg_smember_2 = PredTable::Register("smember",2, new pred_smember_2());
Operation* const  sdda::reg_eqmember_2 = PredTable::Register("eqmember",2, new pred_eqmember_2());
Operation* const  sdda::reg_concat_3 = PredTable::Register("concat",3, new pred_concat_3());
Operation* const  sdda::reg_nl_0 = PredTable::Register("nl",0, new SxxMachine::Builtins::pred_nl_0());
Operation* const  sdda::reg_write_list2_3 = PredTable::Register("write_list2",3, new pred_write_list2_3());
Operation* const  sdda::reg_name_vars_3 = PredTable::Register("name_vars",3, new pred_name_vars_3());
Operation* const  sdda::reg_make_name_2 = PredTable::Register("make_name",2, new pred_make_name_2());
Operation* const  sdda::reg_build_name_3 = PredTable::Register("build_name",3, new pred_build_name_3());
	...
	mach->CUTB = mach->CurrentChoice;
	local_aregs[3] = local_aregs[2] = nullptr;
	return static_cast<Operation*>(sdda::s_var->FindProc(1));
	}
	...
	if(!((areg2)->Unify(Data::F(sdda::s7,var3,var4),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var3->Deref();
	...
	return static_cast<Operation*>(sdda::s13->FindProc(2));
	}
	...
	if(!((areg3)->Unify(Data::F(sdda::s8,var4,var5),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg3)->Unify(Data::F(sdda::s7,var4,var5),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg4)->Unify(var6,mach))) {
		return Prolog::Fail0;
	...
	if(!((areg5)->Unify(Data::F(sdda::s7,var7,var8),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg3)->Unify(Data::F(sdda::s4,var4,var5),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var2->Deref();
	...
	mach->CUTB = mach->CurrentChoice;
	local_aregs[4] = nullptr;
	return static_cast<Operation*>(sdda::s_functor->FindProc(3));
	}
	...
	mach->CUTB = mach->CurrentChoice;
	local_aregs[2] = nullptr;
	return static_cast<Operation*>(sdda::s_atomic->FindProc(1));
	}
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sdda::s7,var1,var2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(sdda::s7,var3,var4),mach))) {
		return Prolog::Fail0;
	}
	mach->DoCut(mach->CUTB);
	...
	if(!((areg2)->Unify(Data::F(sdda::s7,Data::F(sdda::s7,var3,Data::F(sdda::s7,var4,Const::Nil)),var5),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var3->Deref();
	...
	if(!((areg2)->Unify(Data::F(sdda::s7,Data::F(sdda::s7,var3,Data::F(sdda::s7, { var2->Deref(), Const::Nil })),var4),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var3->Deref();
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(Data::F(sdda::s8,sdda::s_true,sdda::posint0),mach))) {
		return Prolog::Fail0;
	}
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(Data::F(sdda::s8,sdda::s_fail,sdda::posint0),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Const::Nil,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sdda::s8,sdda::s12,sdda::posint2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(sdda::s7,var1,Data::F(sdda::s7,var2,Const::Nil)),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(sdda::s7,sdda::s_g,Data::F(sdda::s7,sdda::s_g,Const::Nil)),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg2)->Unify(Data::F(sdda::s7, { var1->Deref(), Data::F(sdda::s7, { var1->Deref(), Const::Nil }) }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sdda::s8,sdda::s3,sdda::posint2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(sdda::s7,var1,Data::F(sdda::s7,var2,Const::Nil)),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(sdda::s7, { var1->Deref(), Data::F(sdda::s7, { var2->Deref(), Const::Nil }) }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sdda::s8,sdda::s5,sdda::posint2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(sdda::s7,var1,Data::F(sdda::s7,var2,Const::Nil)),mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sdda::s8,sdda::s2,sdda::posint2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(sdda::s7,var1,Data::F(sdda::s7,var2,Const::Nil)),mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sdda::s8,sdda::s8,sdda::posint2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(sdda::s7,var1,Data::F(sdda::s7,var2,Const::Nil)),mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sdda::s8,sdda::s14,sdda::posint2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(sdda::s7,var1,Data::F(sdda::s7,var2,Const::Nil)),mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sdda::s8,sdda::s11,sdda::posint2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(sdda::s7,var1,Data::F(sdda::s7,var2,Const::Nil)),mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sdda::s8,sdda::s_is,sdda::posint2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(sdda::s7,var1,Data::F(sdda::s7,var2,Const::Nil)),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(sdda::s7,sdda::s_g,Data::F(sdda::s7, { var2->Deref(), Const::Nil })),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sdda::s7,Data::F(sdda::s8,var1,var2),Data::F(sdda::s7,var3,Data::F(sdda::s7,var4,Const::Nil))),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(sdda::s7,Data::F(sdda::s7,Data::F(sdda::s8, { var1->Deref(), var2->Deref() }),Data::F(sdda::s7,var5,Data::F(sdda::s7, { var4->Deref(), Const::Nil }))),var6),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var3->Deref();
	...
	if(!((areg1)->Unify(Data::F(sdda::s7,var5,var6),mach))) {
		return Prolog::Fail0;
	}
	...
	mach->CUTB = mach->CurrentChoice;
	return static_cast<Operation*>(sdda::s_unify->FindProc(3));
	}
	...
	if(!((areg1)->Unify(Data::F(sdda::s7,Data::F(sdda::s7,var2,Data::F(sdda::s7, { var1->Deref(), Const::Nil })),var3),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	...
	if(!((areg1)->Unify(Data::F(sdda::s7,Data::F(sdda::s7,var2,Data::F(sdda::s7,var3,Const::Nil)),var4),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var4->Deref();
	...
	if(!((areg1)->Unify(Data::F(sdda::s7,var2,var3),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var1->Deref();
	local_aregs[1] = var3->Deref();
	...
	if(!((areg1)->Unify(Data::F(sdda::s7, { var1->Deref(), var2 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(Data::F(sdda::s7, { var1->Deref(), var4 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var2->Deref();
	local_aregs[1] = var3->Deref();
	...
	mach->CUTB = mach->CurrentChoice;
	local_aregs[3] = local_aregs[2] = nullptr;
	return static_cast<Operation*>(sdda::s_atom->FindProc(1));
	}
	...
	mach->CUTB = mach->CurrentChoice;
	return static_cast<Operation*>(sdda::s_is->FindProc(2));
	}
	...
	Term* areg0 = local_aregs[0]->Deref();
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(sdda::posint0,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(Data::F(sdda::s7, { var1->Deref(), Const::Nil }),mach))) {
		return Prolog::Fail0;
	}
	mach->DoCut(mach->CUTB);
	local_aregs[0] = continuation;
	...
	if(!((areg2)->Unify(Data::F(sdda::s7, { var2->Deref(), var3 }),mach))) {
		return Prolog::Fail0;
	}
