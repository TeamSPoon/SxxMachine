...
Const* const  run::s10 = Data::Intern("/opt/logicmoo_workspace/taupl/SxxMachine/prolog/bench");
...
const Operation run::reg_on_load_run_0 = PredTable::Register("on_load_run", 0, new pred_on_load_run_0());
const Operation run::reg_run_1 = PredTable::Register("run", 1, new pred_run_1());
const Operation run::reg_run_2 = PredTable::Register("run", 2, new pred_run_2());
const Operation run::reg_compile_programs_0 = PredTable::Register("compile_programs", 0, new pred_compile_programs_0());
const Operation run::reg_run_program_4 = PredTable::Register("run_program", 4, new pred_run_program_4());
const Operation run::reg_add_3 = PredTable::Register("add", 3, new pred_add_3());
const Operation run::reg_ntimes_4 = PredTable::Register("ntimes", 4, new pred_ntimes_4());
const Operation run::reg_ntimes_2 = PredTable::Register("ntimes", 2, new pred_ntimes_2());
const Operation run::reg_ntimes_dummy_1 = PredTable::Register("ntimes_dummy", 1, new pred_ntimes_dummy_1());
const Operation run::reg_not_not_top_1 = PredTable::Register("not_not_top", 1, new pred_not_not_top_1());
const Operation run::reg_not_top_1 = PredTable::Register("not_top", 1, new pred_not_top_1());
const Operation run::reg_not_not_dummy_0 = PredTable::Register("not_not_dummy", 0, new pred_not_not_dummy_0());
const Operation run::reg_not_dummy_0 = PredTable::Register("not_dummy", 0, new pred_not_dummy_0());
const Operation run::reg_dummy_0 = PredTable::Register("dummy", 0, new pred_dummy_0());
const Operation run::reg_tune_counts_0 = PredTable::Register("tune_counts", 0, new pred_tune_counts_0());
const Operation run::reg_tune_count_2 = PredTable::Register("tune_count", 2, new pred_tune_count_2());
const Operation run::reg_program_3 = PredTable::Register("program", 3, new pred_program_3());
const Operation run::reg_program_2 = PredTable::Register("program", 2, new pred_program_2());
const Operation run::reg_run_interleaved_1 = PredTable::Register("run_interleaved", 1, new pred_run_interleaved_1());
const Operation run::reg_$002D$002D$003E_2 = PredTable::Register("-->", 2, new SxxMachine::Builtins::pred_$002D$002D$003E_2());
const Operation run::reg_seq_clause_2 = PredTable::Register("seq_clause", 2, new pred_seq_clause_2());
const Operation run::reg_run_non_interleaved_1 = PredTable::Register("run_non_interleaved", 1, new pred_run_non_interleaved_1());
	...
	Operation run::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__2(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(run::s4, Data::F(run::s_seq_interleaved, { var1->Deref(), var2 }), Data::F(run::s_seq_interleaved, { var2->Deref() }))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation run::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__4(Prolog* mach) {
		...
		Var* var2 = Data::V(mach);
		Var* var1 = Data::V(mach);
		if(!((areg0)->Unify(Data::F(run::s_seq_interleaved, Data::F(run::s8, Data::F(run::s5, run::posint1, var1), var2), var3)))) {
			return Prolog::Fail0;
		}
		if(!((areg1)->Unify(Data::F(run::s4, run::s1, Data::F(run::s4, Data::F(run::s8, { var1->Deref(), Const::Nil }), Data::F(run::s_seq_interleaved, { var2->Deref(), var3->Deref() })))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation run::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__5(Prolog* mach) {
		...
		Var* var2 = Data::V(mach);
		Var* var1 = Data::V(mach);
		if(!((areg0)->Unify(Data::F(run::s_seq_interleaved, Data::F(run::s8, Data::F(run::s5, var1, var2), var3), Data::F(run::s8, Data::F(run::s5, var4, var2->Deref()), var5))))) {
			return Prolog::Fail0;
		}
		if(!((areg1)->Unify(Data::F(run::s4, Data::F(run::s8, { var2->Deref(), Const::Nil }), Data::F(run::s4, Data::F(run::s101, Data::F(run::s_is, { var4->Deref(), Data::F(run::s5, { var1->Deref(), run::posint1 }) })), Data::F(run::s_seq_interleaved, { var3->Deref(), var5->Deref() })))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation run::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__7(Prolog* mach) {
		...
		Var* var2 = Data::V(mach);
		Var* var1 = Data::V(mach);
		if(!((areg0)->Unify(Data::F(run::s_seq_non_interleaved, Data::F(run::s8, Data::F(run::s5, run::posint0, var1), var2))))) {
			return Prolog::Fail0;
		}
	...
	Operation run::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__8(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(run::s4, Data::F(run::s8, { var2->Deref(), Const::Nil }), Data::F(run::s4, Data::F(run::s101, Data::F(run::s_is, var4, Data::F(run::s5, { var1->Deref(), run::posint1 }))), Data::F(run::s_seq_non_interleaved, Data::F(run::s8, Data::F(run::s5, { var4->Deref(), var2->Deref() }), var3->Deref()))))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation run::pred_seq_clause_2::exec_pred_seq_clause_2__2(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(run::s4, Data::F(run::s11, Data::F(run::s18, Data::F(run::s18, { var1->Deref() })), run::s_top), var3)))) {
			return Prolog::Fail0;
		}
