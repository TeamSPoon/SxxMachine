...
const Operation flatten::reg_top_0 = PredTable::Register("top", 0, new SxxMachine::sxx_library::pred_top_0());
const Operation flatten::reg_eliminate_disjunctions_4 = PredTable::Register("eliminate_disjunctions", 4, new pred_eliminate_disjunctions_4());
const Operation flatten::reg_gather_disj_4 = PredTable::Register("gather_disj", 4, new pred_gather_disj_4());
const Operation flatten::reg_extract_disj_4 = PredTable::Register("extract_disj", 4, new pred_extract_disj_4());
const Operation flatten::reg_extract_disj_7 = PredTable::Register("extract_disj", 7, new pred_extract_disj_7());
const Operation flatten::reg_is_disj_2 = PredTable::Register("is_disj", 2, new pred_is_disj_2());
const Operation flatten::reg_treat_disj_3 = PredTable::Register("treat_disj", 3, new pred_treat_disj_3());
const Operation flatten::reg_make_dummy_clauses_4 = PredTable::Register("make_dummy_clauses", 4, new pred_make_dummy_clauses_4());
const Operation flatten::reg_find_vars_2 = PredTable::Register("find_vars", 2, new pred_find_vars_2());
const Operation flatten::reg_find_vars_3 = PredTable::Register("find_vars", 3, new pred_find_vars_3());
const Operation flatten::reg_intersect_vars_3 = PredTable::Register("intersect_vars", 3, new pred_intersect_vars_3());
const Operation flatten::reg_make_dummy_name_2 = PredTable::Register("make_dummy_name", 2, new pred_make_dummy_name_2());
const Operation flatten::reg_append_3 = PredTable::Register("append", 3, new SxxMachine::sxx_library::pred_append_3());
const Operation flatten::reg_copy_2 = PredTable::Register("copy", 2, new pred_copy_2());
const Operation flatten::reg_copy2_3 = PredTable::Register("copy2", 3, new pred_copy2_3());
const Operation flatten::reg_copy2_5 = PredTable::Register("copy2", 5, new pred_copy2_5());
const Operation flatten::reg_retrieve_sym_3 = PredTable::Register("retrieve_sym", 3, new pred_retrieve_sym_3());
const Operation flatten::reg_make_sym_2 = PredTable::Register("make_sym", 2, new pred_make_sym_2());
const Operation flatten::reg_varset_2 = PredTable::Register("varset", 2, new pred_varset_2());
const Operation flatten::reg_varbag_2 = PredTable::Register("varbag", 2, new pred_varbag_2());
const Operation flatten::reg_$002D$002D$003E_2 = PredTable::Register("-->", 2, new SxxMachine::Builtins::pred_$002D$002D$003E_2());
const Operation flatten::reg_inst_vars_1 = PredTable::Register("inst_vars", 1, new pred_inst_vars_1());
const Operation flatten::reg_inst_vars_list_2 = PredTable::Register("inst_vars_list", 2, new pred_inst_vars_list_2());
const Operation flatten::reg_sort_vars_2 = PredTable::Register("sort_vars", 2, new pred_sort_vars_2());
const Operation flatten::reg_sort_vars_3 = PredTable::Register("sort_vars", 3, new pred_sort_vars_3());
const Operation flatten::reg_intersect_sorted_vars_3 = PredTable::Register("intersect_sorted_vars", 3, new pred_intersect_sorted_vars_3());
const Operation flatten::reg_split_vars_4 = PredTable::Register("split_vars", 4, new pred_split_vars_4());
	...
	Operation flatten::pred_is_disj_2::exec_pred_is_disj_2__1(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(flatten::s8, Data::F(flatten::s3, { var1->Deref(), Data::F(flatten::s3, flatten::s1, var2->Deref()) }), var3->Deref())))) {
			return Prolog::Fail0;
		}
	...
	Operation flatten::pred_is_disj_2::exec_pred_is_disj_2__3(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(flatten::s8, Data::F(flatten::s3, { var1->Deref(), Data::F(flatten::s3, flatten::s1, flatten::s_fail) }), flatten::s_true)))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation flatten::pred_is_disj_2::exec_pred_is_disj_2__5(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(flatten::s8, Data::F(flatten::s3, Data::F(flatten::s9, { var1->Deref(), var2->Deref() }), Data::F(flatten::s3, flatten::s1, flatten::s_fail)), flatten::s_true)))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation flatten::pred_treat_disj_3::exec_pred_treat_disj_3__2(Prolog* mach) {
		...
		Var* var2 = Data::V(mach);
		Var* var1 = Data::V(mach);
		if(!((areg0)->Unify(Data::F(flatten::s6, Data::F(flatten::s_disj, Data::F(flatten::s8, var1, var2), var3, var4, var5), var6)))) {
			return Prolog::Fail0;
		}
		if(!((areg1)->Unify(var7))) {
			return Prolog::Fail0;
	...
	Operation flatten::pred_make_dummy_name_2::exec_pred_make_dummy_name_2__1(Prolog* mach) {
		...
		mach->CUTB = mach->CurrentChoice;
		return static_cast<Operation>(SxxMachine::Builtins::pred_name_2::exec_static);
	}
	...
	Operation flatten::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__1(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(flatten::s3, Data::F(flatten::s62, Data::F(flatten::s_var, { var1->Deref() })), Data::F(flatten::s3, flatten::s1, Data::F(flatten::s6, { var1->Deref(), Const::Nil })))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation flatten::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__2(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(flatten::s3, Data::F(flatten::s62, Data::F(flatten::s3, Data::F(flatten::s_nonvar, { var1->Deref() }), Data::F(flatten::s3, flatten::s1, Data::F(flatten::s_functor, { var1->Deref(), var2, var3 })))), Data::F(flatten::s_varbag, { var1->Deref(), flatten::posint1, var3->Deref() }))))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
	...
	Operation flatten::pred_$002D$002D$003E_2::exec_pred_$002D$002D$003E_2__3(Prolog* mach) {
		...
		if(!((areg1)->Unify(Data::F(flatten::s3, Data::F(flatten::s62, Data::F(flatten::s12, { var2->Deref(), var3->Deref() })), flatten::s1)))) {
			return Prolog::Fail0;
		}
		local_aregs[0] = continuation;
		mach->CUTB = mach->CurrentChoice;
