...
const Operation crypt::reg_top_0 = PredTable::Register("top", 0, new SxxMachine::sxx_library::pred_top_0());
const Operation crypt::reg_sum_3 = PredTable::Register("sum", 3, new pred_sum_3());
const Operation crypt::reg_sum_4 = PredTable::Register("sum", 4, new pred_sum_4());
const Operation crypt::reg_mult_3 = PredTable::Register("mult", 3, new pred_mult_3());
const Operation crypt::reg_mult_4 = PredTable::Register("mult", 4, new pred_mult_4());
const Operation crypt::reg_zero_1 = PredTable::Register("zero", 1, new pred_zero_1());
const Operation crypt::reg_odd_1 = PredTable::Register("odd", 1, new pred_odd_1());
const Operation crypt::reg_even_1 = PredTable::Register("even", 1, new pred_even_1());
const Operation crypt::reg_lefteven_1 = PredTable::Register("lefteven", 1, new pred_lefteven_1());
