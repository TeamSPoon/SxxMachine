...
Operation* const  nreverse::reg_top_0 = PredTable::Register("top",0, new SxxMachine::sxx_library::pred_top_0());
Operation* const  nreverse::reg_nreverse_0 = PredTable::Register("nreverse",0, new pred_nreverse_0());
Operation* const  nreverse::reg_nreverse_2 = PredTable::Register("nreverse",2, new pred_nreverse_2());
Operation* const  nreverse::reg_concatenate_3 = PredTable::Register("concatenate",3, new pred_concatenate_3());
	...
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(nreverse::s1,var1,var2),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg2)->Unify(Data::F(nreverse::s1, { var1->Deref(), var4 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var2->Deref();
