...
public:
	...
	static Operation* const  reg_toplevel_0;
	static Operation* const  reg_top_0;
	static Operation* const  reg_notmore_0;
	static Operation* const  reg_noteq_2;
	static Operation* const  reg_untilend_1;
	static Operation* const  reg_writevars_1;
	static Operation* const  reg_nrev_2;
	static Operation* const  reg_append_3;
	static Operation* const  reg_max_3;
	static Operation* const  reg_sort_2;
	static Operation* const  reg_split_4;
	static Operation* const  reg_time_1;
	static Operation* const  reg_exec_1;
	static Operation* const  reg_execdisj_2;
	static Operation* const  reg_loop_1;
	static Operation* const  reg_or_2;
	static Operation* const  reg_findall_3;
	static Operation* const  reg_findall2_4;
	static Operation* const  reg_copy_term_2;
	static Operation* const  reg_var_1;
	static Operation* const  reg_atomic_1;
	static Operation* const  reg_atomic2_1;
	static Operation* const  reg_atom_1;
	static Operation* const  reg_integer_1;
	static Operation* const  reg_assumeduring_2;
	static Operation* const  reg_assumed_1;
	static Operation* const  reg_m1_2;
	static Operation* const  reg_statistics_2;
	static Operation* const  reg_specialgoal_2;
	static Operation* const  reg_termsmallerthan_2;
	static Operation* const  reg_termgreaterthan_2;
	static Operation* const  reg_termsmallerequal_2;
	static Operation* const  reg_smeq_1;
	static Operation* const  reg_termgreaterequal_2;
	static Operation* const  reg_smgr_1;
	static Operation* const  reg_termequal_2;
	static Operation* const  reg_not_1;
	static Operation* const  reg_freeze_2;
	static Operation* const  reg_execpendinggoals_1;
public:
