...
const Operation sxx_meta::reg_forall_2 = PredTable::Register("forall", 2, new SxxMachine::sxx_meta::pred_forall_2());
const Operation sxx_meta::reg_undo_1 = PredTable::Register("undo", 1, new SxxMachine::Metaterm::pred_undo_1());
const Operation sxx_meta::reg_redo_each_call_3 = PredTable::Register("redo_each_call", 3, new SxxMachine::sxx_meta::pred_redo_each_call_3());
const Operation sxx_meta::reg_or_2 = PredTable::Register("or", 2, new SxxMachine::sxx_meta::pred_or_2());
const Operation sxx_meta::reg_one_of_or_else_3 = PredTable::Register("one_of_or_else", 3, new SxxMachine::sxx_meta::pred_one_of_or_else_3());
