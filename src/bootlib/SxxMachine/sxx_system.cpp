...
const Operation sxx_system::reg_on_load_sxx_system_0 = PredTable::Register("on_load_sxx_system", 0, new SxxMachine::sxx_system::pred_on_load_sxx_system_0());
const Operation sxx_system::reg_package_1 = PredTable::Register("package", 1, new SxxMachine::sxx_system::pred_package_1());
const Operation sxx_system::reg_system_predicate_1 = PredTable::Register("system_predicate", 1, new SxxMachine::sxx_system::pred_system_predicate_1());
