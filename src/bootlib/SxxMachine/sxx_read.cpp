...
Const* const  sxx_read::s_real = Data::Intern("real");
Const* const  sxx_read::s_smallerorequal = Data::Intern("smallerorequal");
Const* const  sxx_read::s_string = Data::Intern("string");
...
Const* const  sxx_read::s68 = Data::Intern("|");
...
Operation* const  sxx_read::reg_vread_2 = PredTable::Register("vread",2, new SxxMachine::sxx_read::pred_vread_2());
Operation* const  sxx_read::reg_read_1 = PredTable::Register("read",1, new SxxMachine::sxx_read::pred_read_1());
Operation* const  sxx_read::reg_collectvars_3 = PredTable::Register("collectvars",3, new SxxMachine::sxx_read::pred_collectvars_3());
Operation* const  sxx_read::reg_notvmember_2 = PredTable::Register("notvmember",2, new SxxMachine::sxx_read::pred_notvmember_2());
Operation* const  sxx_read::reg_readall_2 = PredTable::Register("readall",2, new SxxMachine::sxx_read::pred_readall_2());
Operation* const  sxx_read::reg_infix_3 = PredTable::Register("infix",3, new SxxMachine::sxx_read::pred_infix_3());
Operation* const  sxx_read::reg_prefix_3 = PredTable::Register("prefix",3, new SxxMachine::sxx_read::pred_prefix_3());
Operation* const  sxx_read::reg_maketerm_3 = PredTable::Register("maketerm",3, new SxxMachine::sxx_read::pred_maketerm_3());
Operation* const  sxx_read::reg_newprec_4 = PredTable::Register("newprec",4, new SxxMachine::sxx_read::pred_newprec_4());
Operation* const  sxx_read::reg_newprec_3 = PredTable::Register("newprec",3, new SxxMachine::sxx_read::pred_newprec_3());
Operation* const  sxx_read::reg_getargs_2 = PredTable::Register("getargs",2, new SxxMachine::sxx_read::pred_getargs_2());
Operation* const  sxx_read::reg_maketerm_2 = PredTable::Register("maketerm",2, new SxxMachine::sxx_read::pred_maketerm_2());
Operation* const  sxx_read::reg_ap_3 = PredTable::Register("ap",3, new SxxMachine::sxx_read::pred_ap_3());
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sxx_read::s9,Data::F(sxx_read::s_var,var1,var2,var3),var4),mach))) {
		return Prolog::Fail0;
	}
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sxx_read::s9,var1,var2),mach))) {
		return Prolog::Fail0;
	}
	...
	if(!((areg1)->Unify(Data::F(sxx_read::s9,Data::F(sxx_read::s17,var2,var1->Deref()),var3),mach))) {
		return Prolog::Fail0;
	}
	mach->DoCut(mach->CUTB);
	...
	if(!((areg1)->Unify(Data::F(sxx_read::s9,var2,var3),mach))) {
		return Prolog::Fail0;
	}
	...
	Term* areg0 = local_aregs[0]->Deref();
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(sxx_read::s_end_of_file,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	Term* areg0 = local_aregs[0]->Deref();
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(sxx_read::s_end_of_clause,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	if(!((areg1)->Unify(Data::F(sxx_read::s9, { var1->Deref(), var2 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var3;
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(sxx_read::posint1200,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(sxx_read::s_xfx,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(sxx_read::s13,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(sxx_read::posint1000,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(sxx_read::s_xfy,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(sxx_read::s6,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(sxx_read::posint1100,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(sxx_read::s_xfy,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(sxx_read::s14,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(sxx_read::posint1050,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(sxx_read::s_xfy,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(sxx_read::s8,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(sxx_read::posint700,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(sxx_read::s_xfx,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(sxx_read::s17,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s_is,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s18,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s21,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s26,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s28,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s27,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s29,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s19,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s15,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s20,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s22,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s23,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(sxx_read::posint550,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(sxx_read::s_xfy,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(sxx_read::s12,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(sxx_read::posint500,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(sxx_read::s_yfx,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(sxx_read::s5,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s7,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s1,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(sxx_read::posint400,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(sxx_read::s_yfx,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(sxx_read::s4,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s10,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s11,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s16,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg2)->Unify(sxx_read::s24,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(sxx_read::posint300,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(sxx_read::s_xfx,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(sxx_read::s_mod,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Term* areg1 = local_aregs[1]->Deref();
	Term* areg0 = local_aregs[0]->Deref();
	if(!((areg0)->Unify(sxx_read::posint200,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(sxx_read::s_xfy,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(sxx_read::s32,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	if(!((areg1)->Unify(sxx_read::s_fx,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(sxx_read::s13,mach))) {
		return Prolog::Fail0;
	...
	if(!((areg2)->Unify(sxx_read::s25,mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = continuation;
	mach->CUTB = mach->CurrentChoice;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sxx_read::s9,Data::F(sxx_read::s_var,var1,var2,var3),Const::Nil),mach))) {
		return Prolog::Fail0;
	}
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sxx_read::s9,Data::F(sxx_read::s_int,var1),Const::Nil),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var2,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sxx_read::s9,Data::F(sxx_read::s_real,var1),Const::Nil),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var2,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sxx_read::s9,Data::F(sxx_read::s_const,var1),Const::Nil),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var2,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sxx_read::s9,Data::F(sxx_read::s_string,var1),Const::Nil),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var2,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sxx_read::s9,Data::F(sxx_read::s_const,var1),Data::F(sxx_read::s9,Data::F(sxx_read::s_const,sxx_read::s2),var2)),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var3,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sxx_read::s9,Data::F(sxx_read::s_const,var1),var2),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var3,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sxx_read::s9,Data::F(sxx_read::s_const,sxx_read::s30),var1),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Data::F(sxx_read::s9,var2,var3),mach))) {
		return Prolog::Fail0;
	...
	Operation* sxx_read::pred_maketerm_3::exec_pred_maketerm_3__11(Prolog* mach) {
		mach->FillAlternative(SxxMachine::sxx_read::pred_maketerm_3::exec_pred_maketerm_3__12);
	std::vector<Term*> local_aregs = mach->Areg;
	Term* continuation = local_aregs[3];
	Term* areg2 = local_aregs[2]->Deref();
	Term* areg1 = local_aregs[1]->Deref();
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sxx_read::s9,Data::F(sxx_read::s_const,sxx_read::s2),var1),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var2,mach))) {
		return Prolog::Fail0;
	...
	Operation* sxx_read::pred_maketerm_3::exec_pred_maketerm_3__12(Prolog* mach) {
		mach->FillAlternative(SxxMachine::sxx_read::pred_maketerm_3::exec_pred_maketerm_3__13);
	std::vector<Term*> local_aregs = mach->Areg;
	Term* continuation = local_aregs[3];
	Term* areg2 = local_aregs[2]->Deref();
	Term* areg1 = local_aregs[1]->Deref();
	...
	if(!((areg1)->Unify(Data::F(sxx_read::s9,var2,Const::Nil),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg2)->Unify(var3,mach))) {
		return Prolog::Fail0;
	...
	Operation* sxx_read::pred_maketerm_3::exec_pred_maketerm_3__13(Prolog* mach) {
		mach->RemoveChoice();
	std::vector<Term*> local_aregs = mach->Areg;
	Term* continuation = local_aregs[3];
	Term* areg2 = local_aregs[2]->Deref();
	...
	Term* areg0 = local_aregs[0]->Deref();
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(Data::F(sxx_read::s9,Data::F(sxx_read::s_const,sxx_read::s30),Data::F(sxx_read::s9,Data::F(sxx_read::s_const,sxx_read::s31),Const::Nil)),mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(Const::Nil,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(sxx_read::s_xfx,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(sxx_read::s_xfy,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(sxx_read::s_yfx,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	Var* var2 = Data::V(mach);
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(sxx_read::s_fx,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	Term* areg0 = local_aregs[0]->Deref();
	Var* var1 = Data::V(mach);
	if(!((areg0)->Unify(sxx_read::s_fy,mach))) {
		return Prolog::Fail0;
	}
	if(!((areg1)->Unify(var1,mach))) {
		return Prolog::Fail0;
	...
	if(!((areg2)->Unify(Data::F(sxx_read::s9, { var1->Deref(), var4 }),mach))) {
		return Prolog::Fail0;
	}
	local_aregs[0] = var2->Deref();
	local_aregs[1] = var3->Deref();
