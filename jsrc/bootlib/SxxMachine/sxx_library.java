...
final static Operation reg_termsmallerthan_2 = PredTable.Register("termsmallerthan",2, new pred_termsmallerthan_2());
final static Operation reg_termgreaterthan_2 = PredTable.Register("termgreaterthan",2, new pred_termgreaterthan_2());
final static Operation reg_termsmallerequal_2 = PredTable.Register("termsmallerequal",2, new pred_termsmallerequal_2());
final static Operation reg_smeq_1 = PredTable.Register("smeq",1, new pred_smeq_1());
final static Operation reg_termgreaterequal_2 = PredTable.Register("termgreaterequal",2, new pred_termgreaterequal_2());
...
final static Operation reg_execpendinggoals_1 = PredTable.Register("execpendinggoals",1, new pred_execpendinggoals_1());
...
public static Operation exec_pred_toplevel_0__1(Prolog mach){ mach.FillAlternative(pred_toplevel_0::exec_pred_toplevel_0__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[0] ;
local_aregs[0] = Data.F(sxx_library.s_fail,continuation) ;
mach.CUTB = mach.CurrentChoice ;
return (Operation)pred_top_0::exec_static ;}
public static Operation exec_pred_toplevel_0__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[0] ;
...
public static Operation exec_pred_notmore_0__1(Prolog mach){ mach.FillAlternative(pred_notmore_0::exec_pred_notmore_0__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[0] ;
Var var1 = Data.V(mach) ;
...
public static Operation exec_pred_noteq_2__1(Prolog mach){ mach.FillAlternative(pred_noteq_2::exec_pred_noteq_2__2) ;
Term local_aregs[] = mach.Areg ;
...
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_noteq_2__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Operation exec_pred_untilend_1__1(Prolog mach){ mach.FillAlternative(pred_untilend_1::exec_pred_untilend_1__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
if (!( (areg0).Unify(sxx_library.posint10,mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
return Prolog.Call1 ;}
public static Operation exec_pred_untilend_1__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
...
public static Operation exec_pred_writevars_1__1(Prolog mach){ mach.FillAlternative(pred_writevars_1::exec_pred_writevars_1__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
...
local_aregs[1] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_writevars_1__2(Prolog mach){ mach.FillAlternative(pred_writevars_1::exec_pred_writevars_1__3) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
...
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s5,Data.F(sxx_library.s9,var1,var2),var3),mach))) return Prolog.Fail0 ;
...
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s5,var1,var2),mach))) return Prolog.Fail0 ;
local_aregs[0] = var2.Deref() ;
...
public static Operation exec_pred_nrev_2__1(Prolog mach){ mach.FillAlternative(pred_nrev_2::exec_pred_nrev_2__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_nrev_2__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
if (!( (areg0).Unify(Data.F(sxx_library.s5,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(var3,mach))) return Prolog.Fail0 ;
if (!( (areg2).Unify(Data.F(sxx_library.s5,var1.Deref(),var4),mach))) return Prolog.Fail0 ;
local_aregs[0] = var2.Deref() ;
...
public static Operation exec_pred_max_3__1(Prolog mach){ mach.FillAlternative(pred_max_3::exec_pred_max_3__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[3] ;
Term areg2 = local_aregs[2].Deref() ;
Term areg1 = local_aregs[1].Deref() ;
...
public static Operation exec_pred_max_3__2(Prolog mach){ mach.FillAlternative(pred_max_3::exec_pred_max_3__3) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[3] ;
Term areg2 = local_aregs[2].Deref() ;
Term areg1 = local_aregs[1].Deref() ;
...
local_aregs[3] = null ;
return (Operation)pred_smallerthan_2::exec_static ;}
public static Operation exec_pred_max_3__3(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[3] ;
Term areg2 = local_aregs[2].Deref() ;
Term areg1 = local_aregs[1].Deref() ;
...
public static Operation exec_pred_sort_2__1(Prolog mach){ mach.FillAlternative(pred_sort_2::exec_pred_sort_2__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_sort_2__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(var1,mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s5,var2,var3),mach))) return Prolog.Fail0 ;
if (!( (areg2).Unify(Data.F(sxx_library.s5,var2.Deref(),var4),mach))) return Prolog.Fail0 ;
...
return (Operation)pred_smallerthan_2::exec_static ;}
public static Operation exec_pred_split_4__3(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[4] ;
Term areg3 = local_aregs[3].Deref() ;
Term areg2 = local_aregs[2].Deref() ;
...
if (!( (areg3).Unify(Data.F(sxx_library.s5,var2.Deref(),var5),mach))) return Prolog.Fail0 ;
local_aregs[0] = var1.Deref() ;
local_aregs[1] = var3.Deref() ;
local_aregs[2] = var4.Deref() ;
...
public static Operation exec_pred_time_1__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var4 = Data.V(mach) ;
...
public static Operation exec_pred_exec_1__1(Prolog mach){ mach.FillAlternative(pred_exec_1::exec_pred_exec_1__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var1 = Data.V(mach) ;
...
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s2,var1,var2),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = Data.F(sxx_library.s_exec,var1.Deref(),Data.F(sxx_library.s_exec,var2.Deref(),continuation)) ;
mach.CUTB = mach.CurrentChoice ;
return Prolog.Call1 ;}
public static Operation exec_pred_exec_1__3(Prolog mach){ mach.FillAlternative(pred_exec_1::exec_pred_exec_1__4) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s4,var1,var2),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = Data.F(sxx_library.s_execdisj,Data.F(sxx_library.s4,var1.Deref(),var2.Deref()),sxx_library.s_true,continuation) ;
mach.CUTB = mach.CurrentChoice ;
return Prolog.Call1 ;}
public static Operation exec_pred_exec_1__4(Prolog mach){ mach.FillAlternative(pred_exec_1::exec_pred_exec_1__5) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s7,var1,var2),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = Data.F(sxx_library.s_execdisj,var1.Deref(),var2.Deref(),continuation) ;
mach.CUTB = mach.CurrentChoice ;
return Prolog.Call1 ;}
public static Operation exec_pred_exec_1__5(Prolog mach){ mach.FillAlternative(pred_exec_1::exec_pred_exec_1__6) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
...
public static Operation exec_pred_exec_1__6(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var1 = Data.V(mach) ;
...
public static Operation exec_pred_execdisj_2__1(Prolog mach){ mach.FillAlternative(pred_execdisj_2::exec_pred_execdisj_2__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Operation exec_pred_execdisj_2__2(Prolog mach){ mach.FillAlternative(pred_execdisj_2::exec_pred_execdisj_2__3) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_execdisj_2__3(Prolog mach){ mach.FillAlternative(pred_execdisj_2::exec_pred_execdisj_2__4) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
local_aregs[2] = null ;
return (Operation)pred_exec_1::exec_static ;}
public static Operation exec_pred_execdisj_2__4(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Operation exec_pred_loop_1__1(Prolog mach){ mach.FillAlternative(pred_loop_1::exec_pred_loop_1__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
if (!( (areg0).Unify(sxx_library.posint0,mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
return Prolog.Call1 ;}
public static Operation exec_pred_loop_1__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
...
public static Operation exec_pred_or_2__1(Prolog mach){ mach.FillAlternative(pred_or_2::exec_pred_or_2__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
local_aregs[2] = null ;
return (Operation)pred_exec_1::exec_static ;}
public static Operation exec_pred_or_2__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Operation exec_pred_findall_3__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[3] ;
Term areg2 = local_aregs[2].Deref() ;
Term areg1 = local_aregs[1].Deref() ;
...
public static Operation exec_pred_findall2_4__1(Prolog mach){ mach.FillAlternative(pred_findall2_4::exec_pred_findall2_4__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[4] ;
Term areg3 = local_aregs[3].Deref() ;
Term areg2 = local_aregs[2].Deref() ;
...
local_aregs[4] = local_aregs[3] = local_aregs[2] = null ;
return (Operation)pred_exec_1::exec_static ;}
public static Operation exec_pred_findall2_4__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[4] ;
Term areg3 = local_aregs[3].Deref() ;
Term areg2 = local_aregs[2].Deref() ;
...
public static Operation exec_pred_copy_term_2__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Operation exec_pred_var_1__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var1 = Data.V(mach) ;
...
public static Operation exec_pred_atomic_1__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
...
public static Operation exec_pred_atomic2_1__1(Prolog mach){ mach.FillAlternative(pred_atomic2_1::exec_pred_atomic2_1__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
if (!( (areg0).Unify(sxx_library.s_atom,mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
return Prolog.Call1 ;}
public static Operation exec_pred_atomic2_1__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
if (!( (areg0).Unify(sxx_library.s_integer,mach))) return Prolog.Fail0 ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[1] = null ;
return Prolog.Call1 ;}
...
public static Operation exec_pred_atom_1__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var1 = Data.V(mach) ;
...
public static Operation exec_pred_integer_1__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var1 = Data.V(mach) ;
...
public static Operation exec_pred_assumeduring_2__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Operation exec_pred_assumed_1__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
...
public static Operation exec_pred_m1_2__1(Prolog mach){ mach.FillAlternative(pred_m1_2::exec_pred_m1_2__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(var1,mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s5,Data.F(sxx_library.s3,var1.Deref(),var2),var3),mach))) return Prolog.Fail0 ;
local_aregs[0] = var2.Deref() ;
local_aregs[1] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = null ;
...
public static Operation exec_pred_statistics_2__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(sxx_library.s_runtime,mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s5,var1,Data.F(sxx_library.s5,var2,Const.Nil)),mach))) return Prolog.Fail0 ;
local_aregs[0] = var1.Deref() ;
local_aregs[1] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = null ;
...
public static Operation exec_pred_specialgoal_2__1(Prolog mach){ mach.FillAlternative(pred_specialgoal_2::exec_pred_specialgoal_2__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s8,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s_smallerthan,var1.Deref(),var2.Deref()),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_specialgoal_2__2(Prolog mach){ mach.FillAlternative(pred_specialgoal_2::exec_pred_specialgoal_2__3) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s11,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s_smallerorequal,var1.Deref(),var2.Deref()),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_specialgoal_2__3(Prolog mach){ mach.FillAlternative(pred_specialgoal_2::exec_pred_specialgoal_2__4) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s13,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s_smallerthan,var2.Deref(),var1.Deref()),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_specialgoal_2__4(Prolog mach){ mach.FillAlternative(pred_specialgoal_2::exec_pred_specialgoal_2__5) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s14,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s_smallerorequal,var2.Deref(),var1.Deref()),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_specialgoal_2__5(Prolog mach){ mach.FillAlternative(pred_specialgoal_2::exec_pred_specialgoal_2__6) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s10,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s_arithequal,var2.Deref(),var1.Deref()),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_specialgoal_2__6(Prolog mach){ mach.FillAlternative(pred_specialgoal_2::exec_pred_specialgoal_2__7) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s9,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s_unify,var2.Deref(),var1.Deref()),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_specialgoal_2__7(Prolog mach){ mach.FillAlternative(pred_specialgoal_2::exec_pred_specialgoal_2__8) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s7,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s_or,var1.Deref(),var2.Deref()),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_specialgoal_2__8(Prolog mach){ mach.FillAlternative(pred_specialgoal_2::exec_pred_specialgoal_2__9) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s16,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s_termsmallerthan,var1.Deref(),var2.Deref()),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_specialgoal_2__9(Prolog mach){ mach.FillAlternative(pred_specialgoal_2::exec_pred_specialgoal_2__10) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s18,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s_termgreaterthan,var1.Deref(),var2.Deref()),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_specialgoal_2__10(Prolog mach){ mach.FillAlternative(pred_specialgoal_2::exec_pred_specialgoal_2__11) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s17,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s_termsmallerequal,var1.Deref(),var2.Deref()),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_specialgoal_2__11(Prolog mach){ mach.FillAlternative(pred_specialgoal_2::exec_pred_specialgoal_2__12) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s19,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s_termgreaterequal,var1.Deref(),var2.Deref()),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = null ;
return Prolog.Call1 ;}
public static Operation exec_pred_specialgoal_2__12(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(sxx_library.s12,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(Data.F(sxx_library.s_termequal,var1.Deref(),var2.Deref()),mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = null ;
...
public static Operation exec_pred_termsmallerthan_2__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Operation exec_pred_termgreaterthan_2__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Operation exec_pred_termsmallerequal_2__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Operation exec_pred_smeq_1__1(Prolog mach){ mach.FillAlternative(pred_smeq_1::exec_pred_smeq_1__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
if (!( (areg0).Unify(sxx_library.s8,mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
return Prolog.Call1 ;}
public static Operation exec_pred_smeq_1__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
if (!( (areg0).Unify(sxx_library.s9,mach))) return Prolog.Fail0 ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[1] = null ;
return Prolog.Call1 ;}
...
public static Operation exec_pred_termgreaterequal_2__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Operation exec_pred_smgr_1__1(Prolog mach){ mach.FillAlternative(pred_smgr_1::exec_pred_smgr_1__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
if (!( (areg0).Unify(sxx_library.s13,mach))) return Prolog.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
return Prolog.Call1 ;}
public static Operation exec_pred_smgr_1__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
if (!( (areg0).Unify(sxx_library.s9,mach))) return Prolog.Fail0 ;
...
public static Operation exec_pred_termequal_2__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Operation exec_pred_not_1__1(Prolog mach){ mach.FillAlternative(pred_not_1::exec_pred_not_1__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var1 = Data.V(mach) ;
...
mach.CUTB = mach.CurrentChoice ;
return (Operation)pred_exec_1::exec_static ;}
public static Operation exec_pred_not_1__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var1 = Data.V(mach) ;
...
public static Operation exec_pred_freeze_2__1(Prolog mach){ mach.FillAlternative(pred_freeze_2::exec_pred_freeze_2__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Operation exec_pred_execpendinggoals_1__1(Prolog mach){ mach.FillAlternative(pred_execpendinggoals_1::exec_pred_execpendinggoals_1__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
if (!( (areg0).Unify(Const.Nil,mach))) return Prolog.Fail0 ;
...
public static Operation exec_pred_execpendinggoals_1__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[1] ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = Data.V(mach) ;
