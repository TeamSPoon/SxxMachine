...
class meta_qsort /* extends CodeFile */ {
...
class pred_meta_qsort_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_meta_qsort_0__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[0];
...
class pred_interpret_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_interpret_1__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		...
		local_aregs[1] = var2;
		local_aregs[2] = F(meta_qsort.s21,
				F(meta_qsort.s2, F(meta_qsort.s19, var2.Deref()),
						F(meta_qsort.s2, meta_qsort.s1, F(meta_qsort.s14, var2.Deref()))),
				meta_qsort.s26, continuation);
		mach.CUTB = mach.CurrentChoice;
...
class pred_interpret_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_interpret_2__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_interpret_2__2(PrologMachine mach) {
		...
		local_aregs[0] = F(meta_qsort.s14, var1.Deref(), var4,
				F(meta_qsort.s21,
						F(meta_qsort.s3, F(meta_qsort.s19, var4.Deref()),
								F(meta_qsort.s7, var3.Deref(), F(meta_qsort.s2, var4.Deref(), var2.Deref()))),
						F(meta_qsort.s14, var2.Deref(), var3.Deref()), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[2] = null;
		return UpperPrologMachine.Cut2;
	}

	public static Function<PrologMachine, Function> exec_pred_interpret_2__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_interpret_2__4(PrologMachine mach) {
		...
		if (!((areg1).Unify(var3)))
			return UpperPrologMachine.Fail0;
		mach.DoCut(mach.CUTB);
		local_aregs[0] = F(meta_qsort.s16, F(meta_qsort.s3, var1.Deref(), var2.Deref()), meta_qsort.s13, var3.Deref(),
				continuation);
		mach.CUTB = mach.CurrentChoice;
		local_aregs[2] = null;
		return UpperPrologMachine.Cut2;
	...
	public static Function<PrologMachine, Function> exec_pred_interpret_2__5(PrologMachine mach) {
		...
		if (!((areg1).Unify(var2)))
			return UpperPrologMachine.Fail0;
		mach.DoCut(mach.CUTB);
		local_aregs[0] = F(meta_qsort.s16, F(meta_qsort.s3, var1.Deref(), meta_qsort.s13), meta_qsort.s26, var2.Deref(),
				continuation);
		mach.CUTB = mach.CurrentChoice;
		local_aregs[2] = null;
		return UpperPrologMachine.Cut2;
	...
	public static Function<PrologMachine, Function> exec_pred_interpret_2__6(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_interpret_2__7(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_interpret_2__8(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_interpret_2__9(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
...
class pred_interpret_disjunction_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_interpret_disjunction_3__1(PrologMachine mach) {
		...
		local_aregs[0] = var1.Deref();
		local_aregs[1] = var5;
		local_aregs[2] = F(meta_qsort.s0, new HeapChoice(mach.CUTB),
				F(meta_qsort.s21,
						F(meta_qsort.s3, F(meta_qsort.s19, var5.Deref()),
								F(meta_qsort.s7, var4.Deref(), F(meta_qsort.s3, var5.Deref(), var2.Deref()))),
						F(meta_qsort.s14, var2.Deref(), var4.Deref()), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_interpret_2::exec_static;
	}

	public static Function<PrologMachine, Function> exec_pred_interpret_disjunction_3__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_interpret_disjunction_3__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_interpret_disjunction_3__4(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
...
class pred_is_built_in_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_is_built_in_1__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_is_built_in_1__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
...
class pred_interpret_built_in_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_interpret_built_in_1__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_interpret_built_in_1__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
...
class pred_define_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_define_2__1(PrologMachine mach) {
		...
		if (!((areg0).Unify(meta_qsort.s23)))
			return UpperPrologMachine.Fail0;
		if (!((areg1).Unify(F(meta_qsort.s23, F(meta_qsort.s4, meta_qsort.posint27, F(meta_qsort.s4,
				meta_qsort.posint74, F(meta_qsort.s4, meta_qsort.posint17, F(meta_qsort.s4, meta_qsort.posint33, F(
						meta_qsort.s4, meta_qsort.posint94,
						F(meta_qsort.s4, meta_qsort.posint18, F(meta_qsort.s4, meta_qsort.posint46, F(meta_qsort.s4,
								meta_qsort.posint83,
								F(meta_qsort.s4, meta_qsort.posint65, F(meta_qsort.s4, meta_qsort.posint2, F(
										meta_qsort.s4, meta_qsort.posint32,
										F(meta_qsort.s4, meta_qsort.posint53, F(meta_qsort.s4, meta_qsort.posint28, F(
												meta_qsort.s4, meta_qsort.posint85,
												F(meta_qsort.s4, meta_qsort.posint99, F(meta_qsort.s4,
														meta_qsort.posint47,
														F(meta_qsort.s4, meta_qsort.posint28, F(meta_qsort.s4,
																meta_qsort.posint82,
																F(meta_qsort.s4, meta_qsort.posint6, F(meta_qsort.s4,
																		meta_qsort.posint11,
																		F(meta_qsort.s4, meta_qsort.posint55, F(
																				meta_qsort.s4, meta_qsort.posint29,
																				F(meta_qsort.s4, meta_qsort.posint39, F(
																						meta_qsort.s4,
																						meta_qsort.posint81,
																						F(meta_qsort.s4,
																								meta_qsort.posint90,
	...
	public static Function<PrologMachine, Function> exec_pred_define_2__2(PrologMachine mach) {
		...
		if (!((areg0).Unify(F(meta_qsort.s23, F(meta_qsort.s4, var1, var2), var3, var4))))
			return UpperPrologMachine.Fail0;
		if (!((areg1).Unify(F(meta_qsort.s2, F(meta_qsort.s22, var2.Deref(), var1.Deref(), var5, var6),
				F(meta_qsort.s2, F(meta_qsort.s23, var6.Deref(), var7, var4.Deref()),
						F(meta_qsort.s23, var5.Deref(), var3.Deref(), F(meta_qsort.s4, var1.Deref(), var7.Deref())))))))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = continuation;
		mach.CUTB = mach.CurrentChoice;
		local_aregs[2] = local_aregs[1] = null;
	...
	public static Function<PrologMachine, Function> exec_pred_define_2__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_define_2__4(PrologMachine mach) {
		...
		Var var1 = V(mach);
		if (!((areg0).Unify(
				F(meta_qsort.s22, F(meta_qsort.s4, var1, var2), var3, F(meta_qsort.s4, var1.Deref(), var4), var5))))
			return UpperPrologMachine.Fail0;
		if (!((areg1).Unify(F(meta_qsort.s2, F(meta_qsort.s8, var1.Deref(), var3.Deref()), F(meta_qsort.s2,
				meta_qsort.s1, F(meta_qsort.s22, var2.Deref(), var3.Deref(), var4.Deref(), var5.Deref()))))))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = continuation;
		mach.CUTB = mach.CurrentChoice;
		local_aregs[2] = local_aregs[1] = null;
	...
	public static Function<PrologMachine, Function> exec_pred_define_2__5(PrologMachine mach) {
		...
		Var var1 = V(mach);
		if (!((areg0).Unify(
				F(meta_qsort.s22, F(meta_qsort.s4, var1, var2), var3, var4, F(meta_qsort.s4, var1.Deref(), var5)))))
			return UpperPrologMachine.Fail0;
	...
	public static Function<PrologMachine, Function> exec_pred_define_2__6(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
