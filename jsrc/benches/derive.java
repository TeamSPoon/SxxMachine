import java.util.function.Function; class derive /*extends CodeFile*/ {static Const s0 = Const.Intern("cut") ;
...
public static Function<PrologMachine,Function> exec_pred_ops8_0__1(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[0] ;
Var var1 = V(mach) ;
...
log10(_9316):-d(log(log(log(log(log(log(log(log(log(log(x)))))))))),x,_9294,_9316).
...
public static Function<PrologMachine,Function> exec_pred_divide10_0__1(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[0] ;
Var var1 = V(mach) ;
...
d(_9610+_9612,_9624,_9616+_9618,_9694):-cut(1,d(_9610,_9624,_9616,d(_9612,_9624,_9618,_9694))).
d(_9904-_9906,_9918,_9910-_9912,_9988):-cut(1,d(_9904,_9918,_9910,d(_9906,_9918,_9912,_9988))).
d(_10198*_10200,_10224,_10204*_10200+_10198*_10212,_10294):-cut(1,d(_10198,_10224,_10204,d(_10200,_10224,_10212,_10294))).
d(_10504/_10506,_10542,(_10510*_10506-_10504*_10518)/_10506^2,_10612):-cut(1,d(_10504,_10542,_10510,d(_10506,_10542,_10518,_10612))).
d(_10822^_10824,_10848,_10828*_10824*_10822^_10836,_10932):-cut(1,integer(_10824,is(_10836,_10824-1,d(_10822,_10848,_10828,_10932)))).
d(-_11164,_11174,-_11168,_11230):-cut(1,d(_11164,_11174,_11168,_11230)).
d(exp(_11376),_11392,exp(_11376)*_11386,_11448):-cut(1,d(_11376,_11392,_11386,_11448)).
d(log(_11594),_11606,_11598/_11594,_11662):-cut(1,d(_11594,_11606,_11598,_11662)).
d(_11808,_11808,1,_11852):-cut(1,_11852).
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(derive.s2,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(derive.s2,var4,var5)))) return UpperPrologMachine.Fail0 ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(derive.s3,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(derive.s3,var4,var5)))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(derive.s10,var1.Deref(),var3.Deref(),var4.Deref(),F(derive.s10,var2.Deref(),var3.Deref(),var5.Deref(),continuation)) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(derive.s1,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(derive.s2,F(derive.s1,var4,var2.Deref()),F(derive.s1,var1.Deref(),var5))))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(derive.s10,var1.Deref(),var3.Deref(),var4.Deref(),F(derive.s10,var2.Deref(),var3.Deref(),var5.Deref(),continuation)) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(derive.s5,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(derive.s5,F(derive.s3,F(derive.s1,var4,var2.Deref()),F(derive.s1,var1.Deref(),var5)),F(derive.s7,var2.Deref(),derive.posint2))))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(derive.s10,var1.Deref(),var3.Deref(),var4.Deref(),F(derive.s10,var2.Deref(),var3.Deref(),var5.Deref(),continuation)) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(derive.s7,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(derive.s1,F(derive.s1,var4,var2.Deref()),F(derive.s7,var1.Deref(),var5))))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(derive.s3,var1)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var2))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(derive.s3,var3)))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(derive.s12,var1)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var2))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(derive.s1,F(derive.s12,var1.Deref()),var3)))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(derive.s10,var1.Deref(),var2.Deref(),var3.Deref(),continuation) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(derive.s15,var1)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var2))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(derive.s5,var3,var1.Deref())))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(derive.s10,var1.Deref(),var2.Deref(),var3.Deref(),continuation) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
if (!( (areg2).Unify(derive.posint1))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
...
if (!( (areg0).Unify(var1))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var2))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(derive.posint0))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
