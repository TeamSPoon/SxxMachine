import java.util.function.Function; class divide10 /*extends CodeFile*/ {static Const s0 = Const.Intern("cut") ;
...
d(_13378+_13380,_13392,_13384+_13386,_13462):-cut(1,d(_13378,_13392,_13384,d(_13380,_13392,_13386,_13462))).
d(_13660-_13662,_13674,_13666-_13668,_13744):-cut(1,d(_13660,_13674,_13666,d(_13662,_13674,_13668,_13744))).
d(_13942*_13944,_13968,_13948*_13944+_13942*_13956,_14038):-cut(1,d(_13942,_13968,_13948,d(_13944,_13968,_13956,_14038))).
d(_14236/_14238,_14274,(_14242*_14238-_14236*_14250)/_14238^2,_14344):-cut(1,d(_14236,_14274,_14242,d(_14238,_14274,_14250,_14344))).
d(_14542^_14544,_14568,_14548*_14544*_14542^_14556,_14652):-cut(1,integer(_14544,is(_14556,_14544-1,d(_14542,_14568,_14548,_14652)))).
d(-_14872,_14882,-_14876,_14938):-cut(1,d(_14872,_14882,_14876,_14938)).
d(exp(_15072),_15088,exp(_15072)*_15082,_15144):-cut(1,d(_15072,_15088,_15082,_15144)).
d(log(_15278),_15290,_15282/_15278,_15346):-cut(1,d(_15278,_15290,_15282,_15346)).
d(_15480,_15480,1,_15524):-cut(1,_15524).
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(divide10.s2,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(divide10.s2,var4,var5)))) return UpperPrologMachine.Fail0 ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(divide10.s3,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(divide10.s3,var4,var5)))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(divide10.s10,var1.Deref(),var3.Deref(),var4.Deref(),F(divide10.s10,var2.Deref(),var3.Deref(),var5.Deref(),continuation)) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(divide10.s1,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(divide10.s2,F(divide10.s1,var4,var2.Deref()),F(divide10.s1,var1.Deref(),var5))))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(divide10.s10,var1.Deref(),var3.Deref(),var4.Deref(),F(divide10.s10,var2.Deref(),var3.Deref(),var5.Deref(),continuation)) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(divide10.s5,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(divide10.s5,F(divide10.s3,F(divide10.s1,var4,var2.Deref()),F(divide10.s1,var1.Deref(),var5)),F(divide10.s7,var2.Deref(),divide10.posint2))))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(divide10.s10,var1.Deref(),var3.Deref(),var4.Deref(),F(divide10.s10,var2.Deref(),var3.Deref(),var5.Deref(),continuation)) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(divide10.s7,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(divide10.s1,F(divide10.s1,var4,var2.Deref()),F(divide10.s7,var1.Deref(),var5))))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(divide10.s3,var1)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var2))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(divide10.s3,var3)))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(divide10.s12,var1)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var2))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(divide10.s1,F(divide10.s12,var1.Deref()),var3)))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(divide10.s10,var1.Deref(),var2.Deref(),var3.Deref(),continuation) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(divide10.s15,var1)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var2))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(divide10.s5,var3,var1.Deref())))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(divide10.s10,var1.Deref(),var2.Deref(),var3.Deref(),continuation) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
if (!( (areg2).Unify(divide10.posint1))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
if (!( (areg0).Unify(var1))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var2))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(divide10.posint0))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
