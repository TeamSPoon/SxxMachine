...
class pred_log10_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_log10_0__1(PrologMachine mach) {
		...
		Term continuation = local_aregs[0];
		Var var1 = V(mach);
		local_aregs[0] = F(log10.s14, F(log10.s14, F(log10.s14, F(log10.s14,
				F(log10.s14, F(log10.s14, F(log10.s14, F(log10.s14, F(log10.s14, F(log10.s14, log10.s17))))))))));
...
class pred_d_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_d_3__1(PrologMachine mach) {
		...
		local_aregs[0] = F(log10.s10, var1.Deref(), var3.Deref(), var4.Deref(),
				F(log10.s10, var2.Deref(), var3.Deref(), var5.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
	...
	public static Function<PrologMachine, Function> exec_pred_d_3__4(PrologMachine mach) {
		...
		if (!((areg1).Unify(var3)))
			return UpperPrologMachine.Fail0;
		if (!((areg2).Unify(F(log10.s5, F(log10.s3, F(log10.s1, var4, var2.Deref()), F(log10.s1, var1.Deref(), var5)),
				F(log10.s7, var2.Deref(), log10.posint2)))))
			return UpperPrologMachine.Fail0;
		mach.DoCut(mach.CUTB);
		local_aregs[0] = F(log10.s10, var1.Deref(), var3.Deref(), var4.Deref(),
				F(log10.s10, var2.Deref(), var3.Deref(), var5.Deref(), continuation));
	...
	public static Function<PrologMachine, Function> exec_pred_d_3__5(PrologMachine mach) {
		...
		if (!((areg2).Unify(F(log10.s1, F(log10.s1, var4, var2.Deref()), F(log10.s7, var1.Deref(), var5)))))
			return UpperPrologMachine.Fail0;
		mach.DoCut(mach.CUTB);
		local_aregs[0] = F(log10.s12, var2.Deref(), F(log10.s13, var5.Deref(), F(log10.s3, var2.Deref(), log10.posint1),
				F(log10.s10, var1.Deref(), var3.Deref(), var4.Deref(), continuation)));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = local_aregs[2] = null;
		return UpperPrologMachine.Cut2;
	}
