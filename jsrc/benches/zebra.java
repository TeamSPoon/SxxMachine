...
class pred_top_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_top_0__1(PrologMachine mach) {
		...
		Var var1 = V(mach);
		local_aregs[0] = var1;
		local_aregs[1] = F(zebra.s19, F(zebra.s13, zebra.s27, zebra.s9, var2, var3, var4), var1.Deref(), F(zebra.s19,
				F(zebra.s13, var5, zebra.s30, zebra.s8, var6, var7), var1.Deref(),
				F(zebra.s19, F(zebra.s13, zebra.s11, var8, var9, zebra.s6, var10), var1.Deref(), F(zebra.s19,
						F(zebra.s13, var11, zebra.s33, var12, zebra.s31, var13), var1.Deref(),
						F(zebra.s28, F(zebra.s13, zebra.s11, var14, var15, var16, var17),
								F(zebra.s13, zebra.s15, var18, var19, var20, var21), var1.Deref(),
								F(zebra.s19, F(zebra.s13, var22, var23, zebra.s29, var24, zebra.s36), var1.Deref(), F(
										zebra.s19, F(zebra.s13, zebra.s38, var25, var26, var27, zebra.s17),
										var1.Deref(),
										F(zebra.s34,
												F(zebra.s1, var28, F(zebra.s1, var29,
														F(zebra.s1, F(zebra.s13, var30, var31, var32, zebra.s20, var33),
																F(zebra.s1, var34, F(zebra.s1, var35, Const.Nil))))),
												var1.Deref(),
												F(zebra.s34, F(zebra.s1,
														F(zebra.s13, var36, zebra.s23, var37, var38, var39), var40),
														var1.Deref(),
														F(zebra.s21, F(zebra.s13, var41, var42, var43, var44, zebra.s5),
																F(zebra.s13, var45, var46, zebra.s10, var47, var48),
																var1.Deref(),
																F(zebra.s21,
																		F(zebra.s13, var49, var50, var51, var52,
																				zebra.s17),
																		F(zebra.s13, var53, var54, zebra.s12, var55,
																				var56),
																		var1.Deref(),
																		F(zebra.s19,
																				F(zebra.s13, var57, var58, var59,
																						zebra.s24, zebra.s18),
																				var1.Deref(),
																				F(zebra.s19,
																						F(zebra.s13, var60, zebra.s16,
																								var61, var62,
																								zebra.s25),
																						var1.Deref(),
																						F(zebra.s21, F(zebra.s13, var63,
																								zebra.s23, var64, var65,
																								var66),
																								F(zebra.s13, zebra.s3,
																										var67, var68,
																										var69, var70),
																								var1.Deref(),
																								F(zebra.s19, F(
...
class pred_houses_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_houses_1__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		...
		Var var1 = V(mach);
		if (!((areg0)
				.Unify(F(zebra.s1, F(zebra.s13, var1, var2, var3, var4, var5),
						F(zebra.s1, F(zebra.s13, var6, var7, var8, var9, var10),
								F(zebra.s1, F(zebra.s13, var11, var12, var13, var14, var15), F(zebra.s1,
										F(zebra.s13, var16, var17, var18, var19, var20),
										F(zebra.s1, F(zebra.s13, var21, var22, var23, var24, var25), Const.Nil))))))))
...
class pred_right_of_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_right_of_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_right_of_3__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
...
class pred_next_to_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_next_to_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_next_to_3__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_next_to_3__3(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
...
class pred_print_houses_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_print_houses_1__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_print_houses_1__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
