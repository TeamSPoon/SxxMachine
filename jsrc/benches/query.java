...
class pred_query_0 extends Code {
	...
	/*
	 * 
	 * query(_33808):-query(_33780,fail(_33808)). query(_33918):-call(_33918).
	 * 
	 * 
	 */
	...
	public static Function<PrologMachine, Function> exec_pred_query_0__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_query_0__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[0];
		local_aregs[0] = continuation;
...
class pred_query_1 extends Code {
	...
	/*
	 * 
	 * query([_33962,_33968,_33974,_33980],_34092):-density(_33962,_33968,density(
	 * _33974,_33980,smallerthan(_33980,_33968,is(_34014,20*_33968,is(_34026,21*
	 * _33980,smallerthan(_34014,_34026,_34092)))))).
	 * 
	 * 
	 */
	...
	public static Function<PrologMachine, Function> exec_pred_query_1__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		...
		local_aregs[2] = F(query.s11, var3.Deref(), var4.Deref(),
				F(query.s30, var4.Deref(), var2.Deref(),
						F(query.s19, var5, F(query.s1, query.posint20, var2.Deref()),
								F(query.s19, var6, F(query.s1, query.posint21, var4.Deref()),
										F(query.s30, var5.Deref(), var6.Deref(), continuation)))));
		mach.CUTB = mach.CurrentChoice;
...
class pred_density_2 extends Code {
	...
	/*
	 * 
	 * density(_34452,_34454,_34530):-pop(_34452,_34460,area(_34452,_34466,is(_34454
	 * ,_34460*100//_34466,_34530))).
	 * 
	 * 
	 */
	...
	public static Function<PrologMachine, Function> exec_pred_density_2__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		...
		local_aregs[0] = var1.Deref();
		local_aregs[1] = var3;
		local_aregs[2] = F(query.s5, var1.Deref(), var4, F(query.s19, var2.Deref(),
				F(query.s3, F(query.s1, var3.Deref(), query.posint100), var4.Deref()), continuation));
		mach.CUTB = mach.CurrentChoice;
...
class pred_pop_2 extends Code {
	...
	/*
	 * 
	 * pop(china,8250,_34766):-call(_34766). pop(india,5863,_34880):-call(_34880).
	 * pop(ussr,2521,_34994):-call(_34994). pop(usa,2119,_35108):-call(_35108).
	 * pop(indonesia,1276,_35222):-call(_35222).
	 * pop(japan,1097,_35336):-call(_35336). pop(brazil,1042,_35450):-call(_35450).
	 * pop(bangladesh,750,_35564):-call(_35564).
	 * pop(pakistan,682,_35678):-call(_35678).
	 * pop(w_germany,620,_35792):-call(_35792).
	 * pop(nigeria,613,_35906):-call(_35906). pop(mexico,581,_36020):-call(_36020).
	 * pop(uk,559,_36134):-call(_36134). pop(italy,554,_36248):-call(_36248).
	 * pop(france,525,_36362):-call(_36362).
	 * pop(philippines,415,_36476):-call(_36476).
	 * pop(thailand,410,_36590):-call(_36590). pop(turkey,383,_36704):-call(_36704).
	 * pop(egypt,364,_36818):-call(_36818). pop(spain,352,_36932):-call(_36932).
	 * pop(poland,337,_37046):-call(_37046). pop(s_korea,335,_37160):-call(_37160).
	 * pop(iran,320,_37274):-call(_37274). pop(ethiopia,272,_37388):-call(_37388).
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__4(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__5(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__6(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__7(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__8(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__9(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__10(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__11(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__12(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__13(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__14(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__15(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__16(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__17(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__18(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__19(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__20(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__21(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__22(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__23(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__24(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_pop_2__25(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
...
class pred_area_2 extends Code {
	...
	/*
	 * 
	 * area(china,3380,_37616):-call(_37616). area(india,1139,_37736):-call(_37736).
	 * area(ussr,8708,_37856):-call(_37856). area(usa,3609,_37976):-call(_37976).
	 * area(indonesia,570,_38096):-call(_38096).
	 * area(japan,148,_38216):-call(_38216). area(brazil,3288,_38336):-call(_38336).
	 ...
	 * area(mexico,764,_38936):-call(_38936). area(uk,86,_39056):-call(_39056).
	 * area(italy,116,_39176):-call(_39176). area(france,213,_39296):-call(_39296).
	 * area(philippines,90,_39416):-call(_39416).
	 * area(thailand,200,_39536):-call(_39536).
	 * area(turkey,296,_39656):-call(_39656). area(egypt,386,_39776):-call(_39776).
	 * area(spain,190,_39896):-call(_39896). area(poland,121,_40016):-call(_40016).
	 * area(s_korea,37,_40136):-call(_40136). area(iran,628,_40256):-call(_40256).
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__4(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__5(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__6(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__7(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__8(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__9(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__10(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__11(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__12(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__13(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__14(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__15(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__16(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__17(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__18(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__19(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__20(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__21(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__22(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__23(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__24(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_area_2__25(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
