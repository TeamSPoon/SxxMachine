...
class pred_on_load_run_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_on_load_run_0__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_on_load_run_0__2(PrologMachine mach) {
		mach.FillAlternative(pred_on_load_run_0::exec_pred_on_load_run_0__3);
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[0];
		Var var1 = V(mach);
		local_aregs[0] = F(run.s13, F(run.s7, F(run.s41, run.s24, var1), run.s94),
				F(run.s4, F(run.s67, run.s35, run.s10), F(run.s22, F(run.s11, run.s98, F(run.s41, run.s24, run.s10)))));
		local_aregs[1] = continuation;
		mach.CUTB = mach.CurrentChoice;
		return (Function<PrologMachine, Function>) pred_write_1::exec_static;
	}

	public static Function<PrologMachine, Function> exec_pred_on_load_run_0__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_on_load_run_0__4(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[0];
...
class pred_run_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_run_1__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
...
class pred_run_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_run_2__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		...
		if (!((areg1).Unify(var2)))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = F(run.s45, var1.Deref(), run.s104,
				F(run.s8, run.s16, F(run.s8, run.s17, F(run.s8, run.s15, Const.Nil))),
				F(run.s45, var1.Deref(), run.s102, Const.Nil,
						F(run.s97, F(run.s93, run.posint0, run.posint0, run.posint0), var3,
								F(run.s44, F(run.s66, var4, var5, var2.Deref()),
										F(run.s79, var4.Deref(), var5.Deref(), var1.Deref(), var3.Deref()),
										F(run.s97, F(run.s93, var6, var7, var8), var3.Deref(),
												F(run.s50, var9, F(run.s9, var7.Deref(), var6.Deref()),
														F(run.s50, var10, F(run.s9, var8.Deref(), var6.Deref()),
																F(run.s45, var1.Deref(), run.s106, F(run.s8, run.s23,
																		F(run.s8, var9.Deref(),
																				F(run.s8, var10.Deref(), Const.Nil))),
																		continuation))))))));
		mach.CUTB = mach.CurrentChoice;
...
class pred_compile_programs_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_compile_programs_0__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[0];
		Var var2 = V(mach);
		...
		local_aregs[1] = F(run.s44, F(run.s66, var1, var2),
				F(run.s51, F(run.s11, var1.Deref(), F(run.s24, var1.Deref())),
						F(run.s8, F(run.s84, run.s94), F(run.s8, F(run.s49, run.s29), Const.Nil))),
				continuation);
		mach.CUTB = mach.CurrentChoice;
...
class pred_run_program_4 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_run_program_4__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		...
		local_aregs[2] = var5;
		local_aregs[3] = var6;
		local_aregs[4] = F(run.s0, new HeapChoice(mach.CUTB), F(run.s19, run.posint1, var4.Deref(), run.posint1,
				F(run.s19, run.posint2, var4.Deref(), var5.Deref(), F(run.s19, run.posint3, var4.Deref(), var6.Deref(),
						F(run.s45, var3.Deref(), run.s103,
								F(run.s8, var1.Deref(), F(run.s8, var5.Deref(), F(run.s8, var6.Deref(), Const.Nil))),
								continuation)))));
		mach.CUTB = mach.CurrentChoice;
...
class pred_add_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_add_3__1(PrologMachine mach) {
		...
		local_aregs[1] = var2.Deref();
		local_aregs[2] = var4;
		local_aregs[3] = F(run.s50, var5, F(run.s3, var4.Deref(), var3.Deref()),
				F(run.s55, var1.Deref(), var2.Deref(), var5.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
...
class pred_ntimes_4 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_ntimes_4__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[4];
		Term areg3 = local_aregs[3].Deref();
		...
		local_aregs[0] = var5;
		local_aregs[1] = var6;
		local_aregs[2] = F(run.s61, var1.Deref(), var2.Deref(),
				F(run.s48, var7, var8, F(run.s62, var2.Deref(), F(run.s48, var9, var10, F(run.s50, var3.Deref(),
						F(run.s5, F(run.s5, var8.Deref(), var6.Deref()), F(run.s5, var10.Deref(), var8.Deref())),
						F(run.s50, var4.Deref(),
								F(run.s5, F(run.s5, var7.Deref(), var5.Deref()), F(run.s5, var9.Deref(), var7.Deref())),
								continuation))))));
		mach.CUTB = mach.CurrentChoice;
...
class pred_ntimes_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_ntimes_2__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_ntimes_2__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
		...
		if (!((areg1).Unify(var2)))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = var1.Deref();
		local_aregs[1] = F(run.s0, new HeapChoice(mach.CUTB), F(run.s50, var3, F(run.s5, var2.Deref(), run.posint1),
				F(run.s61, var1.Deref(), var3.Deref(), continuation)));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[2] = null;
...
class pred_ntimes_dummy_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_ntimes_dummy_1__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_ntimes_dummy_1__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
		...
		if (!((areg0).Unify(var1)))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = F(run.s0, new HeapChoice(mach.CUTB),
				F(run.s50, var2, F(run.s5, var1.Deref(), run.posint1), F(run.s62, var2.Deref(), continuation)));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[1] = null;
...
class pred_not_not_top_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_not_not_top_1__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_not_not_top_1__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
...
class pred_not_top_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_not_top_1__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_not_top_1__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
...
class pred_not_not_dummy_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_not_not_dummy_0__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_not_not_dummy_0__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[0];
		local_aregs[0] = continuation;
...
class pred_not_dummy_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_not_dummy_0__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_not_dummy_0__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[0];
		local_aregs[0] = continuation;
...
class pred_dummy_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_dummy_0__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[0];
		local_aregs[0] = continuation;
...
class pred_tune_counts_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_tune_counts_0__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[0];
		Var var3 = V(mach);
		...
		local_aregs[1] = F(run.s4, F(run.s95, var1.Deref(), var3),
				F(run.s45, run.s105, F(run.s8, F(run.s66, var1.Deref(), var3.Deref()), Const.Nil)));
		local_aregs[2] = continuation;
		mach.CUTB = mach.CurrentChoice;
...
class pred_tune_count_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_tune_count_2__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
		...
		local_aregs[2] = var3;
		local_aregs[3] = F(run.s50, var4, F(run.s14, run.posint1, var3.Deref()),
				F(run.s61, var1.Deref(), var4.Deref(), var5, var6,
						F(run.s87, Float(0.5), var5.Deref(), F(run.s0, new HeapChoice(mach.CUTB),
								F(run.s50, var2.Deref(),
										F(run.s75, F(run.s2, var4.Deref(), F(run.s9, run.posint1, var5.Deref()))),
										continuation)))));
		mach.CUTB = mach.CurrentChoice;
...
class pred_program_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_program_3__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
		...
		local_aregs[0] = var1.Deref();
		local_aregs[1] = var4;
		local_aregs[2] = F(run.s50, var2.Deref(),
				F(run.s52, run.posint1, F(run.s75, F(run.s2, var4.Deref(), var3.Deref()))), continuation);
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
...
class pred_program_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__4(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__5(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__6(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__7(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__8(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__9(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__10(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__11(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__12(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__13(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__14(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__15(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__16(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__17(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__18(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_program_2__19(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
...
class pred_run_interleaved_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_run_interleaved_1__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
		...
		if (!((areg0).Unify(var1)))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = F(run.s42, F(run.s5, var2, var3), F(run.s66, var3.Deref(), var2.Deref(), var1.Deref()), var4,
				F(run.s64, F(run.s82, var4.Deref()), var5,
						F(run.s81, var5.Deref(), var6, F(run.s73, run.s74, F(run.s22, F(run.s12, run.s74, var6.Deref()),
								var7, F(run.s46, F(run.s91, run.s74, F(run.s38, var7.Deref(), continuation))))))));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[1] = null;
		return (Function<PrologMachine, Function>) pred_compile_programs_0::exec_static;
	}
...
class pred_sym_dcg_arrow_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_sym_dcg_arrow_2__4(PrologMachine mach) {
		...
		if (!((areg0).Unify(F(run.s82, F(run.s8, F(run.s5, run.posint1, var1), var2), var3))))
			return UpperPrologMachine.Fail0;
		if (!((areg1).Unify(F(run.s4, run.s1,
				F(run.s4, F(run.s8, var1.Deref(), Const.Nil), F(run.s82, var2.Deref(), var3.Deref()))))))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = continuation;
		mach.CUTB = mach.CurrentChoice;
		local_aregs[2] = local_aregs[1] = null;
	...
	public static Function<PrologMachine, Function> exec_pred_sym_dcg_arrow_2__5(PrologMachine mach) {
		...
		Var var1 = V(mach);
		if (!((areg0).Unify(
				F(run.s82, F(run.s8, F(run.s5, var1, var2), var3), F(run.s8, F(run.s5, var4, var2.Deref()), var5)))))
			return UpperPrologMachine.Fail0;
		if (!((areg1).Unify(F(run.s4, F(run.s8, var2.Deref(), Const.Nil),
				F(run.s4, F(run.s101, F(run.s50, var4.Deref(), F(run.s5, var1.Deref(), run.posint1))),
						F(run.s82, var3.Deref(), var5.Deref()))))))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = continuation;
		mach.CUTB = mach.CurrentChoice;
		local_aregs[2] = local_aregs[1] = null;
	...
	public static Function<PrologMachine, Function> exec_pred_sym_dcg_arrow_2__8(PrologMachine mach) {
		...
		if (!((areg0).Unify(F(run.s83, F(run.s8, F(run.s5, var1, var2), var3)))))
			return UpperPrologMachine.Fail0;
		if (!((areg1).Unify(F(run.s4, F(run.s8, var2.Deref(), Const.Nil),
				F(run.s4, F(run.s101, F(run.s50, var4, F(run.s5, var1.Deref(), run.posint1))),
						F(run.s83, F(run.s8, F(run.s5, var4.Deref(), var2.Deref()), var3.Deref())))))))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = continuation;
		mach.CUTB = mach.CurrentChoice;
		local_aregs[2] = local_aregs[1] = null;
...
class pred_seq_clause_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_seq_clause_2__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_seq_clause_2__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
...
class pred_run_non_interleaved_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_run_non_interleaved_1__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
		...
		if (!((areg0).Unify(var1)))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = F(run.s42, F(run.s5, var2, var3), F(run.s66, var3.Deref(), var2.Deref(), var1.Deref()), var4,
				F(run.s64, F(run.s83, var4.Deref()), var5,
						F(run.s81, var5.Deref(), var6, F(run.s22, F(run.s12, run.s74, var6.Deref()), var7,
								F(run.s46, F(run.s91, run.s74, F(run.s38, var7.Deref(), continuation)))))));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[1] = null;
		return (Function<PrologMachine, Function>) pred_compile_programs_0::exec_static;
	}
