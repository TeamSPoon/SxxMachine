...
class sendmore /* extends CodeFile */ {
...
class pred_top_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_top_0__1(PrologMachine mach) {
		...
		Var var1 = V(mach);
		local_aregs[0] = var1;
		local_aregs[1] = F(sendmore.s11, var2, F(sendmore.s9, var1.Deref(), var2.Deref(), F(sendmore.s16,
				sendmore.posint0, var1.Deref(), var2.Deref(), var3, var4,
				F(sendmore.s11, var5, F(sendmore.s9, var5.Deref(), var3.Deref(), F(sendmore.s9, var5.Deref(),
						var2.Deref(),
						F(sendmore.s9, var5.Deref(), var1.Deref(), F(sendmore.s11, var6, F(sendmore.s9, var6.Deref(),
								var5.Deref(),
								F(sendmore.s9, var6.Deref(), var3.Deref(), F(sendmore.s9, var6.Deref(), var2.Deref(), F(
										sendmore.s9, var6.Deref(), var1.Deref(),
										F(sendmore.s16, var4.Deref(), var5.Deref(), var6.Deref(), var2.Deref(), var7,
												F(sendmore.s11, var8, F(sendmore.s9, var8.Deref(), var6.Deref(), F(
														sendmore.s9, var8.Deref(), var5.Deref(),
														F(sendmore.s9, var8.Deref(), var3.Deref(), F(sendmore.s9,
																var8.Deref(), var2.Deref(),
																F(sendmore.s9, var8.Deref(), var1.Deref(), F(
																		sendmore.s16, var7.Deref(), var2.Deref(),
																		var8.Deref(), var5.Deref(), var9,
																		F(sendmore.s14, var10, F(sendmore.s9,
																				var10.Deref(), var8.Deref(),
																				F(sendmore.s9, var10.Deref(),
																						var6.Deref(),
																						F(sendmore.s9, var10.Deref(),
																								var5.Deref(),
																								F(sendmore.s9,
...
class pred_sumdigit_5 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_sumdigit_5__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		...
		local_aregs[2] = F(sendmore.s15,
				F(sendmore.s4, F(sendmore.s7, var6.Deref(), sendmore.posint10),
						F(sendmore.s2, F(sendmore.s8, var4.Deref(), var6.Deref()),
								F(sendmore.s8, var5.Deref(), sendmore.posint0))),
				F(sendmore.s2, F(sendmore.s13, var4.Deref(), F(sendmore.s3, var6.Deref(), sendmore.posint10)),
						F(sendmore.s8, var5.Deref(), sendmore.posint1)),
				continuation);
		mach.CUTB = mach.CurrentChoice;
...
class pred_digit_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_digit_1__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_digit_1__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_digit_1__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_digit_1__4(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_digit_1__5(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_digit_1__6(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_digit_1__7(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_digit_1__8(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_digit_1__9(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_digit_1__10(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
...
class pred_leftdigit_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_leftdigit_1__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_leftdigit_1__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_leftdigit_1__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_leftdigit_1__4(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_leftdigit_1__5(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_leftdigit_1__6(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_leftdigit_1__7(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_leftdigit_1__8(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_leftdigit_1__9(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
