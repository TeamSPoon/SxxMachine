...
class fast_mu /* extends CodeFile */ {
...
class pred_top_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_top_0__1(PrologMachine mach) {
		...
		local_aregs[0] = F(fast_mu.s4, fast_mu.s16, F(fast_mu.s4, fast_mu.s23,
				F(fast_mu.s4, fast_mu.s12, F(fast_mu.s4, fast_mu.s12, F(fast_mu.s4, fast_mu.s23, Const.Nil)))));
...
class pred_theorem_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_theorem_1__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		...
		local_aregs[1] = var2;
		local_aregs[2] = F(fast_mu.s13, var3, F(fast_mu.s2, var2.Deref(), fast_mu.posint1),
				F(fast_mu.s10, F(fast_mu.s4, fast_mu.s16, F(fast_mu.s4, fast_mu.s12, Const.Nil)), var1.Deref(),
...
class pred_derive_6 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_derive_6__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_derive_6__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[6];
		Term areg5 = local_aregs[5].Deref();
		...
		local_aregs[2] = F(fast_mu.s10, var1.Deref(), var2.Deref(), var3.Deref(), var4.Deref(), var5.Deref(),
...
class pred_derive2_7 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_derive2_7__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_derive2_7__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[7];
		Term areg6 = local_aregs[6].Deref();
		...
		local_aregs[2] = var10;
		local_aregs[3] = F(fast_mu.s19, var10.Deref(), var9.Deref(),
				F(fast_mu.s13, var11, F(fast_mu.s2, var9.Deref(), fast_mu.posint1),
						F(fast_mu.s18, var1.Deref(), var7.Deref(), var3.Deref(), var12, var5.Deref(), var13,
								var6.Deref(), F(fast_mu.s11, var7.Deref(), var2.Deref(), var12.Deref(), var4.Deref(),
										var13.Deref(), var8.Deref(), var11.Deref(), continuation))));
		mach.CUTB = mach.CurrentChoice;
...
class pred_rule_7 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_rule_7__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[7];
		Term areg6 = local_aregs[6].Deref();
...
class pred_rule_11 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_rule_11__1(PrologMachine mach) {
		...
		local_aregs[2] = F(fast_mu.s13, var4.Deref(), F(fast_mu.s2, var5.Deref(), fast_mu.posint2),
				F(fast_mu.s13, var2.Deref(), F(fast_mu.s1, var1.Deref(), fast_mu.posint1), continuation));
		mach.CUTB = mach.CurrentChoice;
	...
	public static Function<PrologMachine, Function> exec_pred_rule_11__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_rule_11__3(PrologMachine mach) {
		...
		local_aregs[2] = F(fast_mu.s13, var5.Deref(), F(fast_mu.s2, var6.Deref(), fast_mu.posint1),
				F(fast_mu.s13, var3.Deref(), F(fast_mu.s2, var2.Deref(), fast_mu.posint2), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[11] = local_aregs[10] = local_aregs[9] = local_aregs[8] = local_aregs[7] = local_aregs[6] = local_aregs[5] = local_aregs[4] = local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_smallerorequal_2::exec_static;
	}

	public static Function<PrologMachine, Function> exec_pred_rule_11__4(PrologMachine mach) {
		...
		local_aregs[0] = var4.Deref();
		local_aregs[1] = var6.Deref();
		local_aregs[2] = F(fast_mu.s13, var5.Deref(), F(fast_mu.s2, var6.Deref(), fast_mu.posint2),
				F(fast_mu.s13, var3.Deref(), F(fast_mu.s2, var2.Deref(), fast_mu.posint2), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[11] = local_aregs[10] = local_aregs[9] = local_aregs[8] = local_aregs[7] = local_aregs[6] = local_aregs[5] = local_aregs[4] = local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_smallerorequal_2::exec_static;
	...
	public static Function<PrologMachine, Function> exec_pred_rule_11__5(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[11];
		Term areg10 = local_aregs[10].Deref();
		...
		local_aregs[2] = F(fast_mu.s18, var2.Deref(), var3.Deref(), var4.Deref(), var5.Deref(), var6.Deref(),
				var7.Deref(), var13.Deref(), var1.Deref(), var10.Deref(), var11.Deref(), var12.Deref(), continuation);
		mach.CUTB = mach.CurrentChoice;
		local_aregs[11] = local_aregs[10] = local_aregs[9] = local_aregs[8] = local_aregs[7] = local_aregs[6] = local_aregs[5] = local_aregs[4] = local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_is_2::exec_static;
	}
...
class pred_lower_bound_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_lower_bound_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_lower_bound_3__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_lower_bound_3__3(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
		...
		local_aregs[2] = F(fast_mu.s13, var4, F(fast_mu.s2, var1.Deref(), var2.Deref()),
				F(fast_mu.s13, var5, F(fast_mu.s5, var4.Deref(), fast_mu.posint1), F(fast_mu.s17,
						F(fast_mu.s3, F(fast_mu.s7, var5.Deref(), fast_mu.posint0),
								F(fast_mu.s13, var3.Deref(), F(fast_mu.s8, var4.Deref(), fast_mu.posint1))),
						F(fast_mu.s13, var3.Deref(),
								F(fast_mu.s1,
										F(fast_mu.s8, F(fast_mu.s1, var4.Deref(), fast_mu.posint1), fast_mu.posint1),
										fast_mu.posint1)),
						continuation)));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
