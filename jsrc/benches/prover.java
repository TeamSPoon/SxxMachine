...
class pred_on_load_prover_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_on_load_prover_0__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_on_load_prover_0__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_on_load_prover_0__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_on_load_prover_0__4(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[0];
...
class pred_prover_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_prover_0__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_prover_0__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[0];
		local_aregs[0] = continuation;
...
class pred_problem_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_problem_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_problem_3__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_problem_3__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_problem_3__4(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_problem_3__5(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_problem_3__6(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_problem_3__7(PrologMachine mach) {
		...
		if (!((areg1).Unify(F(prover.s4, prover.s7))))
			return UpperPrologMachine.Fail0;
		if (!((areg2).Unify(
				F(prover.s1, F(prover.s4, prover.s9), F(prover.s2, F(prover.s3, prover.s9), F(prover.s4, prover.s7))))))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = continuation;
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = local_aregs[2] = local_aregs[1] = null;
	...
	public static Function<PrologMachine, Function> exec_pred_problem_3__8(PrologMachine mach) {
		...
		if (!((areg0).Unify(prover.posint8)))
			return UpperPrologMachine.Fail0;
		if (!((areg1).Unify(F(prover.s1, F(prover.s4, prover.s7),
				F(prover.s1, F(prover.s4, prover.s9), F(prover.s3, prover.s10))))))
			return UpperPrologMachine.Fail0;
		if (!((areg2).Unify(F(prover.s1, F(prover.s4, prover.s9),
				F(prover.s1, F(prover.s4, prover.s7), F(prover.s3, prover.s10))))))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = continuation;
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = local_aregs[2] = local_aregs[1] = null;
	...
	public static Function<PrologMachine, Function> exec_pred_problem_3__9(PrologMachine mach) {
		...
		if (!((areg1).Unify(F(prover.s1, F(prover.s4, prover.s7), F(prover.s3, prover.s9)))))
			return UpperPrologMachine.Fail0;
		if (!((areg2).Unify(F(prover.s1, F(prover.s2, F(prover.s3, prover.s9), F(prover.s4, prover.s10)),
				F(prover.s1, F(prover.s4, prover.s7), F(prover.s3, prover.s10))))))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = continuation;
		mach.CUTB = mach.CurrentChoice;
	...
	public static Function<PrologMachine, Function> exec_pred_problem_3__10(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
		...
		if (!((areg0).Unify(prover.posint10)))
			return UpperPrologMachine.Fail0;
		if (!((areg1).Unify(F(prover.s2, F(prover.s1, F(prover.s4, prover.s7), F(prover.s3, prover.s10)),
				F(prover.s1, F(prover.s4, prover.s9), F(prover.s3, prover.s10))))))
			return UpperPrologMachine.Fail0;
		if (!((areg2).Unify(F(prover.s1, F(prover.s2, F(prover.s4, prover.s7), F(prover.s4, prover.s9)),
				F(prover.s3, prover.s10)))))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = continuation;
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = local_aregs[2] = local_aregs[1] = null;
...
class pred_implies_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_implies_2__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		...
		local_aregs[1] = var3;
		local_aregs[2] = F(prover.s8, var1.Deref(), var3.Deref(),
				F(prover.s16, Const.Nil, Const.Nil, Const.Nil, Const.Nil), continuation);
		mach.CUTB = mach.CurrentChoice;
...
class pred_opposite_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_opposite_2__1(PrologMachine mach) {
		...
		local_aregs[0] = F(prover.s22, var1.Deref(), var3.Deref(),
				F(prover.s22, var2.Deref(), var4.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[2] = null;
		return UpperPrologMachine.Cut2;
	}

	public static Function<PrologMachine, Function> exec_pred_opposite_2__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_opposite_2__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_opposite_2__4(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
...
class pred_add_conjunction_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_add_conjunction_3__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
...
class pred_expand_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_expand_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_expand_3__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_expand_3__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_expand_3__4(PrologMachine mach) {
		...
		if (!((areg2).Unify(var7)))
			return UpperPrologMachine.Fail0;
		mach.DoCut(mach.CUTB);
		local_aregs[0] = F(prover.s13, var1.Deref(),
				F(prover.s16, var3.Deref(), F(prover.s5, F(prover.s2, var1.Deref(), var2.Deref()), var4.Deref()),
						var5.Deref(), var6.Deref()),
				var8, F(prover.s13, var2.Deref(), var8.Deref(), var7.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = local_aregs[2] = null;
		return UpperPrologMachine.Cut2;
	}

	public static Function<PrologMachine, Function> exec_pred_expand_3__5(PrologMachine mach) {
		...
		if (!((areg2).Unify(var7)))
			return UpperPrologMachine.Fail0;
		mach.DoCut(mach.CUTB);
		local_aregs[0] = F(prover.s22, F(prover.s1, var1.Deref(), var2.Deref()), var8,
				F(prover.s14, var8.Deref(), var3.Deref(), var4.Deref(), var9,
						F(prover.s16, var9.Deref(), var4.Deref(), var5.Deref(), var6.Deref()), var7.Deref(),
						continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = local_aregs[2] = null;
		return UpperPrologMachine.Cut2;
	...
	public static Function<PrologMachine, Function> exec_pred_expand_3__6(PrologMachine mach) {
		...
		if (!((areg2).Unify(var6)))
			return UpperPrologMachine.Fail0;
		mach.DoCut(mach.CUTB);
		local_aregs[0] = F(prover.s14, var1.Deref(), var4.Deref(), var5.Deref(), var7,
				F(prover.s16, var2.Deref(), var3.Deref(), var7.Deref(), var5.Deref()), var6.Deref(), continuation);
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = local_aregs[2] = null;
		return UpperPrologMachine.Cut2;
	}

	public static Function<PrologMachine, Function> exec_pred_expand_3__7(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
...
class pred_includes_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_includes_2__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_includes_2__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
...
class pred_extend_6 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_extend_6__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_extend_6__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_extend_6__3(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[6];
		Term areg5 = local_aregs[5].Deref();
...
class pred_refute_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_refute_1__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_refute_1__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
		...
		local_aregs[0] = var1.Deref();
		local_aregs[1] = var7;
		local_aregs[2] = F(prover.s22, var2.Deref(), var8,
				F(prover.s29, F(prover.s16, var3.Deref(), var4.Deref(), var5.Deref(), var6.Deref()), var9,
						F(prover.s8, var7.Deref(), var2.Deref(), var9.Deref(), F(prover.s8, var7.Deref(), var8.Deref(),
								var9.Deref(), F(prover.s8, var1.Deref(), var8.Deref(), var9.Deref(), continuation)))));
		mach.CUTB = mach.CurrentChoice;
		return (Function<PrologMachine, Function>) pred_opposite_2::exec_static;
	}
}
