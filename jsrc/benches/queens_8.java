...
class queens_8 /* extends CodeFile */ {
...
class pred_queens_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_queens_2__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
...
class pred_queens_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_queens_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_queens_3__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
		...
		local_aregs[1] = var4;
		local_aregs[2] = var5;
		local_aregs[3] = F(queens_8.s10, var2.Deref(), var5.Deref(),
				F(queens_8.s11, var4.Deref(), F(queens_8.s3, var5.Deref(), var2.Deref()), var3.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
...
class pred_not_attack_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_not_attack_2__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
...
class pred_not_attack_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_not_attack_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_not_attack_3__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
		...
		local_aregs[2] = F(queens_8.s5, var3.Deref(), F(queens_8.s2, var1.Deref(), var4.Deref()),
				F(queens_8.s9, var5, F(queens_8.s1, var4.Deref(), queens_8.posint1),
						F(queens_8.s10, var2.Deref(), var3.Deref(), var5.Deref(), continuation)));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
...
class pred_select_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_select_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_select_3__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
...
class pred_range_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_range_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_range_3__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
		...
		local_aregs[0] = var1.Deref();
		local_aregs[1] = var2.Deref();
		local_aregs[2] = F(queens_8.s9, var4, F(queens_8.s1, var1.Deref(), queens_8.posint1),
				F(queens_8.s12, var4.Deref(), var2.Deref(), var3.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
