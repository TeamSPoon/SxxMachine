...
public static Operation exec_pred_nreverse_0__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[0] ;
...
public static Operation exec_pred_nreverse_2__1(Prolog mach){ mach.FillAlternative(pred_nreverse_2::exec_pred_nreverse_2__2) ;
Term local_aregs[] = mach.Areg ;
...
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(nreverse.s1,var1,var2),mach))) return Prolog.Fail0 ;
...
mach.CUTB = mach.CurrentChoice ;
return (Operation)pred_nreverse_2::exec_static ;}
public static Operation exec_pred_nreverse_2__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Operation exec_pred_concatenate_3__1(Prolog mach){ mach.FillAlternative(pred_concatenate_3::exec_pred_concatenate_3__2) ;
Term local_aregs[] = mach.Areg ;
...
if (!( (areg0).Unify(Data.F(nreverse.s1,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(var3,mach))) return Prolog.Fail0 ;
if (!( (areg2).Unify(Data.F(nreverse.s1,var1.Deref(),var4),mach))) return Prolog.Fail0 ;
local_aregs[0] = var2.Deref() ;
...
public static Operation exec_pred_concatenate_3__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[3] ;
Term areg2 = local_aregs[2].Deref() ;
Term areg1 = local_aregs[1].Deref() ;
