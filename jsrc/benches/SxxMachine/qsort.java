...
qsort(_5814):-qsort([27,74,17,33,94,18,46,83,65,2,32,53,28,85,99,47,28,82,6,11,55,29,39,81,90,37,10,0,66,51,7,21,85,27,31,63,75,4,95,99,11,28,61,74,18,92,40,53,59,8],_5790,[],_5814).
...
public static Operation exec_pred_qsort_0__1(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[0] ;
...
qsort([_5912|_5914],_5920,_5922,_6006):-partition(_5914,_5912,_5930,_5932,qsort(_5932,_5938,_5922,qsort(_5930,_5920,[_5912|_5938],_6006))).
qsort([],_6278,_6278,_6302):-call(_6302).
...
public static Operation exec_pred_qsort_3__1(Prolog mach){ mach.FillAlternative(pred_qsort_3::exec_pred_qsort_3__2) ;
Term local_aregs[] = mach.Areg ;
...
Var var1 = Data.V(mach) ;
if (!( (areg0).Unify(Data.F(qsort.s1,var1,var2),mach))) return Prolog.Fail0 ;
...
public static Operation exec_pred_qsort_3__2(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[3] ;
Term areg2 = local_aregs[2].Deref() ;
Term areg1 = local_aregs[1].Deref() ;
...
partition([_6394|_6396],_6408,[_6394|_6402],_6412,_6486):-smallerorequal(_6394,_6408,cut(1,partition(_6396,_6408,_6402,_6412,_6486))).
partition([_6704|_6706],_6718,_6720,[_6704|_6712],_6778):-partition(_6706,_6718,_6720,_6712,_6778).
partition([],_6936,[],[],_6962):-call(_6962).
...
public static Operation exec_pred_partition_4__1(Prolog mach){ mach.FillAlternative(pred_partition_4::exec_pred_partition_4__2) ;
Term local_aregs[] = mach.Areg ;
...
if (!( (areg0).Unify(Data.F(qsort.s1,var1,var2),mach))) return Prolog.Fail0 ;
if (!( (areg1).Unify(var3,mach))) return Prolog.Fail0 ;
if (!( (areg2).Unify(Data.F(qsort.s1,var1.Deref(),var4),mach))) return Prolog.Fail0 ;
...
public static Operation exec_pred_partition_4__2(Prolog mach){ mach.FillAlternative(pred_partition_4::exec_pred_partition_4__3) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[4] ;
Term areg3 = local_aregs[3].Deref() ;
Term areg2 = local_aregs[2].Deref() ;
...
if (!( (areg1).Unify(var3,mach))) return Prolog.Fail0 ;
if (!( (areg2).Unify(var4,mach))) return Prolog.Fail0 ;
if (!( (areg3).Unify(Data.F(qsort.s1,var1.Deref(),var5),mach))) return Prolog.Fail0 ;
local_aregs[0] = var2.Deref() ;
local_aregs[1] = var3.Deref() ;
...
mach.CUTB = mach.CurrentChoice ;
return (Operation)pred_partition_4::exec_static ;}
public static Operation exec_pred_partition_4__3(Prolog mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[4] ;
Term areg3 = local_aregs[3].Deref() ;
Term areg2 = local_aregs[2].Deref() ;
