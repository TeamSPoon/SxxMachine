...
public class sdda /*extends CodeFile*/ {
	...
	final static Operation reg_read_procedures_3 = PredTable.Register("read_procedures", 3,
			new pred_read_procedures_3());
	final static Operation reg_entry_exit_modes_list_3 = PredTable.Register("entry_exit_modes_list", 3,
			new pred_entry_exit_modes_list_3());
	final static Operation reg_proc_exit_mode_6 = PredTable.Register("proc_exit_mode", 6, new pred_proc_exit_mode_6());
	final static Operation reg_clause_exit_modes_list_6 = PredTable.Register("clause_exit_modes_list", 6,
			new pred_clause_exit_modes_list_6());
	final static Operation reg_clause_exit_mode_5 = PredTable.Register("clause_exit_mode", 5,
			new pred_clause_exit_mode_5());
	...
	public static class pred_do_sdda_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_do_sdda_4__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			...
			local_aregs[2] = var6;
			local_aregs[3] = Data.F(sdda.s_entry_exit_modes_list, var5.Deref(), var2.Deref(), var6.Deref(),
					continuation);
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = null;
	...
	public static class pred_read_procedures_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_read_procedures_3__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			...
			if (!((areg0)
					.Unify(Data.F(
							sdda.s7, Data
									.F(sdda.s7, Data.F(sdda.s8, sdda.s_a, sdda.posint2),
											Data.F(sdda.s7, Data.F(sdda.s_a, var1, var2),
													Data.F(sdda.s7, Data.F(sdda.s_a, var3, var3.Deref()), var4))),
							Data.F(sdda.s7,
									Data.F(sdda.s7, Data.F(sdda.s8, sdda.s_c, sdda.posint3),
											Data.F(sdda.s7,
													Data.F(sdda.s10, Data.F(sdda.s_c, var5, var6, var7),
															Data.F(sdda.s_a, var5.Deref(), var6.Deref())),
													var8)),
									var9)))))
				return Prolog.Fail0;
	...
	public static class pred_entry_exit_modes_list_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_entry_exit_modes_list_3__1(Prolog mach) {
		...
		public static Operation exec_pred_entry_exit_modes_list_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			local_aregs[2] = Data.F(sdda.s_length, var6.Deref(), var7, Data.F(sdda.s_proc_exit_mode, var1.Deref(),
					var2.Deref(), Const.Nil, Data.F(sdda.s8, var5.Deref(), var7.Deref()), var6.Deref(), var8,
					Data.F(sdda.s_entry_exit_modes_list, var1.Deref(), var2.Deref(), var4.Deref(), continuation)));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = null;
	...
	public static class pred_proc_exit_mode_6 extends Code {
		...
		*/
		...
		public static Operation exec_pred_proc_exit_mode_6__1(Prolog mach) {
		...
		public static Operation exec_pred_proc_exit_mode_6__2(Prolog mach) {
			...
			if (!((areg5).Unify(var7)))
				return Prolog.Fail0;
			local_aregs[0] = Data.F(sdda.s7, Data.F(sdda.s8, var4.Deref(), var5.Deref()),
					Data.F(sdda.s7, var6.Deref(), Data.F(sdda.s7, var7.Deref(), Const.Nil)));
			local_aregs[1] = var2.Deref();
		...
		public static Operation exec_pred_proc_exit_mode_6__3(Prolog mach) {
			...
			local_aregs[2] = Data
					.F(sdda.s_dup, var8.Deref(), var9,
							Data.F(sdda.s_clause_exit_modes_list, var1.Deref(), var2.Deref(), var3.Deref(),
									var9.Deref(), var6.Deref(), var10,
									Data.F(sdda.s_or,
											Data.F(sdda.s6, Data.F(sdda.s12, var10.Deref(), Const.Nil), sdda.s_fail),
											sdda.s_true,
											Data.F(sdda.s_worst_case, var10.Deref(), var7.Deref(),
													Data.F(sdda.s_dup, var6.Deref(), var11, Data.F(sdda.s_add_to_list,
															Data.F(sdda.s7, Data.F(sdda.s8, var4.Deref(), var5.Deref()),
																	Data.F(sdda.s7, var11.Deref(),
																			Data.F(sdda.s7, var7.Deref(), Const.Nil))),
		...
		public static Operation exec_pred_proc_exit_mode_6__4(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[6];
			Term areg5 = local_aregs[5].Deref();
			...
			local_aregs[2] = Data.F(sdda.s_all_shared, var6.Deref(), var7.Deref(),
					Data.F(sdda.s_add_to_list,
							Data.F(sdda.s7, Data.F(sdda.s8, var4.Deref(), var5.Deref()),
									Data.F(sdda.s7, var6.Deref(), Data.F(sdda.s7, var7.Deref(), Const.Nil))),
							var2.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_clause_exit_modes_list_6 extends Code {
		...
		*/
		...
		public static Operation exec_pred_clause_exit_modes_list_6__1(Prolog mach) {
		...
		public static Operation exec_pred_clause_exit_modes_list_6__2(Prolog mach) {
			...
			local_aregs[2] = Data.F(sdda.s_clause_exit_modes_list, var1.Deref(), var2.Deref(), var3.Deref(),
		...
		public static Operation exec_pred_clause_exit_modes_list_6__3(Prolog mach) {
			...
			local_aregs[2] = Data.F(sdda.s_clause_exit_mode, var1.Deref(), var2.Deref(),
					Data.F(sdda.s7, Data.F(sdda.s7, var4.Deref(), Data.F(sdda.s7, var6.Deref(), Const.Nil)),
							var3.Deref()),
					var4.Deref(), var7.Deref(), Data.F(sdda.s_clause_exit_modes_list, var1.Deref(), var2.Deref(),
							var3.Deref(), var5.Deref(), var6.Deref(), var8.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[6] = local_aregs[5] = local_aregs[4] = local_aregs[3] = null;
			return (Operation) pred_dup_2::exec_static;
		}

		public static Operation exec_pred_clause_exit_modes_list_6__4(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[6];
			Term areg5 = local_aregs[5].Deref();
	...
	public static class pred_clause_exit_mode_5 extends Code {
		...
		*/
		...
		public static Operation exec_pred_clause_exit_mode_5__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			...
			local_aregs[1] = Data.F(sdda.s4, Data.F(sdda.s12, var4.Deref(), var6.Deref()),
					Data.F(sdda.s12, var7.Deref(), sdda.s_true));
			local_aregs[2] = Data.F(sdda.s13, var6.Deref(), Data.F(sdda.s7, var8, var9),
					Data.F(sdda.s_unify, var9.Deref(), var5.Deref(), Data.F(sdda.s_body_exit_mode, var1.Deref(),
							var2.Deref(), var3.Deref(), var7.Deref(), continuation)));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_body_exit_mode_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_body_exit_mode_4__1(Prolog mach) {
			...
			local_aregs[4] = Data.F(sdda.s_body_exit_mode, var1.Deref(), var2.Deref(), var3.Deref(), var5.Deref(),
					continuation);
			mach.CUTB = mach.CurrentChoice;
			return (Operation) pred_body_exit_mode_4::exec_static;
		}

		public static Operation exec_pred_body_exit_mode_4__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[4];
			Term areg3 = local_aregs[3].Deref();
			...
			local_aregs[1] = var5;
			local_aregs[2] = var6;
			local_aregs[3] = Data.F(sdda.s13, var4.Deref(), Data.F(sdda.s7, var5.Deref(), var7),
					Data.F(sdda.s_proc_exit_mode, var1.Deref(), var2.Deref(), var3.Deref(),
							Data.F(sdda.s8, var5.Deref(), var6.Deref()), var7.Deref(), var8,
							Data.F(sdda.s_unify, var7.Deref(), var8.Deref(), continuation)));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = null;
	...
	public static class pred_unify_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_unify_2__1(Prolog mach) {
		...
		public static Operation exec_pred_unify_2__2(Prolog mach) {
		...
		public static Operation exec_pred_unify_2__3(Prolog mach) {
		...
		public static Operation exec_pred_unify_2__4(Prolog mach) {
			...
			if (!((areg1).Unify(Data.F(sdda.s7, var3, var4))))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
			local_aregs[0] = Data.F(sdda.s_unify, var1.Deref(), var3.Deref(),
					Data.F(sdda.s_unify, var2.Deref(), var4.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = null;
			return Prolog.Call1;
		}

		public static Operation exec_pred_unify_2__5(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			local_aregs[2] = Data.F(sdda.s13, var2.Deref(), Data.F(sdda.s7, var3.Deref(), var5),
					Data.F(sdda.s_unify, var4.Deref(), var5.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
			return (Operation) pred_$003D$002E$002E_2::exec_static;
		}
	}
	...
	public static class pred_equiv_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_equiv_2__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_equiv_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_equiv_3__1(Prolog mach) {
		...
		public static Operation exec_pred_equiv_3__2(Prolog mach) {
		...
		public static Operation exec_pred_equiv_3__3(Prolog mach) {
		...
		public static Operation exec_pred_equiv_3__4(Prolog mach) {
			...
			if (!((areg2).Unify(var3)))
				return Prolog.Fail0;
			local_aregs[0] = var1.Deref();
			local_aregs[1] = mach.HC(Data.F(sdda.s_var, var2.Deref(),
					Data.F(sdda.s_equiv_vars, var1.Deref(), var2.Deref(), var3.Deref(), continuation)));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = local_aregs[2] = null;
			return (Operation) pred_var_1::exec_static;
		}

		public static Operation exec_pred_equiv_3__5(Prolog mach) {
			...
			local_aregs[1] = mach.HC(Data.F(sdda.s_var, var1.Deref(),
					Data.F(sdda.s_equiv_vars, var1.Deref(), var2.Deref(), var3.Deref(), continuation)));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = local_aregs[2] = null;
			return (Operation) pred_var_1::exec_static;
		...
		public static Operation exec_pred_equiv_3__6(Prolog mach) {
			...
			if (!((areg2).Unify(var5)))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
			local_aregs[0] = Data.F(sdda.s_equiv, var1.Deref(), var3.Deref(), var5.Deref(),
					Data.F(sdda.s_equiv, var2.Deref(), var4.Deref(), var5.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = local_aregs[2] = null;
			return Prolog.Call1;
		}

		public static Operation exec_pred_equiv_3__7(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			local_aregs[2] = Data.F(sdda.s13, var2.Deref(), Data.F(sdda.s7, var4.Deref(), var6),
					Data.F(sdda.s_equiv, var5.Deref(), var6.Deref(), var3.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = null;
			return (Operation) pred_$003D$002E$002E_2::exec_static;
		}
	...
	public static class pred_equiv_vars_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_equiv_vars_3__1(Prolog mach) {
			...
			if (!((areg2).Unify(var3)))
				return Prolog.Fail0;
			local_aregs[0] = var3.Deref();
			local_aregs[1] = mach.HC(Data.F(sdda.s_unify,
					Data.F(sdda.s7, Data.F(sdda.s7, var1.Deref(), Data.F(sdda.s7, var2.Deref(), Const.Nil)), var4),
		...
		public static Operation exec_pred_equiv_vars_3__2(Prolog mach) {
		...
		public static Operation exec_pred_equiv_vars_3__3(Prolog mach) {
		...
		public static Operation exec_pred_equiv_vars_3__4(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_dup_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_dup_2__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_dup_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_dup_3__1(Prolog mach) {
		...
		public static Operation exec_pred_dup_3__2(Prolog mach) {
		...
		public static Operation exec_pred_dup_3__3(Prolog mach) {
			...
			if (!((areg2).Unify(var5)))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
			local_aregs[0] = Data.F(sdda.s_dup, var1.Deref(), var3.Deref(), var5.Deref(),
					Data.F(sdda.s_dup, var2.Deref(), var4.Deref(), var5.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = local_aregs[2] = null;
			return Prolog.Call1;
		}

		public static Operation exec_pred_dup_3__4(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			local_aregs[0] = var1.Deref();
			local_aregs[1] = Data.F(sdda.s7, var4, var5);
			local_aregs[2] = Data.F(sdda.s_dup, var5.Deref(), var6, var3.Deref(),
					Data.F(sdda.s13, var2.Deref(), Data.F(sdda.s7, var4.Deref(), var6.Deref()), continuation));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = null;
			return (Operation) pred_$003D$002E$002E_2::exec_static;
		}
	...
	public static class pred_dup_var_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_dup_var_3__1(Prolog mach) {
		...
		public static Operation exec_pred_dup_var_3__2(Prolog mach) {
			...
			if (!((areg1).Unify(var2)))
				return Prolog.Fail0;
			if (!((areg2)
					.Unify(Data.F(sdda.s7, Data.F(sdda.s7, var3, Data.F(sdda.s7, var2.Deref(), Const.Nil)), var4))))
				return Prolog.Fail0;
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var3.Deref();
			local_aregs[2] = mach.HC(continuation);
		...
		public static Operation exec_pred_dup_var_3__3(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_built_in_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_built_in_3__1(Prolog mach) {
		...
		public static Operation exec_pred_built_in_3__2(Prolog mach) {
		...
		public static Operation exec_pred_built_in_3__3(Prolog mach) {
		...
		public static Operation exec_pred_built_in_3__4(Prolog mach) {
		...
		public static Operation exec_pred_built_in_3__5(Prolog mach) {
		...
		public static Operation exec_pred_built_in_3__6(Prolog mach) {
		...
		public static Operation exec_pred_built_in_3__7(Prolog mach) {
		...
		public static Operation exec_pred_built_in_3__8(Prolog mach) {
		...
		public static Operation exec_pred_built_in_3__9(Prolog mach) {
		...
		public static Operation exec_pred_built_in_3__10(Prolog mach) {
		...
		public static Operation exec_pred_built_in_3__11(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_worst_case_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_worst_case_2__1(Prolog mach) {
		...
		public static Operation exec_pred_worst_case_2__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_look_up_act_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_look_up_act_2__1(Prolog mach) {
		...
		public static Operation exec_pred_look_up_act_2__2(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(sdda.s7, Data.F(sdda.s8, var1, var2),
					Data.F(sdda.s7, var3, Data.F(sdda.s7, var4, Const.Nil))))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(sdda.s7, Data.F(sdda.s7, Data.F(sdda.s8, var1.Deref(), var2.Deref()),
					Data.F(sdda.s7, var5, Data.F(sdda.s7, var4.Deref(), Const.Nil))), var6))))
				return Prolog.Fail0;
			local_aregs[0] = var3.Deref();
		...
		public static Operation exec_pred_look_up_act_2__3(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			if (!((areg1).Unify(Data.F(sdda.s7, var5, var6))))
				return Prolog.Fail0;
			local_aregs[0] = Data.F(sdda.s7, Data.F(sdda.s8, var1.Deref(), var2.Deref()),
					Data.F(sdda.s7, var3.Deref(), Data.F(sdda.s7, var4.Deref(), Const.Nil)));
			local_aregs[1] = var6.Deref();
			local_aregs[2] = continuation;
			mach.CUTB = mach.CurrentChoice;
			return (Operation) pred_look_up_act_2::exec_static;
	...
	public static class pred_all_shared_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_all_shared_2__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			local_aregs[1] = var3;
			local_aregs[2] = var4;
			local_aregs[3] = Data.F(sdda.s_bind_all, var5, var4.Deref(),
					Data.F(sdda.s_unify, var1.Deref(), var2.Deref(), var4.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_bind_all_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_bind_all_2__1(Prolog mach) {
		...
		public static Operation exec_pred_bind_all_2__2(Prolog mach) {
			...
			if (!((areg0).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg1)
					.Unify(Data.F(sdda.s7, Data.F(sdda.s7, var2, Data.F(sdda.s7, var1.Deref(), Const.Nil)), var3))))
				return Prolog.Fail0;
			local_aregs[0] = var1.Deref();
		...
		public static Operation exec_pred_bind_all_2__3(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_add_to_list_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_add_to_list_2__1(Prolog mach) {
		...
		public static Operation exec_pred_add_to_list_2__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_umember_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_umember_2__1(Prolog mach) {
		...
		public static Operation exec_pred_umember_2__2(Prolog mach) {
		...
		public static Operation exec_pred_umember_2__3(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_sumember_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_sumember_2__1(Prolog mach) {
		...
		public static Operation exec_pred_sumember_2__2(Prolog mach) {
		...
		public static Operation exec_pred_sumember_2__3(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_smember_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_smember_2__1(Prolog mach) {
		...
		public static Operation exec_pred_smember_2__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_eqmember_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_eqmember_2__1(Prolog mach) {
		...
		public static Operation exec_pred_eqmember_2__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_concat_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_concat_3__1(Prolog mach) {
		...
		public static Operation exec_pred_concat_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_nl_0 extends Code {
		...
		*/
		...
		public static Operation exec_pred_nl_0__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[0];
			local_aregs[0] = continuation;
	...
	public static class pred_write_list2_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_write_list2_3__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			local_aregs[1] = var3.Deref();
			local_aregs[2] = var5;
			local_aregs[3] = Data.F(sdda.s_write, var1.Deref(),
					Data.F(sdda.s_or, Data.F(sdda.s6, Data.F(sdda.s_nonvar, var2.Deref()),
							Data.F(sdda.s4, Data.F(sdda.s_write, sdda.s4), Data.F(sdda.s4, sdda.s_nl,
									Data.F(sdda.s4, Data.F(sdda.s_write, sdda.s1),
											Data.F(sdda.s_write_list2, var2.Deref(), var5.Deref(), var4.Deref()))))),
							Data.F(sdda.s12, var4.Deref(), var5.Deref()), continuation));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_name_vars_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_name_vars_3__1(Prolog mach) {
			...
			if (!((areg2).Unify(var3)))
				return Prolog.Fail0;
			local_aregs[0] = var1.Deref();
			local_aregs[1] = mach.HC(Data.F(sdda.s_make_name, var2.Deref(), var1.Deref(),
					Data.F(sdda.s_is, var3.Deref(), Data.F(sdda.s3, var2.Deref(), sdda.posint1), continuation)));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = local_aregs[2] = null;
			return (Operation) pred_var_1::exec_static;
		}

		public static Operation exec_pred_name_vars_3__2(Prolog mach) {
		...
		public static Operation exec_pred_name_vars_3__3(Prolog mach) {
			...
			if (!((areg2).Unify(var4)))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
			local_aregs[0] = Data.F(sdda.s_name_vars, var1.Deref(), var3.Deref(), var5,
					Data.F(sdda.s_name_vars, var2.Deref(), var5.Deref(), var4.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = local_aregs[2] = null;
			return Prolog.Call1;
		}

		public static Operation exec_pred_name_vars_3__4(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_make_name_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_make_name_2__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			local_aregs[2] = Data.F(sdda.s_is, var4,
					Data.F(sdda.s3, Data.F(sdda.s_mod, var1.Deref(), sdda.posint26), Const.Intern("A")),
					Data.F(sdda.s_build_name, var3.Deref(), var4.Deref(), var5,
							Data.F(sdda.s_name, var2.Deref(), var5.Deref(), continuation)));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_build_name_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_build_name_3__1(Prolog mach) {
		...
		public static Operation exec_pred_build_name_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			local_aregs[1] = var1.Deref();
			local_aregs[2] = Data.F(sdda.s_is, var4, Data.F(sdda.s5, var1.Deref(), sdda.posint1),
					Data.F(sdda.s_build_name, var4.Deref(), var2.Deref(), var3.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = null;
