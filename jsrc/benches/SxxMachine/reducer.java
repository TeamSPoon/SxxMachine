...
public class reducer /*extends CodeFile*/ {
	...
	final static Operation reg_list_functor_name_1 = PredTable.Register("list_functor_name", 1,
			new pred_list_functor_name_1());
	...
	final static Operation reg_intersectv_list_2 = PredTable.Register("intersectv_list", 2,
			new pred_intersectv_list_2());
	...
	public static class pred_top_0 extends Code {
		...
		*/
		...
		public static Operation exec_pred_top_0__1(Prolog mach) {
			...
			local_aregs[1] = var1;
			local_aregs[2] = Data.F(reducer.s_try,
					Data.F(reducer.s_quick, Data.F(reducer.s7, reducer.posint3,
							Data.F(reducer.s7, reducer.posint1, Data.F(reducer.s7, reducer.posint2, Const.Nil)))),
					var2, continuation);
	...
	public static class pred_try_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_try_2__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			...
			local_aregs[1] = var3;
			local_aregs[2] = Data.F(reducer.s_curry, var3.Deref(), var4, Data.F(reducer.s_t_reduce, var4.Deref(), var5,
					Data.F(reducer.s_make_list, var5.Deref(), var2.Deref(), continuation)));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_end_1 extends Code {
		...
		*/
		...
		public static Operation exec_pred_end_1__1(Prolog mach) {
		...
		public static Operation exec_pred_end_1__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[1];
			Term areg0 = local_aregs[0].Deref();
	...
	public static class pred_list_functor_name_1 extends Code {
		...
		*/
		...
		public static Operation exec_pred_list_functor_name_1__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[1];
			Term areg0 = local_aregs[0].Deref();
	...
	public static class pred_t_def_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_t_def_3__1(Prolog mach) {
			...
			if (!((areg1).Unify(Data.F(reducer.s7, var1, Const.Nil))))
				return Prolog.Fail0;
			if (!((areg2).Unify(Data.F(reducer.s_cond, Data.F(reducer.s11, var1.Deref(), reducer.posint0),
					reducer.posint1, Data.F(reducer.s1, var1.Deref(),
							Data.F(reducer.s_fac, Data.F(reducer.s4, var1.Deref(), reducer.posint1)))))))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_t_def_3__2(Prolog mach) {
			...
			if (!((areg1).Unify(Data.F(reducer.s7, var1, Const.Nil))))
				return Prolog.Fail0;
			if (!((areg2).Unify(Data.F(reducer.s_cond, Data.F(reducer.s11, var1.Deref(), Const.Nil), Const.Nil,
					Data.F(reducer.s_cond, Data.F(reducer.s11, Data.F(reducer.s_tl, var1.Deref()), Const.Nil),
							var1.Deref(), Data.F(reducer.s_quick2, Data.F(reducer.s_split,
									Data.F(reducer.s_hd, var1.Deref()), Data.F(reducer.s_tl, var1.Deref()))))))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_t_def_3__3(Prolog mach) {
			...
			if (!((areg1).Unify(Data.F(reducer.s7, var1, Const.Nil))))
				return Prolog.Fail0;
			if (!((areg2).Unify(Data.F(reducer.s_append, Data.F(reducer.s_quick, Data.F(reducer.s_hd, var1.Deref())),
					Data.F(reducer.s_quick, Data.F(reducer.s_tl, var1.Deref()))))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_t_def_3__4(Prolog mach) {
			...
			if (!((areg1).Unify(Data.F(reducer.s7, var1, Data.F(reducer.s7, var2, Const.Nil)))))
				return Prolog.Fail0;
			if (!((areg2).Unify(Data.F(reducer.s_cond, Data.F(reducer.s11, var2.Deref(), Const.Nil),
					Data.F(reducer.s7, Data.F(reducer.s7, var1.Deref(), Const.Nil), Const.Nil),
					Data.F(reducer.s_cond, Data.F(reducer.s13, Data.F(reducer.s_hd, var2.Deref()), var1.Deref()),
							Data.F(reducer.s_inserthead, Data.F(reducer.s_hd, var2.Deref()),
									Data.F(reducer.s_split, var1.Deref(), Data.F(reducer.s_tl, var2.Deref()))),
							Data.F(reducer.s_inserttail, Data.F(reducer.s_hd, var2.Deref()),
									Data.F(reducer.s_split, var1.Deref(), Data.F(reducer.s_tl, var2.Deref()))))))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
		...
		public static Operation exec_pred_t_def_3__5(Prolog mach) {
			...
			if (!((areg1).Unify(Data.F(reducer.s7, var1, Data.F(reducer.s7, var2, Const.Nil)))))
				return Prolog.Fail0;
			if (!((areg2).Unify(Data.F(reducer.s7, Data.F(reducer.s7, var1.Deref(), Data.F(reducer.s_hd, var2.Deref())),
					Data.F(reducer.s_tl, var2.Deref())))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_t_def_3__6(Prolog mach) {
			...
			if (!((areg1).Unify(Data.F(reducer.s7, var1, Data.F(reducer.s7, var2, Const.Nil)))))
				return Prolog.Fail0;
			if (!((areg2).Unify(Data.F(reducer.s7, Data.F(reducer.s_hd, var2.Deref()),
					Data.F(reducer.s7, var1.Deref(), Data.F(reducer.s_tl, var2.Deref()))))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_t_def_3__7(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			if (!((areg1).Unify(Data.F(reducer.s7, var1, Data.F(reducer.s7, var2, Const.Nil)))))
				return Prolog.Fail0;
			if (!((areg2).Unify(Data.F(reducer.s_cond, Data.F(reducer.s11, var1.Deref(), Const.Nil), var2.Deref(),
					Data.F(reducer.s7, Data.F(reducer.s_hd, var1.Deref()),
							Data.F(reducer.s_append, Data.F(reducer.s_tl, var1.Deref()), var2.Deref()))))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = local_aregs[2] = local_aregs[1] = null;
	...
	public static class pred_t_reduce_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_t_reduce_2__1(Prolog mach) {
		...
		public static Operation exec_pred_t_reduce_2__2(Prolog mach) {
			...
			local_aregs[1] = Data.F(reducer.s_t_reduce, var2.Deref(), var5.Deref(),
					mach.HC(Data.F(reducer.s_t_reduce, var1.Deref(), var4.Deref(), mach.HC(continuation))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = null;
			return (Operation) pred_list_functor_name_1::exec_static;
		}

		public static Operation exec_pred_t_reduce_2__3(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			local_aregs[4] = Data.F(reducer.s_t_redex, var5.Deref(), var4.Deref(),
					mach.HC(Data.F(reducer.s_t_reduce, var3.Deref(), var2.Deref(), mach.HC(continuation))));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_t_append_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_t_append_4__1(Prolog mach) {
		...
		public static Operation exec_pred_t_append_4__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[4];
			Term areg3 = local_aregs[3].Deref();
	...
	public static class pred_t_redex_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_t_redex_2__1(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(reducer.s7, var1,
					Data.F(reducer.s7, var2, Data.F(reducer.s7, var3, Data.F(reducer.s7, var4, reducer.s_sp)))))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(reducer.s7, Data.F(reducer.s7, var5, var2.Deref()),
					Data.F(reducer.s7, Data.F(reducer.s7, var5.Deref(), var3.Deref()), var4.Deref())))))
				return Prolog.Fail0;
			local_aregs[0] = var1.Deref();
		...
		public static Operation exec_pred_t_redex_2__2(Prolog mach) {
			...
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(reducer.s7, var1,
					Data.F(reducer.s7, var2, Data.F(reducer.s7, var3, Data.F(reducer.s7, var4, reducer.s_bp)))))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(reducer.s7, Data.F(reducer.s7, var1.Deref(), var2.Deref()),
					Data.F(reducer.s7, var3.Deref(), var4.Deref())))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
		...
		public static Operation exec_pred_t_redex_2__3(Prolog mach) {
			...
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(reducer.s7, var1,
					Data.F(reducer.s7, var2, Data.F(reducer.s7, var3, Data.F(reducer.s7, var4, reducer.s_cp)))))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(reducer.s7, var2.Deref(),
					Data.F(reducer.s7, Data.F(reducer.s7, var1.Deref(), var3.Deref()), var4.Deref())))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_t_redex_2__4(Prolog mach) {
			...
			Var var1 = Data.V(mach);
			if (!((areg0)
					.Unify(Data.F(reducer.s7, var1, Data.F(reducer.s7, var2, Data.F(reducer.s7, var3, reducer.s_s))))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(reducer.s7, Data.F(reducer.s7, var4, var2.Deref()),
					Data.F(reducer.s7, var4.Deref(), var3.Deref())))))
				return Prolog.Fail0;
			local_aregs[0] = var1.Deref();
		...
		public static Operation exec_pred_t_redex_2__5(Prolog mach) {
			...
			Var var1 = Data.V(mach);
			if (!((areg0)
					.Unify(Data.F(reducer.s7, var1, Data.F(reducer.s7, var2, Data.F(reducer.s7, var3, reducer.s_b))))))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_t_redex_2__6(Prolog mach) {
			...
			Var var1 = Data.V(mach);
			if (!((areg0)
					.Unify(Data.F(reducer.s7, var1, Data.F(reducer.s7, var2, Data.F(reducer.s7, var3, reducer.s_c))))))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_t_redex_2__7(Prolog mach) {
		...
		public static Operation exec_pred_t_redex_2__8(Prolog mach) {
		...
		public static Operation exec_pred_t_redex_2__9(Prolog mach) {
			...
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(
					Data.F(reducer.s7, var1, Data.F(reducer.s7, var2, Data.F(reducer.s7, var3, reducer.s_cond))))))
				return Prolog.Fail0;
			if (!((areg1).Unify(var2.Deref())))
				return Prolog.Fail0;
			local_aregs[0] = var3.Deref();
		...
		public static Operation exec_pred_t_redex_2__10(Prolog mach) {
		...
		public static Operation exec_pred_t_redex_2__11(Prolog mach) {
		...
		public static Operation exec_pred_t_redex_2__12(Prolog mach) {
			...
			if (!((areg1).Unify(var2)))
				return Prolog.Fail0;
			local_aregs[0] = var3;
			local_aregs[1] = Data.F(reducer.s_t_reduce, var1.Deref(),
					Data.F(reducer.s7, var4, Data.F(reducer.s7, var2.Deref(), var3.Deref())), continuation);
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = null;
			return (Operation) pred_list_functor_name_1::exec_static;
		}

		public static Operation exec_pred_t_redex_2__13(Prolog mach) {
			...
			local_aregs[0] = var3;
			local_aregs[1] = Data.F(reducer.s_t_reduce, var1.Deref(),
					Data.F(reducer.s7, var2.Deref(), Data.F(reducer.s7, var4, var3.Deref())), continuation);
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = null;
			return (Operation) pred_list_functor_name_1::exec_static;
		}

		public static Operation exec_pred_t_redex_2__14(Prolog mach) {
			...
			if (!((areg1).Unify(var4)))
				return Prolog.Fail0;
			local_aregs[0] = var3.Deref();
			local_aregs[1] = Data.F(reducer.s_member, var3.Deref(),
					Data.F(reducer.s7, reducer.s2, Data.F(reducer.s7, reducer.s4,
							Data.F(reducer.s7, reducer.s1,
									Data.F(reducer.s7, reducer.s8, Data.F(reducer.s7, reducer.s_mod, Const.Nil))))),
					Data.F(reducer.s_t_reduce, var2.Deref(), var5,
							Data.F(reducer.s_t_reduce, var1.Deref(), var6,
									Data.F(reducer.s_number, var5.Deref(),
											Data.F(reducer.s_number, var6.Deref(), Data.F(reducer.s_eval, var3.Deref(),
		...
		public static Operation exec_pred_t_redex_2__15(Prolog mach) {
			...
			local_aregs[0] = var3.Deref();
			local_aregs[1] = Data.F(reducer.s_member, var3.Deref(),
					Data.F(reducer.s7, reducer.s10, Data.F(reducer.s7, reducer.s15, Data.F(reducer.s7, reducer.s13,
							Data.F(reducer.s7, reducer.s16,
									Data.F(reducer.s7, reducer.s14, Data.F(reducer.s7, reducer.s12, Const.Nil)))))),
					Data.F(reducer.s_t_reduce, var2.Deref(), var5,
							Data.F(reducer.s_t_reduce, var1.Deref(), var6, Data.F(reducer.s_number, var5.Deref(),
									Data.F(reducer.s_number, var6.Deref(), Data.F(reducer.s_or,
											Data.F(reducer.s6,
													Data.F(reducer.s_relop, var3.Deref(), var5.Deref(), var6.Deref()),
													Data.F(reducer.s11, var4.Deref(), reducer.s_true)),
											Data.F(reducer.s11, var4.Deref(), reducer.s_false),
		...
		public static Operation exec_pred_t_redex_2__16(Prolog mach) {
			...
			local_aregs[0] = var2.Deref();
			local_aregs[1] = var4;
			local_aregs[2] = Data.F(reducer.s_t_reduce, var1.Deref(), var5,
					Data.F(reducer.s_or,
							Data.F(reducer.s6, Data.F(reducer.s11, var4.Deref(), var5.Deref()),
									Data.F(reducer.s11, var3.Deref(), reducer.s_true)),
							Data.F(reducer.s11, var3.Deref(), reducer.s_false), mach.HC(continuation)));
			mach.CUTB = mach.CurrentChoice;
			return (Operation) pred_t_reduce_2::exec_static;
		}

		public static Operation exec_pred_t_redex_2__17(Prolog mach) {
			...
			if (!((areg1).Unify(var3)))
				return Prolog.Fail0;
			local_aregs[0] = var2.Deref();
			local_aregs[1] = Data.F(reducer.s_member, var2.Deref(), Data.F(reducer.s7, reducer.s4, Const.Nil),
					Data.F(reducer.s_t_reduce, var1.Deref(), var4, Data.F(reducer.s_number, var4.Deref(),
							Data.F(reducer.s_eval1, var2.Deref(), var5, var4.Deref(), continuation))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = null;
			return (Operation) pred_end_1::exec_static;
		}

		public static Operation exec_pred_t_redex_2__18(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			local_aregs[3] = Data.F(reducer.s_end, var4.Deref(),
					Data.F(reducer.s_t_def, var4.Deref(), var5, var6, Data.F(reducer.s_t, var5.Deref(), var6.Deref(),
							var7, Data.F(reducer.s_append, var3.Deref(), var7.Deref(), var2.Deref(), continuation))));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_eval_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_eval_4__1(Prolog mach) {
		...
		public static Operation exec_pred_eval_4__2(Prolog mach) {
		...
		public static Operation exec_pred_eval_4__3(Prolog mach) {
		...
		public static Operation exec_pred_eval_4__4(Prolog mach) {
		...
		public static Operation exec_pred_eval_4__5(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[4];
			Term areg3 = local_aregs[3].Deref();
	...
	public static class pred_eval1_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_eval1_3__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_relop_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_relop_3__1(Prolog mach) {
		...
		public static Operation exec_pred_relop_3__2(Prolog mach) {
		...
		public static Operation exec_pred_relop_3__3(Prolog mach) {
		...
		public static Operation exec_pred_relop_3__4(Prolog mach) {
		...
		public static Operation exec_pred_relop_3__5(Prolog mach) {
		...
		public static Operation exec_pred_relop_3__6(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_t_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_t_3__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			local_aregs[0] = var2.Deref();
			local_aregs[1] = var4;
			local_aregs[2] = Data.F(reducer.s_curry, var4.Deref(), var5,
					Data.F(reducer.s_t_argvars, var1.Deref(), var5.Deref(), var3.Deref(), mach.HC(continuation)));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = null;
			return (Operation) pred_listify_2::exec_static;
		}
	...
	public static class pred_t_argvars_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_t_argvars_3__1(Prolog mach) {
		...
		public static Operation exec_pred_t_argvars_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			local_aregs[1] = var3.Deref();
			local_aregs[2] = var5;
			local_aregs[3] = Data.F(reducer.s_t_vars, var5.Deref(), var6,
					Data.F(reducer.s_t_trans, var1.Deref(), var5.Deref(), var6.Deref(), var4.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_curry_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_curry_2__1(Prolog mach) {
		...
		public static Operation exec_pred_curry_2__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_currylist_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_currylist_3__1(Prolog mach) {
		...
		public static Operation exec_pred_currylist_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var5;
			local_aregs[2] = Data.F(reducer.s_currylist, var2.Deref(), var3.Deref(),
					Data.F(reducer.s7, var5.Deref(), var4.Deref()), continuation);
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = null;
	...
	public static class pred_t_vars_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_t_vars_2__1(Prolog mach) {
		...
		public static Operation exec_pred_t_vars_2__2(Prolog mach) {
		...
		public static Operation exec_pred_t_vars_2__3(Prolog mach) {
		...
		public static Operation exec_pred_t_vars_2__4(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			if (!((areg0).Unify(Data.F(reducer.s7, var1, var2))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(reducer.s7, var3, Data.F(reducer.s7, Data.F(reducer.s7, var4, var5),
					Data.F(reducer.s7, Data.F(reducer.s7, var6, var7), Const.Nil))))))
				return Prolog.Fail0;
			local_aregs[0] = var1.Deref();
			local_aregs[1] = Data.F(reducer.s7, var4.Deref(), var5.Deref());
			local_aregs[2] = Data.F(reducer.s_t_vars, var2.Deref(), Data.F(reducer.s7, var6.Deref(), var7.Deref()),
					Data.F(reducer.s_unionv, var4.Deref(), var6.Deref(), var3.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_t_trans_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_t_trans_4__1(Prolog mach) {
			...
			local_aregs[1] = Data.F(reducer.s3, Data.F(reducer.s_var, var2.Deref()),
					Data.F(reducer.s17, var2.Deref(), var1.Deref()));
			local_aregs[2] = mach.HC(continuation);
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = local_aregs[3] = null;
			return (Operation) pred_or_2::exec_static;
		...
		public static Operation exec_pred_t_trans_4__2(Prolog mach) {
		...
		public static Operation exec_pred_t_trans_4__3(Prolog mach) {
		...
		public static Operation exec_pred_t_trans_4__4(Prolog mach) {
			...
			if (!((areg1).Unify(Data.F(reducer.s7, var2, var3))))
				return Prolog.Fail0;
			if (!((areg2)
					.Unify(Data.F(reducer.s7, var4, Data.F(reducer.s7, var5, Data.F(reducer.s7, var6, Const.Nil))))))
				return Prolog.Fail0;
			if (!((areg3).Unify(var7)))
				return Prolog.Fail0;
			...
			local_aregs[1] = var5.Deref();
			local_aregs[2] = Data
					.F(reducer.s_unify, Data.F(reducer.s7, var10, var11), var6.Deref(),
							Data.F(reducer.s_or, Data.F(reducer.s_end, var3.Deref()),
									Data.F(reducer.s3, Data.F(reducer.s11, var11.Deref(),
											Data.F(reducer.s7, var12,
													Data.F(reducer.s7, Data.F(reducer.s7, var13, var14), Const.Nil))),
											Data.F(reducer.s17, var13.Deref(), Const.Nil)),
									Data.F(reducer.s_t_rule1, var1.Deref(), var3.Deref(), var10.Deref(), var6.Deref(),
											var2.Deref(), var8.Deref(), var5.Deref(), var7.Deref(), continuation)));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = local_aregs[3] = null;
			return (Operation) pred_unify_2::exec_static;
		}

		public static Operation exec_pred_t_trans_4__5(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[4];
			Term areg3 = local_aregs[3].Deref();
			...
			if (!((areg1).Unify(Data.F(reducer.s7, var2, Data.F(reducer.s7, var3, var4)))))
				return Prolog.Fail0;
			if (!((areg2)
					.Unify(Data.F(reducer.s7, var5, Data.F(reducer.s7, var6, Data.F(reducer.s7, var7, Const.Nil))))))
				return Prolog.Fail0;
			if (!((areg3).Unify(var8)))
				return Prolog.Fail0;
			local_aregs[0] = Data.F(reducer.s7, var9, var10);
			local_aregs[1] = var6.Deref();
			local_aregs[2] = Data.F(reducer.s_unify,
					Data.F(reducer.s7, var11, Data.F(reducer.s7, var12, Data.F(reducer.s7, var13, Const.Nil))),
					var7.Deref(),
					Data.F(reducer.s_unify, Data.F(reducer.s7, var14, var15), var13.Deref(),
							Data.F(reducer.s_unify, Data.F(reducer.s7, var16, var17), var12.Deref(),
									Data.F(reducer.s_t_rule2, var1.Deref(), var4.Deref(), var3.Deref(), var16.Deref(),
											var12.Deref(), var2.Deref(), var9.Deref(), var6.Deref(), var8.Deref(),
											continuation))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = local_aregs[3] = null;
			return (Operation) pred_unify_2::exec_static;
	...
	public static class pred_t_rule1_8 extends Code {
		...
		*/
		...
		public static Operation exec_pred_t_rule1_8__1(Prolog mach) {
		...
		public static Operation exec_pred_t_rule1_8__2(Prolog mach) {
			...
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var3.Deref();
			local_aregs[2] = Data.F(reducer.s_inv, var1.Deref(), var6.Deref(),
					Data.F(reducer.s17, var1.Deref(), var5.Deref(), mach.HC(Data.F(reducer.s_t_trans, var1.Deref(),
							var5.Deref(), var7.Deref(), var8.Deref(), continuation))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[8] = local_aregs[7] = local_aregs[6] = local_aregs[5] = local_aregs[4] = local_aregs[3] = null;
			return (Operation) pred_notinv_2::exec_static;
		}

		public static Operation exec_pred_t_rule1_8__3(Prolog mach) {
			...
			local_aregs[2] = mach.HC(
					Data.F(reducer.s_t_trans, var1.Deref(), var2.Deref(), var4.Deref(), var8.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[8] = local_aregs[7] = local_aregs[6] = local_aregs[5] = local_aregs[4] = local_aregs[3] = null;
			return (Operation) pred_notinv_2::exec_static;
		}

		public static Operation exec_pred_t_rule1_8__4(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[8];
			Term areg7 = local_aregs[7].Deref();
			...
			local_aregs[4] = Data.F(reducer.s_t_trans, var1.Deref(), var5.Deref(), var7.Deref(), var8.Deref(),
					continuation);
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_t_rule2_9 extends Code {
		...
		*/
		...
		public static Operation exec_pred_t_rule2_9__1(Prolog mach) {
		...
		public static Operation exec_pred_t_rule2_9__2(Prolog mach) {
			...
			local_aregs[1] = var3.Deref();
			local_aregs[2] = mach.HC(
					Data.F(reducer.s_t_trans, var1.Deref(), var6.Deref(), var8.Deref(), var9.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[9] = local_aregs[8] = local_aregs[7] = local_aregs[6] = local_aregs[5] = local_aregs[4] = local_aregs[3] = null;
			return (Operation) pred_termequal_2::exec_static;
		}

		public static Operation exec_pred_t_rule2_9__3(Prolog mach) {
			...
			if (!((areg7).Unify(var8)))
				return Prolog.Fail0;
			if (!((areg8).Unify(Data.F(reducer.s7, var6.Deref(),
					Data.F(reducer.s7, var9, Data.F(reducer.s7, var2.Deref(), reducer.s_cp))))))
				return Prolog.Fail0;
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var4.Deref();
			local_aregs[2] = Data.F(reducer.s_notinv, var1.Deref(), var7.Deref(), mach.HC(
					Data.F(reducer.s_t_trans, var1.Deref(), var3.Deref(), var5.Deref(), var9.Deref(), continuation)));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[9] = local_aregs[8] = local_aregs[7] = local_aregs[6] = local_aregs[5] = local_aregs[4] = local_aregs[3] = null;
			return (Operation) pred_inv_2::exec_static;
		}

		public static Operation exec_pred_t_rule2_9__4(Prolog mach) {
			...
			if (!((areg7).Unify(var8)))
				return Prolog.Fail0;
			if (!((areg8).Unify(Data.F(reducer.s7, var9,
					Data.F(reducer.s7, var10, Data.F(reducer.s7, var2.Deref(), reducer.s_sp))))))
				return Prolog.Fail0;
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var4.Deref();
			local_aregs[2] = mach.HC(Data.F(reducer.s_t_trans, var1.Deref(), var3.Deref(), var5.Deref(), var10.Deref(),
					Data.F(reducer.s_t_trans, var1.Deref(), var6.Deref(), var8.Deref(), var9.Deref(), continuation)));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[9] = local_aregs[8] = local_aregs[7] = local_aregs[6] = local_aregs[5] = local_aregs[4] = local_aregs[3] = null;
			return (Operation) pred_inv_2::exec_static;
		...
		public static Operation exec_pred_t_rule2_9__5(Prolog mach) {
		...
		public static Operation exec_pred_t_rule2_9__6(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[9];
			Term areg8 = local_aregs[8].Deref();
			...
			if (!((areg7).Unify(var8)))
				return Prolog.Fail0;
			if (!((areg8).Unify(Data.F(reducer.s7, var9,
					Data.F(reducer.s7, var3.Deref(), Data.F(reducer.s7, var2.Deref(), reducer.s_bp))))))
				return Prolog.Fail0;
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var6.Deref();
	...
	public static class pred_make_list_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_make_list_2__1(Prolog mach) {
		...
		public static Operation exec_pred_make_list_2__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_listify_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_listify_2__1(Prolog mach) {
		...
		public static Operation exec_pred_listify_2__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			local_aregs[1] = var2.Deref();
			local_aregs[2] = var4;
			local_aregs[3] = Data.F(reducer.s_listify_list, reducer.posint1, var4.Deref(), var1.Deref(), var3.Deref(),
					continuation);
			mach.CUTB = mach.CurrentChoice;
			return (Operation) pred_functor_3::exec_static;
		}
	...
	public static class pred_listify_list_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_listify_list_4__1(Prolog mach) {
		...
		public static Operation exec_pred_listify_list_4__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[4];
			Term areg3 = local_aregs[3].Deref();
			...
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var2.Deref();
			local_aregs[2] = mach.HC(Data.F(reducer.s_arg, var1.Deref(), var3.Deref(), var6,
					Data.F(reducer.s_listify, var6.Deref(), var4.Deref(),
							Data.F(reducer.s_is, var7, Data.F(reducer.s2, var1.Deref(), reducer.posint1),
									Data.F(reducer.s_listify_list, var7.Deref(), var2.Deref(), var3.Deref(),
	...
	public static class pred_intersectv_2_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_intersectv_2_4__2(Prolog mach) {
			...
			local_aregs[1] = var3.Deref();
			local_aregs[2] = var1.Deref();
			local_aregs[3] = Data.F(reducer.s_intersectv_3, var6.Deref(), var3.Deref(), var4.Deref(), var1.Deref(),
	...
	public static class pred_intersectv_list_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_intersectv_list_2__1(Prolog mach) {
		...
		public static Operation exec_pred_intersectv_list_2__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
		...
		*/
		...
		public static Operation exec_pred_$002D$002D$003E_2__2(Prolog mach) {
			...
			if (!((areg0).Unify(Data.F(reducer.s_intersectv_list, Data.F(reducer.s7, var1, var2)))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(reducer.s3, Data.F(reducer.s_intersectv, var1.Deref()),
					Data.F(reducer.s_intersectv_list, var2.Deref())))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = local_aregs[1] = null;
	...
	public static class pred_diffv_2_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_diffv_2_4__2(Prolog mach) {
			...
			local_aregs[1] = var3.Deref();
			local_aregs[2] = var1.Deref();
			local_aregs[3] = Data.F(reducer.s_diffv_3, var6.Deref(), var3.Deref(), var4.Deref(), var1.Deref(),
					var2.Deref(), var5.Deref(), continuation);
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = null;
			return (Operation) pred_compare_3::exec_static;
	...
	public static class pred_unionv_2_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_unionv_2_4__2(Prolog mach) {
			...
			local_aregs[1] = var3.Deref();
			local_aregs[2] = var1.Deref();
			local_aregs[3] = Data.F(reducer.s_unionv_3, var6.Deref(), var3.Deref(), var4.Deref(), var1.Deref(),
					var2.Deref(), var5.Deref(), continuation);
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = null;
			return (Operation) pred_compare_3::exec_static;
	...
	public static class pred_subsetv_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_subsetv_2__2(Prolog mach) {
			...
			local_aregs[1] = var1.Deref();
			local_aregs[2] = var3.Deref();
			local_aregs[3] = Data.F(reducer.s_subsetv_2, var5.Deref(), var1.Deref(), var2.Deref(), var4.Deref(),
					continuation);
			mach.CUTB = mach.CurrentChoice;
			return (Operation) pred_compare_3::exec_static;
		}
	...
	public static class pred_small_subsetv_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_small_subsetv_2__1(Prolog mach) {
		...
		public static Operation exec_pred_small_subsetv_2__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_notinv_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_notinv_2__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_notinv_2_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_notinv_2_2__1(Prolog mach) {
		...
		public static Operation exec_pred_notinv_2_2__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_notinv_3_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_notinv_3_3__1(Prolog mach) {
		...
		public static Operation exec_pred_notinv_3_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
