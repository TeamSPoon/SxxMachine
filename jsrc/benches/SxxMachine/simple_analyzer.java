...
public class simple_analyzer /*extends CodeFile*/ {
	...
	final static Operation reg_analyze_closure_3 = PredTable.Register("analyze_closure", 3,
			new pred_analyze_closure_3());
	final static Operation reg_analyze_closure_4 = PredTable.Register("analyze_closure", 4,
			new pred_analyze_closure_4());
	...
	final static Operation reg_traverse_strees_5 = PredTable.Register("traverse_strees", 5,
			new pred_traverse_strees_5());
	...
	final static Operation reg_create_new_call_9 = PredTable.Register("create_new_call", 9,
			new pred_create_new_call_9());
	...
	final static Operation reg_create_argument_6 = PredTable.Register("create_argument", 6,
			new pred_create_argument_6());
	...
	final static Operation reg_lattice_modes_call_3 = PredTable.Register("lattice_modes_call", 3,
			new pred_lattice_modes_call_3());
	final static Operation reg_lattice_modes_call_6 = PredTable.Register("lattice_modes_call", 6,
			new pred_lattice_modes_call_6());
	final static Operation reg_lattice_modes_arg_4 = PredTable.Register("lattice_modes_arg", 4,
			new pred_lattice_modes_arg_4());
	...
	final static Operation reg_membership_flag_3 = PredTable.Register("membership_flag", 3,
			new pred_membership_flag_3());
	final static Operation reg_ground_flag_3 = PredTable.Register("ground_flag", 3, new pred_ground_flag_3());
	final static Operation reg_get_entry_modes_4 = PredTable.Register("get_entry_modes", 4,
			new pred_get_entry_modes_4());
	final static Operation reg_get_entry_modes_6 = PredTable.Register("get_entry_modes", 6,
			new pred_get_entry_modes_6());
	...
	final static Operation reg_goal_dupset_varset_3 = PredTable.Register("goal_dupset_varset", 3,
			new pred_goal_dupset_varset_3());
	final static Operation reg_goal_dupset_varbag_3 = PredTable.Register("goal_dupset_varbag", 3,
			new pred_goal_dupset_varbag_3());
	...
	public static class pred_main_1 extends Code {
		...
		*/
		...
		public static Operation exec_pred_main_1__1(Prolog mach) {
			...
			if (!((areg0).Unify(var1)))
				return Prolog.Fail0;
			local_aregs[0] = Data.F(simple_analyzer.s10,
					Data.F(simple_analyzer.s_stree,
							Data.F(simple_analyzer.s11, simple_analyzer.s_main, simple_analyzer.posint0),
							Data.F(simple_analyzer.s12, simple_analyzer.s_main, Data.F(simple_analyzer.s13,
									Data.F(simple_analyzer.s7, Data.F(simple_analyzer.s_qsort,
											Data.F(simple_analyzer.s10, simple_analyzer.posint1,
													Data.F(simple_analyzer.s10, simple_analyzer.posint2, Const.Nil)),
											var2, Const.Nil), simple_analyzer.s_true),
									simple_analyzer.s_fail)),
							Data.F(simple_analyzer.s12, simple_analyzer.s_main, simple_analyzer.s_true), Const.Nil,
							simple_analyzer.posint1),
					Data.F(simple_analyzer.s10, Data.F(simple_analyzer.s_stree,
							Data.F(simple_analyzer.s11, simple_analyzer.s_qsort, simple_analyzer.posint3),
							Data.F(simple_analyzer.s12, Data.F(simple_analyzer.s_qsort, var3, var4, var5),
									Data.F(simple_analyzer.s13, Data.F(simple_analyzer.s7,
											Data.F(simple_analyzer.s15, var3.Deref(),
													Data.F(simple_analyzer.s10, var6, var7)),
											Data.F(simple_analyzer.s7,
													Data.F(simple_analyzer.s_part, var7.Deref(), var6.Deref(), var8,
															var9),
													Data.F(simple_analyzer.s7,
															Data.F(simple_analyzer.s_qsort, var9.Deref(), var10,
																	var5.Deref()),
															Data.F(simple_analyzer.s7,
																	Data.F(simple_analyzer.s_qsort, var8.Deref(),
																			var4.Deref(),
																			Data.F(simple_analyzer.s10, var6.Deref(),
																					var10.Deref())),
																	simple_analyzer.s_true)))),
											Data.F(simple_analyzer.s13,
													Data.F(simple_analyzer.s7,
															Data.F(simple_analyzer.s15, var3.Deref(), Const.Nil),
															Data.F(simple_analyzer.s7,
																	Data.F(simple_analyzer.s15, var5.Deref(),
																			var4.Deref()),
																	simple_analyzer.s_true)),
													simple_analyzer.s_fail))),
							Data.F(simple_analyzer.s12, Data.F(simple_analyzer.s_qsort, var11, var12, var13),
									simple_analyzer.s_true),
							Const.Nil, simple_analyzer.posint1),
							Data.F(simple_analyzer.s10, Data.F(simple_analyzer.s_stree,
									Data.F(simple_analyzer.s11, simple_analyzer.s_part, simple_analyzer.posint4),
									Data.F(simple_analyzer.s12,
											Data.F(simple_analyzer.s_part, var14, var15, var16, var17),
											Data.F(simple_analyzer.s13, Data.F(simple_analyzer.s7,
													Data.F(simple_analyzer.s2, var18),
													Data.F(simple_analyzer.s7,
															Data.F(simple_analyzer.s3, var14.Deref(), var15.Deref(),
																	var16.Deref(), var17.Deref(), var18.Deref()),
															simple_analyzer.s_true)),
													simple_analyzer.s_fail)),
									Data.F(simple_analyzer.s12,
											Data.F(simple_analyzer.s_part, var19, var20, var21, var22),
											simple_analyzer.s_true),
									Data.F(simple_analyzer.s10, Data.F(simple_analyzer.s_stree,
											Data.F(simple_analyzer.s11, simple_analyzer.s3, simple_analyzer.posint5),
											Data.F(simple_analyzer.s12,
													Data.F(simple_analyzer.s3, var23, var24, var25, var26, var27),
													Data.F(simple_analyzer.s13, Data.F(simple_analyzer.s7,
															Data.F(simple_analyzer.s15, var23.Deref(),
																	Data.F(simple_analyzer.s10, var28, var29)),
															Data.F(simple_analyzer.s7,
																	Data.F(simple_analyzer.s5, var29.Deref(),
																			var24.Deref(), var25.Deref(), var26.Deref(),
																			var27.Deref(), var28.Deref()),
																	simple_analyzer.s_true)),
															Data.F(simple_analyzer.s13, Data.F(simple_analyzer.s7,
																	Data.F(simple_analyzer.s15, var23.Deref(),
																			Const.Nil),
																	Data.F(simple_analyzer.s7,
																			Data.F(simple_analyzer.s15, var25.Deref(),
																					Const.Nil),
																			Data.F(simple_analyzer.s7,
																					Data.F(simple_analyzer.s15,
																							var26.Deref(), Const.Nil),
																					simple_analyzer.s_true))),
																	simple_analyzer.s_fail))),
											Data.F(simple_analyzer.s12,
													Data.F(simple_analyzer.s3, var30, var31, var32, var33, var34),
													simple_analyzer.s_true),
											Data.F(simple_analyzer.s10, Data.F(simple_analyzer.s_stree,
													Data.F(simple_analyzer.s11, simple_analyzer.s5,
															simple_analyzer.posint6),
													Data.F(simple_analyzer.s12,
															Data.F(simple_analyzer.s5, var35, var36, var37, var38,
																	var39, var40),
															Data.F(simple_analyzer.s13,
																	Data.F(simple_analyzer.s7,
																			Data.F(simple_analyzer.s15, var37
																					.Deref(),
																					Data.F(simple_analyzer.s10,
																							var40.Deref(), var41)),
																			Data.F(simple_analyzer.s7,
																					Data.F(simple_analyzer.s16,
																							var40.Deref(),
																							var36.Deref()),
																					Data.F(simple_analyzer.s7,
																							Data.F(simple_analyzer.s4,
																									var39.Deref()),
																							Data.F(simple_analyzer.s7,
																									Data.F(simple_analyzer.s_part,
																											var35.Deref(),
																											var36.Deref(),
																											var41.Deref(),
																											var38.Deref()),
																									simple_analyzer.s_true)))),
																	Data.F(simple_analyzer.s13, Data.F(
																			simple_analyzer.s7,
																			Data.F(simple_analyzer.s15, var38.Deref(),
																					Data.F(simple_analyzer.s10,
																							var40.Deref(), var42)),
																			Data.F(simple_analyzer.s7, Data.F(
																					simple_analyzer.s_part,
																					var35.Deref(), var36.Deref(),
																					var37.Deref(), var42.Deref()),
																					simple_analyzer.s_true)),
																			simple_analyzer.s_fail))),
													Data.F(simple_analyzer.s12,
															Data.F(simple_analyzer.s5, var43, var44, var45, var46,
																	var47, var48),
															simple_analyzer.s_true),
													Const.Nil, simple_analyzer.posint1), Const.Nil),
											simple_analyzer.posint1), Const.Nil),
									simple_analyzer.posint1), Const.Nil)));
	...
	public static class pred_analyze_strees_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_analyze_strees_2__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			...
			local_aregs[1] = var3;
			local_aregs[2] = var4;
			local_aregs[3] = Data.F(simple_analyzer.s_seal, var4.Deref(),
					Data.F(simple_analyzer.s_analyze_closure, var1.Deref(), var4.Deref(), var2.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_analyze_closure_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_analyze_closure_3__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			...
			local_aregs[4] = var5;
			local_aregs[5] = Data.F(simple_analyzer.s_analyze_closure, var1.Deref(), var4.Deref(), var3.Deref(),
	...
	public static class pred_analyze_closure_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_analyze_closure_4__1(Prolog mach) {
		...
		public static Operation exec_pred_analyze_closure_4__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[4];
			Term areg3 = local_aregs[3].Deref();
			...
			local_aregs[2] = mach.HC(
					Data.F(simple_analyzer.s_analyze_closure, var1.Deref(), var2.Deref(), var3.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = local_aregs[3] = null;
	...
	public static class pred_init_strees_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_init_strees_3__1(Prolog mach) {
		...
		public static Operation exec_pred_init_strees_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s10, var1, var2))))
				return Prolog.Fail0;
			if (!((areg1).Unify(var3)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var4)))
				return Prolog.Fail0;
			local_aregs[0] = Data.F(simple_analyzer.s_stree, var5, Data.F(simple_analyzer.s12, var6, var7), var8, var9,
					var10);
			local_aregs[1] = var1.Deref();
			local_aregs[2] = Data.F(simple_analyzer.s_bottom_call, var5.Deref(), var11,
					Data.F(simple_analyzer.s_table_command, Data.F(simple_analyzer.s_get, var5.Deref(), var11.Deref()),
							var3.Deref(), var12,
							Data.F(simple_analyzer.s_init_disj, var7.Deref(), var12.Deref(), var13,
									Data.F(simple_analyzer.s_init_strees, var9.Deref(), var13.Deref(), var14,
											Data.F(simple_analyzer.s_init_strees, var2.Deref(), var14.Deref(),
													var4.Deref(), Data.F(simple_analyzer.s_true, continuation))))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = null;
	...
	public static class pred_init_conj_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_init_conj_3__1(Prolog mach) {
			...
			Term areg0 = local_aregs[0].Deref();
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(simple_analyzer.s_true)))
				return Prolog.Fail0;
			if (!((areg1).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var1.Deref())))
		...
		public static Operation exec_pred_init_conj_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s7, var1, var2))))
				return Prolog.Fail0;
			if (!((areg1).Unify(var3)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var4)))
			...
			local_aregs[2] = var5;
			local_aregs[3] = Data.F(simple_analyzer.s_init_conj, var2.Deref(), var5.Deref(), var4.Deref(),
					Data.F(simple_analyzer.s_true, continuation));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_init_disj_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_init_disj_3__1(Prolog mach) {
			...
			Term areg0 = local_aregs[0].Deref();
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(simple_analyzer.s_fail)))
				return Prolog.Fail0;
			if (!((areg1).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var1.Deref())))
		...
		public static Operation exec_pred_init_disj_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s13, var1, var2))))
				return Prolog.Fail0;
			if (!((areg1).Unify(var3)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var4)))
			...
			local_aregs[1] = var3.Deref();
			local_aregs[2] = var5;
			local_aregs[3] = Data.F(simple_analyzer.s_init_disj, var2.Deref(), var5.Deref(), var4.Deref(),
					Data.F(simple_analyzer.s_true, continuation));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_init_goal_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_init_goal_3__1(Prolog mach) {
			...
			local_aregs[1] = mach.HC(Data.F(simple_analyzer.s_functor, var1.Deref(), var4, var5,
					Data.F(simple_analyzer.s_bottom_call, Data.F(simple_analyzer.s11, var4.Deref(), var5.Deref()), var6,
							Data.F(simple_analyzer.s_table_command,
									Data.F(simple_analyzer.s_get,
											Data.F(simple_analyzer.s11, var4.Deref(), var5.Deref()), var6.Deref()),
									var2.Deref(), var3.Deref(), Data.F(simple_analyzer.s_true, continuation)))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = local_aregs[2] = null;
			return (Operation) pred_call_p_1::exec_static;
		}

		public static Operation exec_pred_init_goal_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_traverse_strees_5 extends Code {
		...
		*/
		...
		public static Operation exec_pred_traverse_strees_5__1(Prolog mach) {
		...
		public static Operation exec_pred_traverse_strees_5__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[5];
			Term areg4 = local_aregs[4].Deref();
			...
			if (!((areg4).Unify(var6)))
				return Prolog.Fail0;
			local_aregs[0] = Data.F(simple_analyzer.s_stree, var7, Data.F(simple_analyzer.s12, var8, var9), var10,
					var11, var12);
			local_aregs[1] = var1.Deref();
			local_aregs[2] = Data.F(simple_analyzer.s_traverse_disj, var8.Deref(), var9.Deref(), var3.Deref(), var13,
					var5.Deref(), var14,
					Data.F(simple_analyzer.s_traverse_strees, var11.Deref(), var13.Deref(), var15, var14.Deref(), var16,
							Data.F(simple_analyzer.s_traverse_strees, var2.Deref(), var15.Deref(), var4.Deref(),
									var16.Deref(), var6.Deref(), Data.F(simple_analyzer.s_true, continuation))));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_traverse_disj_6 extends Code {
		...
		*/
		...
		public static Operation exec_pred_traverse_disj_6__1(Prolog mach) {
			...
			if (!((areg0).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg1).Unify(simple_analyzer.s_fail)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var2)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_traverse_disj_6__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[6];
			Term areg5 = local_aregs[5].Deref();
			...
			if (!((areg0).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(simple_analyzer.s13, var2, var3))))
				return Prolog.Fail0;
			if (!((areg2).Unify(var4)))
				return Prolog.Fail0;
			if (!((areg3).Unify(var5)))
			...
			local_aregs[5] = var9;
			local_aregs[6] = Data.F(simple_analyzer.s_traverse_disj, var1.Deref(), var3.Deref(), var8.Deref(),
					var5.Deref(), var9.Deref(), var7.Deref(), Data.F(simple_analyzer.s_true, continuation));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_traverse_conj_6 extends Code {
		...
		*/
		...
		public static Operation exec_pred_traverse_conj_6__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[6];
			Term areg5 = local_aregs[5].Deref();
			...
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var7;
			local_aregs[2] = Data.F(simple_analyzer.s_functor, var1.Deref(), var8, var9, Data.F(
					simple_analyzer.s_table_command,
					Data.F(simple_analyzer.s_get, Data.F(simple_analyzer.s11, var8.Deref(), var9.Deref()), var10),
					var3.Deref(), var11,
					Data.F(simple_analyzer.s_get_entry_modes, simple_analyzer.s_uninit, var1.Deref(), var10.Deref(),
							var12,
							Data.F(simple_analyzer.s_get_entry_modes, simple_analyzer.s_ground, var1.Deref(),
									var10.Deref(), var13,
									Data.F(simple_analyzer.s_traverse_conj, var2.Deref(), var11.Deref(), var4.Deref(),
											var5.Deref(), var6.Deref(), var13.Deref(), var14, var12.Deref(), var15,
											var7.Deref(), var16, Data.F(simple_analyzer.s_true, continuation))))));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_traverse_conj_11 extends Code {
		...
		*/
		...
		public static Operation exec_pred_traverse_conj_11__1(Prolog mach) {
		...
		public static Operation exec_pred_traverse_conj_11__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[11];
			Term areg10 = local_aregs[10].Deref();
			...
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var13;
			local_aregs[2] = Data.F(simple_analyzer.s_update_goal, var1.Deref(), var13.Deref(), var3.Deref(), var14,
					var5.Deref(), var15, var7.Deref(), var16, var9.Deref(), var17, var11.Deref(), var18,
					Data.F(simple_analyzer.s_unionv, var13.Deref(), var18.Deref(), var19,
							Data.F(simple_analyzer.s_traverse_conj, var2.Deref(), var14.Deref(), var4.Deref(),
									var15.Deref(), var6.Deref(), var16.Deref(), var8.Deref(), var17.Deref(),
									var10.Deref(), var19.Deref(), var12.Deref(),
									Data.F(simple_analyzer.s_true, continuation))));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_update_goal_12 extends Code {
		...
		*/
		...
		public static Operation exec_pred_update_goal_12__1(Prolog mach) {
			...
			local_aregs[1] = var10;
			local_aregs[2] = var11;
			local_aregs[3] = Data.F(simple_analyzer.s_var, var10.Deref(), Data.F(simple_analyzer.s_nonvar,
					var11.Deref(),
					Data.F(simple_analyzer.s_varset, var11.Deref(), var12,
							Data.F(simple_analyzer.s_subsetv, var12.Deref(), var5.Deref(),
									mach.HC(Data.F(simple_analyzer.s_set_command,
											Data.F(simple_analyzer.s_add, var10.Deref()), var5.Deref(), var6.Deref(),
											Data.F(simple_analyzer.s_set_command,
													Data.F(simple_analyzer.s_sub, var10.Deref()), var7.Deref(),
													var8.Deref(), Data.F(simple_analyzer.s_true, continuation))))))));
			mach.CUTB = mach.CurrentChoice;
		...
		public static Operation exec_pred_update_goal_12__2(Prolog mach) {
			...
			local_aregs[3] = Data.F(simple_analyzer.s_var, var9.Deref(), Data.F(simple_analyzer.s_nonvar, var10.Deref(),
					Data.F(simple_analyzer.s_inv, var9.Deref(), var6.Deref(), mach.HC(Data.F(simple_analyzer.s_diffv,
							var2.Deref(), var8.Deref(), var11,
							Data.F(simple_analyzer.s_diffv, var11.Deref(), var5.Deref(), var12, Data.F(
									simple_analyzer.s_set_command, Data.F(simple_analyzer.s_add_set, var12.Deref()),
									var6.Deref(), var13,
									Data.F(simple_analyzer.s_set_command, Data.F(simple_analyzer.s_sub, var9.Deref()),
											var13.Deref(), var14,
											Data.F(simple_analyzer.s_intersectv, var2.Deref(), var8.Deref(), var15,
													Data.F(simple_analyzer.s_set_command,
															Data.F(simple_analyzer.s_sub_set, var15.Deref()),
															var14.Deref(), var7.Deref(),
															Data.F(simple_analyzer.s_true, continuation)))))))))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[12] = local_aregs[11] = local_aregs[10] = local_aregs[9] = local_aregs[8] = local_aregs[7] = local_aregs[6] = local_aregs[5] = local_aregs[4] = null;
			return (Operation) pred_split_unify_3::exec_static;
		...
		public static Operation exec_pred_update_goal_12__3(Prolog mach) {
			...
			local_aregs[3] = Data.F(simple_analyzer.s_var, var10.Deref(),
					Data.F(simple_analyzer.s_inv, var10.Deref(), var5.Deref(),
							mach.HC(Data.F(simple_analyzer.s_set_command,
									Data.F(simple_analyzer.s_add_set, var2.Deref()), var5.Deref(), var6.Deref(),
									Data.F(simple_analyzer.s_set_command,
											Data.F(simple_analyzer.s_sub_set, var2.Deref()), var7.Deref(), var8.Deref(),
											Data.F(simple_analyzer.s_true, continuation))))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[12] = local_aregs[11] = local_aregs[10] = local_aregs[9] = local_aregs[8] = local_aregs[7] = local_aregs[6] = local_aregs[5] = local_aregs[4] = null;
			return (Operation) pred_split_unify_3::exec_static;
		...
		public static Operation exec_pred_update_goal_12__4(Prolog mach) {
			...
			local_aregs[0] = var1.Deref();
			local_aregs[1] = mach
					.HC(Data.F(simple_analyzer.s_set_command, Data.F(simple_analyzer.s_sub_set, var2.Deref()),
							var6.Deref(), var7.Deref(), Data.F(simple_analyzer.s_true, continuation)));
			mach.CUTB = mach.CurrentChoice;
		...
		public static Operation exec_pred_update_goal_12__5(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[12];
			Term areg11 = local_aregs[11].Deref();
			...
			if (!((areg11).Unify(var10.Deref())))
				return Prolog.Fail0;
			local_aregs[0] = var1.Deref();
			local_aregs[1] = mach.HC(Data.F(simple_analyzer.s_goal_dupset, var1.Deref(), var11, Data.F(
					simple_analyzer.s_var_args, var1.Deref(), var12,
					Data.F(simple_analyzer.s_functor, var1.Deref(), var13, var14, Data.F(simple_analyzer.s_functor,
							var15, var13.Deref(), var14.Deref(),
							Data.F(simple_analyzer.s_create_new_call, simple_analyzer.posint1, var14.Deref(),
									var7.Deref(), var12.Deref(), var11.Deref(), var8.Deref(), var10.Deref(),
									var1.Deref(), var15.Deref(),
									Data.F(simple_analyzer.s_update_table,
											Data.F(simple_analyzer.s11, var13.Deref(), var14.Deref()), var15.Deref(),
											var3.Deref(), var4.Deref(), var5.Deref(), var6.Deref(),
											Data.F(simple_analyzer.s_set_command,
													Data.F(simple_analyzer.s_sub_set, var2.Deref()), var8.Deref(),
													var9.Deref(), Data.F(simple_analyzer.s_true, continuation)))))))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[12] = local_aregs[11] = local_aregs[10] = local_aregs[9] = local_aregs[8] = local_aregs[7] = local_aregs[6] = local_aregs[5] = local_aregs[4] = local_aregs[3] = local_aregs[2] = null;
			return (Operation) pred_call_p_1::exec_static;
		}
	...
	public static class pred_update_table_6 extends Code {
		...
		*/
		...
		public static Operation exec_pred_update_table_6__1(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s11, var1, var2))))
				return Prolog.Fail0;
			if (!((areg1).Unify(var3)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var4)))
			...
			if (!((areg5).Unify(var7)))
				return Prolog.Fail0;
			local_aregs[0] = Data.F(simple_analyzer.s_get, Data.F(simple_analyzer.s11, var1.Deref(), var2.Deref()),
					var8);
			local_aregs[1] = var4.Deref();
			local_aregs[2] = var9;
			local_aregs[3] = Data
					.F(simple_analyzer.s_lub_call, var8.Deref(), var3.Deref(), var10,
							Data.F(simple_analyzer.s19, var8.Deref(), var10.Deref(),
									mach.HC(Data.F(simple_analyzer.s_table_command, Data.F(simple_analyzer.s_set,
											Data.F(simple_analyzer.s11, var1.Deref(), var2.Deref()), var10.Deref()),
											var9.Deref(), var5.Deref(),
											Data.F(simple_analyzer.s_is, var7.Deref(),
													Data.F(simple_analyzer.s6, var6.Deref(), simple_analyzer.posint1),
													Data.F(simple_analyzer.s_true, continuation))))));
			mach.CUTB = mach.CurrentChoice;
		...
		public static Operation exec_pred_update_table_6__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[6];
			Term areg5 = local_aregs[5].Deref();
	...
	public static class pred_create_new_call_9 extends Code {
		...
		*/
		...
		public static Operation exec_pred_create_new_call_9__1(Prolog mach) {
		...
		public static Operation exec_pred_create_new_call_9__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[9];
			Term areg8 = local_aregs[8].Deref();
			...
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var2.Deref();
			local_aregs[2] = mach.HC(Data.F(simple_analyzer.s_arg, var1.Deref(), var8.Deref(), var10, Data.F(
					simple_analyzer.s_arg, var1.Deref(), var9.Deref(), var11,
					Data.F(simple_analyzer.s_ground_flag, var10.Deref(), var3.Deref(), var12, Data.F(
							simple_analyzer.s_membership_flag, var10.Deref(), var4.Deref(), var13,
							Data.F(simple_analyzer.s_membership_flag, var10.Deref(), var5.Deref(), var14, Data.F(
									simple_analyzer.s_membership_flag, var10.Deref(), var6.Deref(), var15,
									Data.F(simple_analyzer.s_membership_flag, var10.Deref(), var7.Deref(), var16,
											Data.F(simple_analyzer.s_create_argument, var12.Deref(), var13.Deref(),
													var14.Deref(), var15.Deref(), var16.Deref(), var11.Deref(),
													Data.F(simple_analyzer.s_is, var17,
															Data.F(simple_analyzer.s6, var1.Deref(),
																	simple_analyzer.posint1),
															Data.F(simple_analyzer.s_create_new_call, var17.Deref(),
																	var2.Deref(), var3.Deref(), var4.Deref(),
	...
	public static class pred_lub_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_lub_3__1(Prolog mach) {
			...
			Term areg0 = local_aregs[0].Deref();
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(simple_analyzer.s_unknown)))
				return Prolog.Fail0;
			if (!((areg1).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var1.Deref())))
		...
		public static Operation exec_pred_lub_3__2(Prolog mach) {
			...
			if (!((areg0).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg1).Unify(simple_analyzer.s_unknown)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var1.Deref())))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
		...
		public static Operation exec_pred_lub_3__3(Prolog mach) {
			...
			Term areg0 = local_aregs[0].Deref();
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(simple_analyzer.s_any)))
				return Prolog.Fail0;
			if (!((areg1).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg2).Unify(simple_analyzer.s_any)))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
		...
		public static Operation exec_pred_lub_3__4(Prolog mach) {
			...
			if (!((areg0).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg1).Unify(simple_analyzer.s_any)))
				return Prolog.Fail0;
			if (!((areg2).Unify(simple_analyzer.s_any)))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
		...
		public static Operation exec_pred_lub_3__5(Prolog mach) {
			...
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(simple_analyzer.s_uninit)))
				return Prolog.Fail0;
			if (!((areg1).Unify(simple_analyzer.s_uninit)))
				return Prolog.Fail0;
			if (!((areg2).Unify(simple_analyzer.s_uninit)))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
		...
		public static Operation exec_pred_lub_3__6(Prolog mach) {
			...
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(simple_analyzer.s_ground)))
				return Prolog.Fail0;
			if (!((areg1).Unify(simple_analyzer.s_ground)))
				return Prolog.Fail0;
			if (!((areg2).Unify(simple_analyzer.s_ground)))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
		...
		public static Operation exec_pred_lub_3__7(Prolog mach) {
		...
		public static Operation exec_pred_lub_3__8(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_bottom_1 extends Code {
		...
		*/
		...
		public static Operation exec_pred_bottom_1__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[1];
			Term areg0 = local_aregs[0].Deref();
	...
	public static class pred_create_argument_6 extends Code {
		...
		*/
		...
		public static Operation exec_pred_create_argument_6__1(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(simple_analyzer.s_yes)))
				return Prolog.Fail0;
			if (!((areg1).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var2)))
			...
			if (!((areg4).Unify(var4)))
				return Prolog.Fail0;
			if (!((areg5).Unify(simple_analyzer.s_ground)))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
		...
		public static Operation exec_pred_create_argument_6__2(Prolog mach) {
			...
			Term areg0 = local_aregs[0].Deref();
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(simple_analyzer.s_no)))
				return Prolog.Fail0;
			if (!((areg1).Unify(simple_analyzer.s_yes)))
				return Prolog.Fail0;
			if (!((areg2).Unify(simple_analyzer.s_no)))
				return Prolog.Fail0;
			if (!((areg3).Unify(simple_analyzer.s_yes)))
				return Prolog.Fail0;
			if (!((areg4).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg5).Unify(simple_analyzer.s_uninit)))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
		...
		public static Operation exec_pred_create_argument_6__3(Prolog mach) {
			...
			if (!((areg3).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg4).Unify(simple_analyzer.s_no)))
				return Prolog.Fail0;
			if (!((areg5).Unify(simple_analyzer.s_uninit)))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
		...
		public static Operation exec_pred_create_argument_6__4(Prolog mach) {
			...
			if (!((areg2).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg3).Unify(simple_analyzer.s_no)))
				return Prolog.Fail0;
			if (!((areg4).Unify(simple_analyzer.s_yes)))
				return Prolog.Fail0;
			if (!((areg5).Unify(simple_analyzer.s_any)))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
		...
		public static Operation exec_pred_create_argument_6__5(Prolog mach) {
			...
			if (!((areg1).Unify(simple_analyzer.s_yes)))
				return Prolog.Fail0;
			if (!((areg2).Unify(simple_analyzer.s_yes)))
				return Prolog.Fail0;
			if (!((areg3).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg4).Unify(var2)))
		...
		public static Operation exec_pred_create_argument_6__6(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[6];
			Term areg5 = local_aregs[5].Deref();
			...
			if (!((areg0).Unify(simple_analyzer.s_no)))
				return Prolog.Fail0;
			if (!((areg1).Unify(simple_analyzer.s_no)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg3).Unify(var2)))
	...
	public static class pred_lub_call_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_lub_call_3__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			local_aregs[1] = var4;
			local_aregs[2] = var5;
			local_aregs[3] = Data.F(simple_analyzer.s_functor, var2.Deref(), var4.Deref(), var5.Deref(),
					Data.F(simple_analyzer.s_functor, var3.Deref(), var4.Deref(), var5.Deref(),
							Data.F(simple_analyzer.s_lub_call, simple_analyzer.posint1, var5.Deref(), var1.Deref(),
									var2.Deref(), var3.Deref(), continuation)));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_lub_call_5 extends Code {
		...
		*/
		...
		public static Operation exec_pred_lub_call_5__1(Prolog mach) {
		...
		public static Operation exec_pred_lub_call_5__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[5];
			Term areg4 = local_aregs[4].Deref();
			...
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var2.Deref();
			local_aregs[2] = mach.HC(Data.F(simple_analyzer.s_arg, var1.Deref(), var3.Deref(), var6,
					Data.F(simple_analyzer.s_arg, var1.Deref(), var4.Deref(), var7,
							Data.F(simple_analyzer.s_arg, var1.Deref(), var5.Deref(), var8,
									Data.F(simple_analyzer.s_lub, var6.Deref(), var7.Deref(), var8.Deref(),
											Data.F(simple_analyzer.s_is, var9,
													Data.F(simple_analyzer.s6, var1.Deref(), simple_analyzer.posint1),
													Data.F(simple_analyzer.s_lub_call, var9.Deref(), var2.Deref(),
															var3.Deref(), var4.Deref(), var5.Deref(),
															continuation)))))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[5] = local_aregs[4] = local_aregs[3] = null;
			return (Operation) pred_smallerorequal_2::exec_static;
	...
	public static class pred_bottom_call_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_bottom_call_2__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			local_aregs[3] = Data.F(simple_analyzer.s_bottom_call, simple_analyzer.posint1, var2.Deref(), var3.Deref(),
					continuation);
			mach.CUTB = mach.CurrentChoice;
			return (Operation) pred_functor_3::exec_static;
		}
	...
	public static class pred_bottom_call_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_bottom_call_3__1(Prolog mach) {
		...
		public static Operation exec_pred_bottom_call_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var2.Deref();
			local_aregs[2] = mach.HC(Data.F(simple_analyzer.s_bottom, var4,
					Data.F(simple_analyzer.s_arg, var1.Deref(), var3.Deref(), var4.Deref(),
							Data.F(simple_analyzer.s_is, var5,
									Data.F(simple_analyzer.s6, var1.Deref(), simple_analyzer.posint1),
									Data.F(simple_analyzer.s_bottom_call, var5.Deref(), var2.Deref(), var3.Deref(),
											continuation)))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = null;
			return (Operation) pred_smallerorequal_2::exec_static;
	...
	public static class pred_lattice_modes_call_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_lattice_modes_call_3__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			if (!((areg1).Unify(var3)))
				return Prolog.Fail0;
			if (!((areg2).Unify(Data.F(simple_analyzer.s12, var4, var5))))
				return Prolog.Fail0;
			local_aregs[0] = var4.Deref();
			local_aregs[1] = var1.Deref();
			local_aregs[2] = var2.Deref();
			local_aregs[3] = Data.F(simple_analyzer.s_get, var3.Deref(),
					Data.F(simple_analyzer.s11, var1.Deref(), var2.Deref()), var6,
					Data.F(simple_analyzer.s_lattice_modes_call, simple_analyzer.posint1, var2.Deref(), var6.Deref(),
							var4.Deref(), var5.Deref(), simple_analyzer.s_true, continuation));
			mach.CUTB = mach.CurrentChoice;
			return (Operation) pred_functor_3::exec_static;
		}
	}
	...
	public static class pred_lattice_modes_call_6 extends Code {
		...
		*/
		...
		public static Operation exec_pred_lattice_modes_call_6__1(Prolog mach) {
		...
		public static Operation exec_pred_lattice_modes_call_6__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[6];
			Term areg5 = local_aregs[5].Deref();
			...
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var2.Deref();
			local_aregs[2] = mach.HC(Data.F(simple_analyzer.s_arg, var1.Deref(), var3.Deref(), var7,
					Data.F(simple_analyzer.s_arg, var1.Deref(), var4.Deref(), var8,
							Data.F(simple_analyzer.s_lattice_modes_arg, var7.Deref(), var8.Deref(), var5.Deref(), var9,
									Data.F(simple_analyzer.s_is, var10,
											Data.F(simple_analyzer.s6, var1.Deref(), simple_analyzer.posint1),
											Data.F(simple_analyzer.s_lattice_modes_call, var10.Deref(), var2.Deref(),
													var3.Deref(), var4.Deref(), var9.Deref(), var6.Deref(),
													continuation))))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[6] = local_aregs[5] = local_aregs[4] = local_aregs[3] = null;
			return (Operation) pred_smallerorequal_2::exec_static;
	...
	public static class pred_lattice_modes_arg_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_lattice_modes_arg_4__1(Prolog mach) {
			...
			if (!((areg1).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg2).Unify(Data.F(simple_analyzer.s7, Data.F(simple_analyzer.s_uninit, var1.Deref()), var2))))
				return Prolog.Fail0;
			if (!((areg3).Unify(var2.Deref())))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
		...
		public static Operation exec_pred_lattice_modes_arg_4__2(Prolog mach) {
			...
			if (!((areg1).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg2).Unify(Data.F(simple_analyzer.s7, Data.F(simple_analyzer.s_ground, var1.Deref()), var2))))
				return Prolog.Fail0;
			if (!((areg3).Unify(var2.Deref())))
				return Prolog.Fail0;
			mach.DoCut(mach.CUTB);
		...
		public static Operation exec_pred_lattice_modes_arg_4__3(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[4];
			Term areg3 = local_aregs[3].Deref();
	...
	public static class pred_get_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_get_3__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s_node, var1, var2, var3, var4))))
				return Prolog.Fail0;
			if (!((areg1).Unify(var5)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var6)))
	...
	public static class pred_get_6 extends Code {
		...
		*/
		...
		public static Operation exec_pred_get_6__1(Prolog mach) {
		...
		public static Operation exec_pred_get_6__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[6];
			Term areg5 = local_aregs[5].Deref();
			...
			local_aregs[3] = Data.F(simple_analyzer.s_get, var7.Deref(), var5.Deref(), var6.Deref(), var3.Deref(),
	...
	public static class pred_get_5 extends Code {
		...
		*/
		...
		public static Operation exec_pred_get_5__1(Prolog mach) {
		...
		public static Operation exec_pred_get_5__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[5];
			Term areg4 = local_aregs[4].Deref();
	...
	public static class pred_set_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_set_4__1(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(simple_analyzer.s_leaf)))
				return Prolog.Fail0;
			if (!((areg1).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var2)))
				return Prolog.Fail0;
			if (!((areg3).Unify(Data.F(simple_analyzer.s_node, var1.Deref(), var2.Deref(), simple_analyzer.s_leaf,
					simple_analyzer.s_leaf))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = local_aregs[3] = local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_set_4__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[4];
			Term areg3 = local_aregs[3].Deref();
			...
			if (!((areg2).Unify(var6)))
				return Prolog.Fail0;
			if (!((areg3).Unify(Data.F(simple_analyzer.s_node, var1.Deref(), var7, var8, var9))))
				return Prolog.Fail0;
			local_aregs[0] = var10;
			local_aregs[1] = var5.Deref();
			local_aregs[2] = var1.Deref();
			local_aregs[3] = Data.F(simple_analyzer.s_set_2, var10.Deref(), var5.Deref(), var6.Deref(), var2.Deref(),
					var3.Deref(), var4.Deref(), var7.Deref(), var8.Deref(), var9.Deref(), continuation);
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = null;
			return (Operation) pred_compare_3::exec_static;
		}
	...
	public static class pred_set_2_9 extends Code {
		...
		*/
		...
		public static Operation exec_pred_set_2_9__1(Prolog mach) {
		...
		public static Operation exec_pred_set_2_9__2(Prolog mach) {
		...
		public static Operation exec_pred_set_2_9__3(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[9];
			Term areg8 = local_aregs[8].Deref();
	...
	public static class pred_seal_1 extends Code {
		...
		*/
		...
		public static Operation exec_pred_seal_1__1(Prolog mach) {
		...
		public static Operation exec_pred_seal_1__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[1];
			Term areg0 = local_aregs[0].Deref();
	...
	public static class pred_membership_flag_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_membership_flag_3__1(Prolog mach) {
		...
		public static Operation exec_pred_membership_flag_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_ground_flag_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_ground_flag_3__1(Prolog mach) {
		...
		public static Operation exec_pred_ground_flag_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_get_entry_modes_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_get_entry_modes_4__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[4];
			Term areg3 = local_aregs[3].Deref();
			...
			local_aregs[1] = var5;
			local_aregs[2] = var6;
			local_aregs[3] = Data.F(simple_analyzer.s_get_entry_modes, var1.Deref(), simple_analyzer.posint1,
					var6.Deref(), var2.Deref(), var3.Deref(), var7,
					Data.F(simple_analyzer.s_sort, var7.Deref(), var4.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = null;
			return (Operation) pred_functor_3::exec_static;
		}
	...
	public static class pred_get_entry_modes_6 extends Code {
		...
		*/
		...
		public static Operation exec_pred_get_entry_modes_6__1(Prolog mach) {
		...
		public static Operation exec_pred_get_entry_modes_6__2(Prolog mach) {
			...
			if (!((areg4).Unify(var5)))
				return Prolog.Fail0;
			if (!((areg5).Unify(Data.F(simple_analyzer.s10, var6, var7))))
				return Prolog.Fail0;
			local_aregs[0] = var2.Deref();
			local_aregs[1] = var3.Deref();
			local_aregs[2] = Data.F(simple_analyzer.s_arg, var2.Deref(), var5.Deref(), var1.Deref(),
					mach.HC(Data.F(simple_analyzer.s_arg, var2.Deref(), var4.Deref(), var6.Deref(),
							Data.F(simple_analyzer.s_is, var8,
									Data.F(simple_analyzer.s6, var2.Deref(), simple_analyzer.posint1),
									Data.F(simple_analyzer.s_get_entry_modes, var1.Deref(), var8.Deref(), var3.Deref(),
											var4.Deref(), var5.Deref(), var7.Deref(), continuation)))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[6] = local_aregs[5] = local_aregs[4] = local_aregs[3] = null;
			return (Operation) pred_smallerorequal_2::exec_static;
		}

		public static Operation exec_pred_get_entry_modes_6__3(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[6];
			Term areg5 = local_aregs[5].Deref();
			...
			local_aregs[0] = var2.Deref();
			local_aregs[1] = var3.Deref();
			local_aregs[2] = mach.HC(Data.F(simple_analyzer.s_is, var7,
					Data.F(simple_analyzer.s6, var2.Deref(), simple_analyzer.posint1),
					Data.F(simple_analyzer.s_get_entry_modes, var1.Deref(), var7.Deref(), var3.Deref(), var4.Deref(),
	...
	public static class pred_var_args_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_var_args_2__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			local_aregs[1] = var3;
			local_aregs[2] = var4;
			local_aregs[3] = Data.F(simple_analyzer.s_filter_vars, var4.Deref(), var1.Deref(), var5,
					Data.F(simple_analyzer.s_sort, var5.Deref(), var2.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
			return (Operation) pred_functor_3::exec_static;
		}
	}
	...
	public static class pred_filter_vars_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_filter_vars_3__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_$002D$002D$003E_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_$002D$002D$003E_2__1(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s_filter_vars, var1, var2))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(simple_analyzer.s7,
					Data.F(simple_analyzer.s111, Data.F(simple_analyzer.s16, var1.Deref(), simple_analyzer.posint0)),
					simple_analyzer.s1))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
		...
		public static Operation exec_pred_$002D$002D$003E_2__2(Prolog mach) {
			...
			if (!((areg0).Unify(Data.F(simple_analyzer.s_filter_vars, var1, var2))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(simple_analyzer.s7,
					Data.F(simple_analyzer.s111, Data.F(simple_analyzer.s18, var1.Deref(), simple_analyzer.posint0)),
					Data.F(simple_analyzer.s7, simple_analyzer.s1, Data.F(simple_analyzer.s7,
							Data.F(simple_analyzer.s111,
									Data.F(simple_analyzer.s_arg, var1.Deref(), var2.Deref(), var3)),
							Data.F(simple_analyzer.s_filter_vars_arg, var1.Deref(), var2.Deref(), var3.Deref())))))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_$002D$002D$003E_2__3(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s_filter_vars_arg, var1, var2, var3))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(simple_analyzer.s7,
					Data.F(simple_analyzer.s111, Data.F(simple_analyzer.s_var, var3.Deref())),
					Data.F(simple_analyzer.s7, simple_analyzer.s1,
							Data.F(simple_analyzer.s7, Data.F(simple_analyzer.s10, var3.Deref(), Const.Nil),
									Data.F(simple_analyzer.s7, Data.F(simple_analyzer.s111,
											Data.F(simple_analyzer.s_is, var4,
													Data.F(simple_analyzer.s8, var1.Deref(), simple_analyzer.posint1))),
											Data.F(simple_analyzer.s_filter_vars, var4.Deref(), var2.Deref()))))))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_$002D$002D$003E_2__4(Prolog mach) {
			...
			if (!((areg0).Unify(Data.F(simple_analyzer.s_filter_vars_arg, var1, var2, var3))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data
					.F(simple_analyzer.s7, Data.F(simple_analyzer.s111, Data.F(simple_analyzer.s_nonvar, var3.Deref())),
							Data.F(simple_analyzer.s7, simple_analyzer.s1,
									Data.F(simple_analyzer.s7, Data.F(simple_analyzer.s111,
											Data.F(simple_analyzer.s_is, var4,
													Data.F(simple_analyzer.s8, var1.Deref(), simple_analyzer.posint1))),
		...
		public static Operation exec_pred_$002D$002D$003E_2__5(Prolog mach) {
			...
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(Data.F(simple_analyzer.s_filter_dups, Const.Nil))))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_$002D$002D$003E_2__6(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s_filter_dups,
					Data.F(simple_analyzer.s10, Data.F(simple_analyzer.s8, var1, var2),
							Data.F(simple_analyzer.s10, Data.F(simple_analyzer.s8, var3, var4),
									Data.F(simple_analyzer.s10, Data.F(simple_analyzer.s8, var5, var6), var7)))))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(simple_analyzer.s7,
					Data.F(simple_analyzer.s111,
							Data.F(simple_analyzer.s7, Data.F(simple_analyzer.s17, var1.Deref(), var3.Deref()),
									Data.F(simple_analyzer.s17, var3.Deref(), var5.Deref()))),
					Data.F(simple_analyzer.s7, simple_analyzer.s1,
							Data.F(simple_analyzer.s_filter_dups,
									Data.F(simple_analyzer.s10, Data.F(simple_analyzer.s8, var3.Deref(), var8),
											Data.F(simple_analyzer.s10, Data.F(simple_analyzer.s8, var5.Deref(), var9),
													var7.Deref()))))))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
		...
		public static Operation exec_pred_$002D$002D$003E_2__7(Prolog mach) {
			...
			if (!((areg0).Unify(Data.F(simple_analyzer.s_filter_dups,
					Data.F(simple_analyzer.s10, Data.F(simple_analyzer.s8, var1, var2),
							Data.F(simple_analyzer.s10, Data.F(simple_analyzer.s8, var3, var4), var5))))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(simple_analyzer.s7,
					Data.F(simple_analyzer.s111, Data.F(simple_analyzer.s17, var1.Deref(), var3.Deref())),
					Data.F(simple_analyzer.s7, simple_analyzer.s1,
							Data.F(simple_analyzer.s7, Data.F(simple_analyzer.s10, var1.Deref(), Const.Nil),
									Data.F(simple_analyzer.s_filter_dups, var5.Deref())))))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_$002D$002D$003E_2__8(Prolog mach) {
			...
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s_filter_dups,
					Data.F(simple_analyzer.s10, Data.F(simple_analyzer.s8, var1, var2), var3)))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(simple_analyzer.s7, simple_analyzer.s1,
					Data.F(simple_analyzer.s_filter_dups, var3.Deref())))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_$002D$002D$003E_2__9(Prolog mach) {
			...
			Term areg0 = local_aregs[0].Deref();
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s_varbag, var1))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(simple_analyzer.s7,
					Data.F(simple_analyzer.s111, Data.F(simple_analyzer.s_var, var1.Deref())),
					Data.F(simple_analyzer.s7, simple_analyzer.s1,
							Data.F(simple_analyzer.s10, var1.Deref(), Const.Nil))))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_$002D$002D$003E_2__10(Prolog mach) {
			...
			if (!((areg1).Unify(Data.F(simple_analyzer.s7,
					Data.F(simple_analyzer.s111,
							Data.F(simple_analyzer.s7, Data.F(simple_analyzer.s_nonvar, var1.Deref()),
									Data.F(simple_analyzer.s7, simple_analyzer.s1,
											Data.F(simple_analyzer.s_functor, var1.Deref(), var2, var3)))),
					Data.F(simple_analyzer.s_varbag, var1.Deref(), simple_analyzer.posint1, var3.Deref())))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_$002D$002D$003E_2__11(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s_varbag, var1, var2, var3))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(simple_analyzer.s7,
					Data.F(simple_analyzer.s111, Data.F(simple_analyzer.s18, var2.Deref(), var3.Deref())),
					simple_analyzer.s1))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
		...
		public static Operation exec_pred_$002D$002D$003E_2__12(Prolog mach) {
			...
			if (!((areg0).Unify(Data.F(simple_analyzer.s_varbag, var1, var2, var3))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(simple_analyzer.s7,
					Data.F(simple_analyzer.s111, Data.F(simple_analyzer.s16, var2.Deref(), var3.Deref())),
					Data.F(simple_analyzer.s7, simple_analyzer.s1, Data.F(simple_analyzer.s7,
							Data.F(simple_analyzer.s111,
									Data.F(simple_analyzer.s_arg, var2.Deref(), var1.Deref(), var4)),
							Data.F(simple_analyzer.s7, Data.F(simple_analyzer.s_varbag, var4.Deref()),
									Data.F(simple_analyzer.s7, Data.F(simple_analyzer.s111,
											Data.F(simple_analyzer.s_is, var5,
													Data.F(simple_analyzer.s6, var2.Deref(), simple_analyzer.posint1))),
											Data.F(simple_analyzer.s_varbag, var1.Deref(), var5.Deref(),
													var3.Deref())))))))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_goal_dupset_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_goal_dupset_2__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_goal_dupset_varset_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_goal_dupset_varset_3__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_goal_dupset_varbag_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_goal_dupset_varbag_3__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var3.Deref();
			local_aregs[2] = Data.F(simple_analyzer.s_make_key, var3.Deref(), var4,
					Data.F(simple_analyzer.s_keysort, var4.Deref(), var5,
							Data.F(simple_analyzer.s_filter_dups, var5.Deref(), var2.Deref(), continuation)));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = null;
	...
	public static class pred_make_key_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_make_key_2__1(Prolog mach) {
		...
		public static Operation exec_pred_make_key_2__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			if (!((areg0).Unify(Data.F(simple_analyzer.s10, var1, var2))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(simple_analyzer.s10,
					Data.F(simple_analyzer.s8, var1.Deref(), simple_analyzer.s_dummy), var3))))
				return Prolog.Fail0;
			local_aregs[0] = var2.Deref();
			local_aregs[1] = var3.Deref();
			local_aregs[2] = continuation;
	...
	public static class pred_filter_dups_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_filter_dups_2__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
	...
	public static class pred_set_command_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_set_command_3__1(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s_sub, var1))))
				return Prolog.Fail0;
			if (!((areg1).Unify(var2)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var3)))
		...
		public static Operation exec_pred_set_command_3__2(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s_add, var1))))
				return Prolog.Fail0;
			if (!((areg1).Unify(var2)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var3)))
		...
		public static Operation exec_pred_set_command_3__3(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s_sub_set, var1))))
				return Prolog.Fail0;
			if (!((areg1).Unify(var2)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var3)))
		...
		public static Operation exec_pred_set_command_3__4(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s_add_set, var1))))
				return Prolog.Fail0;
			if (!((areg1).Unify(var2)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var3)))
	...
	public static class pred_table_command_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_table_command_3__1(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s_get, var1, var2))))
				return Prolog.Fail0;
			if (!((areg1).Unify(var3)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_table_command_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s_set, var1, var2))))
				return Prolog.Fail0;
			if (!((areg1).Unify(var3)))
				return Prolog.Fail0;
			if (!((areg2).Unify(var4)))
	...
	public static class pred_inv_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_inv_2__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			if (!((areg0).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(simple_analyzer.s10, var2, var3))))
				return Prolog.Fail0;
			local_aregs[0] = var4;
			local_aregs[1] = var1.Deref();
			local_aregs[2] = var2.Deref();
	...
	public static class pred_inv_2_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_inv_2_3__1(Prolog mach) {
		...
		public static Operation exec_pred_inv_2_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_intersectv_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_intersectv_3__1(Prolog mach) {
		...
		public static Operation exec_pred_intersectv_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_intersectv_2_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_intersectv_2_4__1(Prolog mach) {
		...
		public static Operation exec_pred_intersectv_2_4__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[4];
			Term areg3 = local_aregs[3].Deref();
			...
			local_aregs[1] = var3.Deref();
			local_aregs[2] = var1.Deref();
			local_aregs[3] = Data.F(simple_analyzer.s_intersectv_3, var6.Deref(), var3.Deref(), var4.Deref(),
					var1.Deref(), var2.Deref(), var5.Deref(), continuation);
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = null;
			return (Operation) pred_compare_3::exec_static;
		}
	...
	public static class pred_intersectv_3_6 extends Code {
		...
		*/
		...
		public static Operation exec_pred_intersectv_3_6__1(Prolog mach) {
		...
		public static Operation exec_pred_intersectv_3_6__2(Prolog mach) {
			...
			if (!((areg4).Unify(var4)))
				return Prolog.Fail0;
			if (!((areg5).Unify(Data.F(simple_analyzer.s10, var1.Deref(), var5))))
				return Prolog.Fail0;
			local_aregs[0] = var2.Deref();
			local_aregs[1] = var4.Deref();
		...
		public static Operation exec_pred_intersectv_3_6__3(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[6];
			Term areg5 = local_aregs[5].Deref();
	...
	public static class pred_diffv_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_diffv_3__1(Prolog mach) {
		...
		public static Operation exec_pred_diffv_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_diffv_2_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_diffv_2_4__1(Prolog mach) {
			...
			if (!((areg2).Unify(var2)))
				return Prolog.Fail0;
			if (!((areg3).Unify(Data.F(simple_analyzer.s10, var1.Deref(), Const.Nil))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = local_aregs[3] = local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_diffv_2_4__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[4];
			Term areg3 = local_aregs[3].Deref();
			...
			local_aregs[1] = var3.Deref();
			local_aregs[2] = var1.Deref();
			local_aregs[3] = Data.F(simple_analyzer.s_diffv_3, var6.Deref(), var3.Deref(), var4.Deref(), var1.Deref(),
					var2.Deref(), var5.Deref(), continuation);
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = null;
			return (Operation) pred_compare_3::exec_static;
		}
	...
	public static class pred_diffv_3_6 extends Code {
		...
		*/
		...
		public static Operation exec_pred_diffv_3_6__1(Prolog mach) {
		...
		public static Operation exec_pred_diffv_3_6__2(Prolog mach) {
		...
		public static Operation exec_pred_diffv_3_6__3(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[6];
			Term areg5 = local_aregs[5].Deref();
	...
	public static class pred_unionv_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_unionv_3__1(Prolog mach) {
		...
		public static Operation exec_pred_unionv_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_unionv_2_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_unionv_2_4__1(Prolog mach) {
			...
			if (!((areg2).Unify(var2)))
				return Prolog.Fail0;
			if (!((areg3).Unify(Data.F(simple_analyzer.s10, var1.Deref(), var2.Deref()))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = local_aregs[3] = local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_unionv_2_4__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[4];
			Term areg3 = local_aregs[3].Deref();
			...
			local_aregs[1] = var3.Deref();
			local_aregs[2] = var1.Deref();
			local_aregs[3] = Data.F(simple_analyzer.s_unionv_3, var6.Deref(), var3.Deref(), var4.Deref(), var1.Deref(),
					var2.Deref(), var5.Deref(), continuation);
			mach.CUTB = mach.CurrentChoice;
			local_aregs[4] = null;
			return (Operation) pred_compare_3::exec_static;
	...
	public static class pred_unionv_3_6 extends Code {
		...
		*/
		...
		public static Operation exec_pred_unionv_3_6__1(Prolog mach) {
		...
		public static Operation exec_pred_unionv_3_6__2(Prolog mach) {
		...
		public static Operation exec_pred_unionv_3_6__3(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[6];
			Term areg5 = local_aregs[5].Deref();
			...
			if (!((areg4).Unify(var4)))
				return Prolog.Fail0;
			if (!((areg5).Unify(Data.F(simple_analyzer.s10, var3.Deref(), var5))))
				return Prolog.Fail0;
			local_aregs[0] = var4.Deref();
			local_aregs[1] = var1.Deref();
			local_aregs[2] = var2.Deref();
	...
	public static class pred_includev_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_includev_3__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
	...
	public static class pred_includev_2_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_includev_2_3__1(Prolog mach) {
			...
			if (!((areg1).Unify(var1)))
				return Prolog.Fail0;
			if (!((areg2).Unify(Data.F(simple_analyzer.s10, var1.Deref(), Const.Nil))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_includev_2_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			local_aregs[1] = var3.Deref();
			local_aregs[2] = var1.Deref();
			local_aregs[3] = Data.F(simple_analyzer.s_includev_3, var5.Deref(), var3.Deref(), var1.Deref(),
					var2.Deref(), var4.Deref(), continuation);
			mach.CUTB = mach.CurrentChoice;
			return (Operation) pred_compare_3::exec_static;
		}
	}
	...
	public static class pred_includev_3_5 extends Code {
		...
		*/
		...
		public static Operation exec_pred_includev_3_5__1(Prolog mach) {
			...
			if (!((areg3).Unify(var3)))
				return Prolog.Fail0;
			if (!((areg4).Unify(Data.F(simple_analyzer.s10, var1.Deref(),
					Data.F(simple_analyzer.s10, var2.Deref(), var3.Deref())))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[5] = local_aregs[4] = local_aregs[3] = local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_includev_3_5__2(Prolog mach) {
			...
			if (!((areg3).Unify(var3)))
				return Prolog.Fail0;
			if (!((areg4).Unify(Data.F(simple_analyzer.s10, var2.Deref(), var3.Deref()))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[5] = local_aregs[4] = local_aregs[3] = local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_includev_3_5__3(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[5];
			Term areg4 = local_aregs[4].Deref();
			...
			if (!((areg3).Unify(var3)))
				return Prolog.Fail0;
			if (!((areg4).Unify(Data.F(simple_analyzer.s10, var2.Deref(), var4))))
				return Prolog.Fail0;
			local_aregs[0] = var3.Deref();
			local_aregs[1] = var1.Deref();
			local_aregs[2] = var4.Deref();
	...
	public static class pred_subsetv_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_subsetv_2__1(Prolog mach) {
		...
		public static Operation exec_pred_subsetv_2__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			if (!((areg0).Unify(Data.F(simple_analyzer.s10, var1, var2))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(simple_analyzer.s10, var3, var4))))
				return Prolog.Fail0;
			local_aregs[0] = var5;
			local_aregs[1] = var1.Deref();
			local_aregs[2] = var3.Deref();
			local_aregs[3] = Data.F(simple_analyzer.s_subsetv_2, var5.Deref(), var1.Deref(), var2.Deref(), var4.Deref(),
					continuation);
			mach.CUTB = mach.CurrentChoice;
			return (Operation) pred_compare_3::exec_static;
		}
	...
	public static class pred_subsetv_2_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_subsetv_2_4__1(Prolog mach) {
		...
		public static Operation exec_pred_subsetv_2_4__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[4];
			Term areg3 = local_aregs[3].Deref();
	...
	public static class pred_unify_p_1 extends Code {
		...
		*/
		...
		public static Operation exec_pred_unify_p_1__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[1];
			Term areg0 = local_aregs[0].Deref();
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(simple_analyzer.s15, var1, var2))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[1] = null;
	...
	public static class pred_call_p_1 extends Code {
		...
		*/
		...
		public static Operation exec_pred_call_p_1__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[1];
			Term areg0 = local_aregs[0].Deref();
	...
	public static class pred_split_unify_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_split_unify_3__1(Prolog mach) {
		...
		public static Operation exec_pred_split_unify_3__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
