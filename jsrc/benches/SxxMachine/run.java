...
public class run /*extends CodeFile*/ {
	...
	final static Const s10 = Data.Intern("/opt/logicmoo_workspace/taupl/SxxMachine/prolog/bench");
	...
	final static Operation reg_compile_programs_0 = PredTable.Register("compile_programs", 0,
			new pred_compile_programs_0());
	...
	final static Operation reg_run_interleaved_1 = PredTable.Register("run_interleaved", 1,
			new pred_run_interleaved_1());
	...
	final static Operation reg_run_non_interleaved_1 = PredTable.Register("run_non_interleaved", 1,
			new pred_run_non_interleaved_1());
	...
	public static class pred_on_load_run_0 extends Code {
		...
		*/
		...
		public static Operation exec_pred_on_load_run_0__1(Prolog mach) {
		...
		public static Operation exec_pred_on_load_run_0__2(Prolog mach) {
			mach.FillAlternative(pred_on_load_run_0::exec_pred_on_load_run_0__3);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[0];
			Var var1 = Data.V(mach);
			local_aregs[0] = Data.F(run.s13,
					Data.F(run.s7, Data.F(run.s_file_search_path, run.s_bench, var1), run.s_true),
					Data.F(run.s4, Data.F(run.s_prolog_load_context, run.s_directory, run.s10), Data.F(run.s_assert,
							Data.F(run.s11, run.s_user, Data.F(run.s_file_search_path, run.s_bench, run.s10)))));
			local_aregs[1] = continuation;
			mach.CUTB = mach.CurrentChoice;
			return (Operation) pred_write_1::exec_static;
		}

		public static Operation exec_pred_on_load_run_0__3(Prolog mach) {
		...
		public static Operation exec_pred_on_load_run_0__4(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[0];
	...
	public static class pred_run_1 extends Code {
		...
		*/
		...
		public static Operation exec_pred_run_1__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
	...
	public static class pred_run_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_run_2__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			...
			if (!((areg1).Unify(var2)))
				return Prolog.Fail0;
			local_aregs[0] = Data.F(run.s_format, var1.Deref(), run.s104,
					Data.F(run.s8, run.s_Program, Data.F(run.s8, run.s_Time, Data.F(run.s8, run.s_GC, Const.Nil))),
					Data.F(run.s_format, var1.Deref(), run.s102, Const.Nil, Data.F(run.s_unify,
							Data.F(run.s_total, run.posint0, run.posint0, run.posint0), var3,
							Data.F(run.s_forall, Data.F(run.s_program, var4, var5, var2.Deref()),
									Data.F(run.s_run_program, var4.Deref(), var5.Deref(), var1.Deref(), var3.Deref()),
									Data.F(run.s_unify, Data.F(run.s_total, var6, var7, var8), var3.Deref(), Data.F(
											run.s_is, var9, Data.F(run.s9, var7.Deref(), var6.Deref()),
											Data.F(run.s_is, var10, Data.F(run.s9, var8.Deref(), var6.Deref()),
													Data.F(run.s_format, var1.Deref(), run.s106,
															Data.F(run.s8, run.s_average,
																	Data.F(run.s8, var9.Deref(),
																			Data.F(run.s8, var10.Deref(), Const.Nil))),
															continuation))))))));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_compile_programs_0 extends Code {
		...
		*/
		...
		public static Operation exec_pred_compile_programs_0__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[0];
			Var var2 = Data.V(mach);
			...
			local_aregs[1] = Data.F(run.s_forall, Data.F(run.s_program, var1, var2),
					Data.F(run.s_load_files, Data.F(run.s11, var1.Deref(), Data.F(run.s_bench, var1.Deref())),
							Data.F(run.s8, Data.F(run.s_silent, run.s_true),
									Data.F(run.s8, Data.F(run.s_if, run.s_changed), Const.Nil))),
					continuation);
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_run_program_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_run_program_4__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			...
			local_aregs[2] = var5;
			local_aregs[3] = var6;
			local_aregs[4] = mach.HC(Data.F(run.s_add, run.posint1, var4.Deref(), run.posint1, Data.F(run.s_add,
					run.posint2, var4.Deref(), var5.Deref(),
					Data.F(run.s_add, run.posint3, var4.Deref(), var6.Deref(),
							Data.F(run.s_format, var3.Deref(), run.s103,
									Data.F(run.s8, var1.Deref(),
											Data.F(run.s8, var5.Deref(), Data.F(run.s8, var6.Deref(), Const.Nil))),
									continuation)))));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_add_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_add_3__1(Prolog mach) {
			...
			local_aregs[1] = var2.Deref();
			local_aregs[2] = var4;
			local_aregs[3] = Data.F(run.s_is, var5, Data.F(run.s3, var4.Deref(), var3.Deref()),
					Data.F(run.s_nb_setarg, var1.Deref(), var2.Deref(), var5.Deref(), continuation));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_ntimes_4 extends Code {
		...
		*/
		...
		public static Operation exec_pred_ntimes_4__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[4];
			Term areg3 = local_aregs[3].Deref();
			...
			local_aregs[1] = var6;
			local_aregs[2] = Data
					.F(run.s_ntimes, var1.Deref(), var2.Deref(),
							Data.F(run.s_get_performance_stats, var7, var8,
									Data.F(run.s_ntimes_dummy, var2.Deref(), Data.F(run.s_get_performance_stats, var9,
											var10, Data.F(run.s_is, var3.Deref(),
													Data.F(run.s5, Data.F(run.s5, var8.Deref(), var6.Deref()),
															Data.F(run.s5, var10.Deref(), var8.Deref())),
													Data.F(run.s_is, var4.Deref(),
															Data.F(run.s5, Data.F(run.s5, var7.Deref(), var5.Deref()),
																	Data.F(run.s5, var9.Deref(), var7.Deref())),
															continuation))))));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_ntimes_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_ntimes_2__1(Prolog mach) {
		...
		public static Operation exec_pred_ntimes_2__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			if (!((areg1).Unify(var2)))
				return Prolog.Fail0;
			local_aregs[0] = var1.Deref();
			local_aregs[1] = mach.HC(Data.F(run.s_is, var3, Data.F(run.s5, var2.Deref(), run.posint1),
					Data.F(run.s_ntimes, var1.Deref(), var3.Deref(), continuation)));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = null;
	...
	public static class pred_ntimes_dummy_1 extends Code {
		...
		*/
		...
		public static Operation exec_pred_ntimes_dummy_1__1(Prolog mach) {
		...
		public static Operation exec_pred_ntimes_dummy_1__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[1];
			Term areg0 = local_aregs[0].Deref();
			...
			if (!((areg0).Unify(var1)))
				return Prolog.Fail0;
			local_aregs[0] = mach.HC(Data.F(run.s_is, var2, Data.F(run.s5, var1.Deref(), run.posint1),
					Data.F(run.s_ntimes_dummy, var2.Deref(), continuation)));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[1] = null;
	...
	public static class pred_not_not_top_1 extends Code {
		...
		*/
		...
		public static Operation exec_pred_not_not_top_1__1(Prolog mach) {
		...
		public static Operation exec_pred_not_not_top_1__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[1];
			Term areg0 = local_aregs[0].Deref();
	...
	public static class pred_not_top_1 extends Code {
		...
		*/
		...
		public static Operation exec_pred_not_top_1__1(Prolog mach) {
		...
		public static Operation exec_pred_not_top_1__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[1];
			Term areg0 = local_aregs[0].Deref();
	...
	public static class pred_not_not_dummy_0 extends Code {
		...
		*/
		...
		public static Operation exec_pred_not_not_dummy_0__1(Prolog mach) {
		...
		public static Operation exec_pred_not_not_dummy_0__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[0];
			local_aregs[0] = continuation;
	...
	public static class pred_not_dummy_0 extends Code {
		...
		*/
		...
		public static Operation exec_pred_not_dummy_0__1(Prolog mach) {
		...
		public static Operation exec_pred_not_dummy_0__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[0];
			local_aregs[0] = continuation;
	...
	public static class pred_dummy_0 extends Code {
		...
		*/
		...
		public static Operation exec_pred_dummy_0__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[0];
			local_aregs[0] = continuation;
	...
	public static class pred_tune_counts_0 extends Code {
		...
		*/
		...
		public static Operation exec_pred_tune_counts_0__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[0];
			Var var3 = Data.V(mach);
			...
			local_aregs[1] = Data.F(run.s4, Data.F(run.s_tune_count, var1.Deref(), var3), Data.F(run.s_format, run.s105,
					Data.F(run.s8, Data.F(run.s_program, var1.Deref(), var3.Deref()), Const.Nil)));
			local_aregs[2] = continuation;
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_tune_count_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_tune_count_2__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			local_aregs[2] = var3;
			local_aregs[3] = Data.F(run.s_is, var4, Data.F(run.s14, run.posint1, var3.Deref()), Data.F(run.s_ntimes,
					var1.Deref(), var4.Deref(), var5, var6,
					Data.F(run.s_smallerthan, Data.Float(0.5), var5.Deref(),
							mach.HC(Data.F(run.s_is, var2.Deref(),
									Data.F(run.s_round,
											Data.F(run.s2, var4.Deref(), Data.F(run.s9, run.posint1, var5.Deref()))),
									continuation)))));
			mach.CUTB = mach.CurrentChoice;
	...
	public static class pred_program_3 extends Code {
		...
		*/
		...
		public static Operation exec_pred_program_3__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[3];
			Term areg2 = local_aregs[2].Deref();
			...
			local_aregs[0] = var1.Deref();
			local_aregs[1] = var4;
			local_aregs[2] = Data.F(run.s_is, var2.Deref(),
					Data.F(run.s_max, run.posint1, Data.F(run.s_round, Data.F(run.s2, var4.Deref(), var3.Deref()))),
					continuation);
			mach.CUTB = mach.CurrentChoice;
			local_aregs[3] = null;
	...
	public static class pred_program_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_program_2__1(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__2);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_boyer)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__2(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__3);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_browse)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__3(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__4);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_chat_parser)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__4(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__5);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_crypt)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__5(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__6);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_fast_mu)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__6(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__7);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_flatten)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__7(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__8);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_meta_qsort)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__8(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__9);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_mu)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__9(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__10);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_nreverse)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__10(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__11);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_poly_10)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__11(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__12);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_prover)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__12(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__13);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_qsort)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__13(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__14);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_queens_8)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__14(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__15);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_query)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__15(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__16);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_reducer)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__16(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__17);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_sendmore)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__17(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__18);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_simple_analyzer)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__18(Prolog mach) {
			mach.FillAlternative(pred_program_2::exec_pred_program_2__19);
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_tak)))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_program_2__19(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(run.s_zebra)))
				return Prolog.Fail0;
	...
	public static class pred_run_interleaved_1 extends Code {
		...
		*/
		...
		public static Operation exec_pred_run_interleaved_1__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[1];
			Term areg0 = local_aregs[0].Deref();
			...
			if (!((areg0).Unify(var1)))
				return Prolog.Fail0;
			local_aregs[0] = Data
					.F(run.s_findall, Data.F(run.s5, var2, var3),
							Data.F(run.s_program, var3.Deref(), var2.Deref(), var1.Deref()), var4,
							Data.F(run.s_phrase, Data.F(run.s_seq_interleaved, var4.Deref()), var5,
									Data.F(run.s_seq_clause, var5.Deref(), var6, Data.F(run.s_retractall, run.s_rni,
											Data.F(run.s_assert, Data.F(run.s12, run.s_rni, var6.Deref()), var7,
													Data.F(run.s_garbage_collect, Data.F(run.s_time, run.s_rni,
															Data.F(run.s_erase, var7.Deref(), continuation))))))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[1] = null;
			return (Operation) pred_compile_programs_0::exec_static;
		}
	...
	public static class pred_$002D$002D$003E_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_$002D$002D$003E_2__1(Prolog mach) {
			...
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(Data.F(run.s_seq_interleaved, Const.Nil))))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_$002D$002D$003E_2__2(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(run.s_seq_interleaved, var1))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(run.s4, Data.F(run.s_seq_interleaved, var1.Deref(), var2),
					Data.F(run.s_seq_interleaved, var2.Deref())))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_$002D$002D$003E_2__3(Prolog mach) {
			...
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(Data.F(run.s_seq_interleaved, Const.Nil, Const.Nil))))
				return Prolog.Fail0;
		...
		public static Operation exec_pred_$002D$002D$003E_2__4(Prolog mach) {
			...
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(
					Data.F(run.s_seq_interleaved, Data.F(run.s8, Data.F(run.s5, run.posint1, var1), var2), var3))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(run.s4, run.s1, Data.F(run.s4, Data.F(run.s8, var1.Deref(), Const.Nil),
					Data.F(run.s_seq_interleaved, var2.Deref(), var3.Deref()))))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_$002D$002D$003E_2__5(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(run.s_seq_interleaved, Data.F(run.s8, Data.F(run.s5, var1, var2), var3),
					Data.F(run.s8, Data.F(run.s5, var4, var2.Deref()), var5)))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(run.s4, Data.F(run.s8, var2.Deref(), Const.Nil),
					Data.F(run.s4,
							Data.F(run.s101, Data.F(run.s_is, var4.Deref(), Data.F(run.s5, var1.Deref(), run.posint1))),
							Data.F(run.s_seq_interleaved, var3.Deref(), var5.Deref()))))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_$002D$002D$003E_2__6(Prolog mach) {
			...
			Term areg1 = local_aregs[1].Deref();
			Term areg0 = local_aregs[0].Deref();
			if (!((areg0).Unify(Data.F(run.s_seq_non_interleaved, Const.Nil))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Const.Nil)))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
		...
		public static Operation exec_pred_$002D$002D$003E_2__7(Prolog mach) {
			...
			Var var1 = Data.V(mach);
			if (!((areg0)
					.Unify(Data.F(run.s_seq_non_interleaved, Data.F(run.s8, Data.F(run.s5, run.posint0, var1), var2)))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(run.s4, run.s1, Data.F(run.s_seq_non_interleaved, var2.Deref())))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = local_aregs[1] = null;
		...
		public static Operation exec_pred_$002D$002D$003E_2__8(Prolog mach) {
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(run.s_seq_non_interleaved, Data.F(run.s8, Data.F(run.s5, var1, var2), var3)))))
				return Prolog.Fail0;
			if (!((areg1).Unify(Data.F(run.s4, Data.F(run.s8, var2.Deref(), Const.Nil),
					Data.F(run.s4, Data.F(run.s101, Data.F(run.s_is, var4, Data.F(run.s5, var1.Deref(), run.posint1))),
							Data.F(run.s_seq_non_interleaved,
									Data.F(run.s8, Data.F(run.s5, var4.Deref(), var2.Deref()), var3.Deref())))))))
				return Prolog.Fail0;
			local_aregs[0] = continuation;
			mach.CUTB = mach.CurrentChoice;
			local_aregs[2] = local_aregs[1] = null;
	...
	public static class pred_seq_clause_2 extends Code {
		...
		*/
		...
		public static Operation exec_pred_seq_clause_2__1(Prolog mach) {
		...
		public static Operation exec_pred_seq_clause_2__2(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[2];
			Term areg1 = local_aregs[1].Deref();
			...
			Var var2 = Data.V(mach);
			Var var1 = Data.V(mach);
			if (!((areg0).Unify(Data.F(run.s8, var1, var2))))
				return Prolog.Fail0;
			if (!((areg1).Unify(
					Data.F(run.s4, Data.F(run.s11, Data.F(run.s18, Data.F(run.s18, var1.Deref())), run.s_top), var3))))
				return Prolog.Fail0;
	...
	public static class pred_run_non_interleaved_1 extends Code {
		...
		*/
		...
		public static Operation exec_pred_run_non_interleaved_1__1(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[1];
			Term areg0 = local_aregs[0].Deref();
			...
			if (!((areg0).Unify(var1)))
				return Prolog.Fail0;
			local_aregs[0] = Data.F(run.s_findall, Data.F(run.s5, var2, var3),
					Data.F(run.s_program, var3.Deref(), var2.Deref(), var1.Deref()), var4,
					Data.F(run.s_phrase, Data.F(run.s_seq_non_interleaved, var4.Deref()), var5, Data.F(run.s_seq_clause,
							var5.Deref(), var6,
							Data.F(run.s_assert, Data.F(run.s12, run.s_rni, var6.Deref()), var7, Data.F(
									run.s_garbage_collect,
									Data.F(run.s_time, run.s_rni, Data.F(run.s_erase, var7.Deref(), continuation)))))));
			mach.CUTB = mach.CurrentChoice;
			local_aregs[1] = null;
			return (Operation) pred_compile_programs_0::exec_static;
		}
