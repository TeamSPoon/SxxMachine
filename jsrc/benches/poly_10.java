...
class poly_10 /* extends CodeFile */ {
...
class pred_on_load_poly_10_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_on_load_poly_10_0__1(PrologMachine mach) {
		mach.RemoveChoice();
...
class pred_poly_10_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_poly_10_0__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[0];
		Var var2 = V(mach);
...
class pred_test_poly_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_test_poly_1__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		...
		local_aregs[0] = F(poly_10.s16, poly_10.s29, F(poly_10.s4, F(poly_10.s23, poly_10.posint0, poly_10.posint1),
				F(poly_10.s4, F(poly_10.s23, poly_10.posint1, poly_10.posint1), Const.Nil)));
		local_aregs[1] = F(poly_10.s16, poly_10.s31,
				F(poly_10.s4, F(poly_10.s23, poly_10.posint1, poly_10.posint1), Const.Nil));
		local_aregs[2] = var2;
		local_aregs[3] = F(poly_10.s18,
				F(poly_10.s16, poly_10.s32, F(poly_10.s4, F(poly_10.s23, poly_10.posint1, poly_10.posint1), Const.Nil)),
...
class pred_less_than_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_less_than_2__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_less_than_2__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_less_than_2__3(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
...
class pred_poly_add_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_poly_add_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_poly_add_3__2(PrologMachine mach) {
		...
		local_aregs[2] = F(poly_10.s0, new HeapChoice(mach.CUTB),
				F(poly_10.s8, var2.Deref(), F(poly_10.s16, var3.Deref(), var4.Deref()), var5.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_less_than_2::exec_static;
	}

	public static Function<PrologMachine, Function> exec_pred_poly_add_3__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_poly_add_3__4(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_poly_add_3__5(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
...
class pred_term_add_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_term_add_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_term_add_3__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_term_add_3__3(PrologMachine mach) {
		...
		if (!((areg2).Unify(F(poly_10.s4, F(poly_10.s23, var1.Deref(), var6), var7))))
			return UpperPrologMachine.Fail0;
		mach.DoCut(mach.CUTB);
		local_aregs[0] = F(poly_10.s18, var2.Deref(), var4.Deref(), var6.Deref(),
				F(poly_10.s24, var3.Deref(), var5.Deref(), var7.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = local_aregs[2] = null;
		return UpperPrologMachine.Cut2;
	}

	public static Function<PrologMachine, Function> exec_pred_term_add_3__4(PrologMachine mach) {
		...
		local_aregs[2] = F(poly_10.s0, new HeapChoice(mach.CUTB), F(poly_10.s24, var3.Deref(),
				F(poly_10.s4, F(poly_10.s23, var4.Deref(), var5.Deref()), var6.Deref()), var7.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_smallerthan_2::exec_static;
	}

	public static Function<PrologMachine, Function> exec_pred_term_add_3__5(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
...
class pred_add_to_order_zero_term_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_add_to_order_zero_term_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_add_to_order_zero_term_3__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
...
class pred_poly_exp_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_poly_exp_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_poly_exp_3__2(PrologMachine mach) {
		...
		local_aregs[2] = F(poly_10.s11, var1.Deref(), F(poly_10.s6, var4.Deref(), poly_10.posint1),
				F(poly_10.s0, new HeapChoice(mach.CUTB), F(poly_10.s19, var4.Deref(), var2.Deref(), var5,
						F(poly_10.s20, var5.Deref(), var5.Deref(), var3.Deref(), continuation))));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_is_2::exec_static;
	}

	public static Function<PrologMachine, Function> exec_pred_poly_exp_3__3(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
		...
		local_aregs[2] = F(poly_10.s19, var4.Deref(), var2.Deref(), var5,
				F(poly_10.s20, var2.Deref(), var5.Deref(), var3.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_is_2::exec_static;
	}
...
class pred_poly_mul_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_poly_mul_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_poly_mul_3__2(PrologMachine mach) {
		...
		local_aregs[1] = var3.Deref();
		local_aregs[2] = F(poly_10.s0, new HeapChoice(mach.CUTB),
				F(poly_10.s13, var2.Deref(), F(poly_10.s16, var3.Deref(), var4.Deref()), var5.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_less_than_2::exec_static;
	}

	public static Function<PrologMachine, Function> exec_pred_poly_mul_3__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_poly_mul_3__4(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_poly_mul_3__5(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
...
class pred_term_mul_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_term_mul_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_term_mul_3__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_term_mul_3__3(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
		...
		local_aregs[2] = var5;
		local_aregs[3] = F(poly_10.s25, var2.Deref(), var3.Deref(), var6,
				F(poly_10.s24, var5.Deref(), var6.Deref(), var4.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
...
class pred_single_term_mul_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_single_term_mul_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_single_term_mul_3__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
		...
		local_aregs[2] = F(poly_10.s20, var2.Deref(), var5.Deref(), var7.Deref(),
				F(poly_10.s21, var3.Deref(), F(poly_10.s23, var4.Deref(), var5.Deref()), var8.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_is_2::exec_static;
	}
...
class pred_mul_through_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_mul_through_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_mul_through_3__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
