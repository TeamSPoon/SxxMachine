import java.util.function.Function; class qsort /*extends CodeFile*/ {static Const s0 = Const.Intern("cut") ;
...
qsort(_25838):-qsort([27,74,17,33,94,18,46,83,65,2,32,53,28,85,99,47,28,82,6,11,55,29,39,81,90,37,10,0,66,51,7,21,85,27,31,63,75,4,95,99,11,28,61,74,18,92,40,53,59,8],_25814,[],_25838).
...
public static Function<PrologMachine,Function> exec_pred_qsort_0__1(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[0] ;
Var var1 = V(mach) ;
...
qsort([_25936|_25938],_25944,_25946,_26030):-partition(_25938,_25936,_25954,_25956,qsort(_25956,_25962,_25946,qsort(_25954,_25944,[_25936|_25962],_26030))).
...
public static Function<PrologMachine,Function> exec_pred_qsort_3__1(PrologMachine mach){ mach.FillAlternative(pred_qsort_3::exec_pred_qsort_3__2) ;
Term local_aregs[] = mach.Areg ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(qsort.s1,var1,var2)))) return UpperPrologMachine.Fail0 ;
...
public static Function<PrologMachine,Function> exec_pred_qsort_3__2(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[3] ;
Term areg2 = local_aregs[2].Deref() ;
Term areg1 = local_aregs[1].Deref() ;
...
partition([_26418|_26420],_26432,[_26418|_26426],_26436,_26510):-smallerorequal(_26418,_26432,cut(1,partition(_26420,_26432,_26426,_26436,_26510))).
partition([_26728|_26730],_26742,_26744,[_26728|_26736],_26802):-partition(_26730,_26742,_26744,_26736,_26802).
...
public static Function<PrologMachine,Function> exec_pred_partition_4__1(PrologMachine mach){ mach.FillAlternative(pred_partition_4::exec_pred_partition_4__2) ;
Term local_aregs[] = mach.Areg ;
...
if (!( (areg0).Unify(F(qsort.s1,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(qsort.s1,var1.Deref(),var4)))) return UpperPrologMachine.Fail0 ;
if (!( (areg3).Unify(var5))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = var1.Deref() ;
local_aregs[1] = var3.Deref() ;
local_aregs[2] = F(qsort.s0, new HeapChoice(mach.CUTB),F(qsort.s5,var2.Deref(),var3.Deref(),var4.Deref(),var5.Deref(),continuation)) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[4] = local_aregs[3] = null ;
return (Function<PrologMachine,Function>)pred_smallerorequal_2::exec_static ;}
public static Function<PrologMachine,Function> exec_pred_partition_4__2(PrologMachine mach){ mach.FillAlternative(pred_partition_4::exec_pred_partition_4__3) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[4] ;
Term areg3 = local_aregs[3].Deref() ;
Term areg2 = local_aregs[2].Deref() ;
...
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(var4))) return UpperPrologMachine.Fail0 ;
if (!( (areg3).Unify(F(qsort.s1,var1.Deref(),var5)))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = var2.Deref() ;
local_aregs[1] = var3.Deref() ;
...
mach.CUTB = mach.CurrentChoice ;
return (Function<PrologMachine,Function>)pred_partition_4::exec_static ;}
public static Function<PrologMachine,Function> exec_pred_partition_4__3(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[4] ;
Term areg3 = local_aregs[3].Deref() ;
Term areg2 = local_aregs[2].Deref() ;
