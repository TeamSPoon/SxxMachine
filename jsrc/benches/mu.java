import java.util.function.Function; class mu /*extends CodeFile*/ {static Const s0 = Const.Intern("cut") ;
...
public static Function<PrologMachine,Function> exec_pred_mu_0__1(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[0] ;
Var var1 = V(mach) ;
...
theorem(_34154,_34166,[[_34152|_34154]|_34160],_34260):-smallerthan(0,_34166,is(_34184,_34166-1,theorem(_34190,_34184,_34160,rule(_34152,_34190,_34154,_34260)))).
...
public static Function<PrologMachine,Function> exec_pred_theorem_3__1(PrologMachine mach){ mach.FillAlternative(pred_theorem_3::exec_pred_theorem_3__2) ;
Term local_aregs[] = mach.Areg ;
...
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(mu.s2,mu.s10,F(mu.s2,mu.s8,Const.Nil))))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var1))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(mu.s2,F(mu.s2,mu.s4,F(mu.s2,mu.s10,F(mu.s2,mu.s8,Const.Nil))),Const.Nil)))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = local_aregs[1] = null ;
return UpperPrologMachine.Call1 ;}
public static Function<PrologMachine,Function> exec_pred_theorem_3__2(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[3] ;
Term areg2 = local_aregs[2].Deref() ;
Term areg1 = local_aregs[1].Deref() ;
...
if (!( (areg2).Unify(F(mu.s2,F(mu.s2,var3,var1.Deref()),var4)))) return UpperPrologMachine.Fail0 ;
...
public static Function<PrologMachine,Function> exec_pred_rule_3__1(PrologMachine mach){ mach.FillAlternative(pred_rule_3::exec_pred_rule_3__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[3] ;
Term areg2 = local_aregs[2].Deref() ;
Term areg1 = local_aregs[1].Deref() ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(mu.posint1))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var1))) return UpperPrologMachine.Fail0 ;
...
public static Function<PrologMachine,Function> exec_pred_rule_3__2(PrologMachine mach){ mach.FillAlternative(pred_rule_3::exec_pred_rule_3__3) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[3] ;
Term areg2 = local_aregs[2].Deref() ;
Term areg1 = local_aregs[1].Deref() ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(mu.posint2))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var1))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(var2))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = var1.Deref() ;
local_aregs[1] = var2.Deref() ;
...
public static Function<PrologMachine,Function> exec_pred_rule_3__3(PrologMachine mach){ mach.FillAlternative(pred_rule_3::exec_pred_rule_3__4) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[3] ;
Term areg2 = local_aregs[2].Deref() ;
Term areg1 = local_aregs[1].Deref() ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(mu.posint3))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var1))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(var2))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = var1.Deref() ;
local_aregs[1] = var2.Deref() ;
...
public static Function<PrologMachine,Function> exec_pred_rule_3__4(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[3] ;
Term areg2 = local_aregs[2].Deref() ;
Term areg1 = local_aregs[1].Deref() ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(mu.posint4))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var1))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(var2))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = var1.Deref() ;
local_aregs[1] = var2.Deref() ;
...
public static Function<PrologMachine,Function> exec_pred_rule1_2__1(PrologMachine mach){ mach.FillAlternative(pred_rule1_2::exec_pred_rule1_2__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
if (!( (areg0).Unify(F(mu.s2,mu.s8,Const.Nil)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(F(mu.s2,mu.s8,F(mu.s2,mu.s20,Const.Nil))))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = local_aregs[1] = null ;
return UpperPrologMachine.Call1 ;}
public static Function<PrologMachine,Function> exec_pred_rule1_2__2(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(mu.s2,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(F(mu.s2,var1.Deref(),var3)))) return UpperPrologMachine.Fail0 ;
...
public static Function<PrologMachine,Function> exec_pred_rule2_2__1(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(mu.s2,mu.s10,var1)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(F(mu.s2,mu.s10,var2)))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = var1.Deref() ;
...
public static Function<PrologMachine,Function> exec_pred_rule3_2__1(PrologMachine mach){ mach.FillAlternative(pred_rule3_2::exec_pred_rule3_2__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(mu.s2,mu.s8,F(mu.s2,mu.s8,F(mu.s2,mu.s8,var1)))))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(F(mu.s2,mu.s20,var1.Deref())))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = local_aregs[1] = null ;
return UpperPrologMachine.Call1 ;}
public static Function<PrologMachine,Function> exec_pred_rule3_2__2(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Function<PrologMachine,Function> exec_pred_rule4_2__1(PrologMachine mach){ mach.FillAlternative(pred_rule4_2::exec_pred_rule4_2__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(mu.s2,mu.s20,F(mu.s2,mu.s20,var1))))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var1.Deref()))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = local_aregs[1] = null ;
return UpperPrologMachine.Call1 ;}
public static Function<PrologMachine,Function> exec_pred_rule4_2__2(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
append([_36558|_36560],_36572,[_36558|_36566],_36622):-append(_36560,_36572,_36566,_36622).
...
if (!( (areg2).Unify(F(mu.s2,var1.Deref(),var4)))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = var2.Deref() ;
local_aregs[1] = var3.Deref() ;
