...
class flatten /* extends CodeFile */ {
...
class pred_top_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_top_0__1(PrologMachine mach) {
		...
		Var var2 = V(mach);
		Var var1 = V(mach);
		local_aregs[0] = F(flatten.s6, F(flatten.s7, F(flatten.s16, var1, var2, var3),
				F(flatten.s8, F(flatten.s20, var1.Deref()), F(flatten.s21, var3.Deref()))), Const.Nil);
		local_aregs[1] = var4;
		local_aregs[2] = var5;
	...
	public static Function<PrologMachine, Function> exec_pred_top_0__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[0];
...
class pred_eliminate_disjunctions_4 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_eliminate_disjunctions_4__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
...
class pred_gather_disj_4 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_gather_disj_4__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_gather_disj_4__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[4];
		Term areg3 = local_aregs[3].Deref();
		...
		local_aregs[3] = var7;
		local_aregs[4] = F(flatten.s58, F(flatten.s6, var6.Deref(), var8), var3.Deref(),
				F(flatten.s32, var2.Deref(), var8.Deref(), var7.Deref(), var5.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
...
class pred_extract_disj_4 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_extract_disj_4__1(PrologMachine mach) {
		...
		local_aregs[2] = F(flatten.s0, new HeapChoice(mach.CUTB),
				F(flatten.s58, flatten.posint0, var7, F(flatten.s28, var6.Deref(), var3.Deref(), var4.Deref(),
						var5.Deref(), var1.Deref(), var7.Deref(), var8, continuation)));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[4] = local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_unify_2::exec_static;
	}

	public static Function<PrologMachine, Function> exec_pred_extract_disj_4__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[4];
		Term areg3 = local_aregs[3].Deref();
...
class pred_extract_disj_7 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_extract_disj_7__1(PrologMachine mach) {
		...
		local_aregs[6] = var11;
		local_aregs[7] = F(flatten.s28, var2.Deref(), var4.Deref(), var10.Deref(), var6.Deref(), var7.Deref(),
				var11.Deref(), var9.Deref(), continuation);
		mach.CUTB = mach.CurrentChoice;
		return (Function<PrologMachine, Function>) pred_extract_disj_7::exec_static;
	}

	public static Function<PrologMachine, Function> exec_pred_extract_disj_7__2(PrologMachine mach) {
		...
		local_aregs[2] = F(flatten.s0, new HeapChoice(mach.CUTB),
				F(flatten.s58,
						F(flatten.s6, F(flatten.s26, var8.Deref(), var6.Deref(), var2.Deref(), var5.Deref()),
								var4.Deref()),
						var3.Deref(),
						F(flatten.s37, var7.Deref(), F(flatten.s2, var6.Deref(), flatten.posint1), continuation)));
		mach.CUTB = mach.CurrentChoice;
	...
	public static Function<PrologMachine, Function> exec_pred_extract_disj_7__3(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[7];
		Term areg6 = local_aregs[6].Deref();
...
class pred_is_disj_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_is_disj_2__1(PrologMachine mach) {
		...
		if (!((areg0).Unify(F(flatten.s8, F(flatten.s5, var1, var2), var3))))
			return UpperPrologMachine.Fail0;
		if (!((areg1).Unify(
				F(flatten.s8, F(flatten.s3, var1.Deref(), F(flatten.s3, flatten.s1, var2.Deref())), var3.Deref()))))
			return UpperPrologMachine.Fail0;
	...
	public static Function<PrologMachine, Function> exec_pred_is_disj_2__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_is_disj_2__3(PrologMachine mach) {
		...
		if (!((areg0).Unify(F(flatten.s44, var1))))
			return UpperPrologMachine.Fail0;
		if (!((areg1).Unify(
				F(flatten.s8, F(flatten.s3, var1.Deref(), F(flatten.s3, flatten.s1, flatten.s29)), flatten.s57))))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = continuation;
		mach.CUTB = mach.CurrentChoice;
		local_aregs[2] = local_aregs[1] = null;
	...
	public static Function<PrologMachine, Function> exec_pred_is_disj_2__4(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_is_disj_2__5(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
		...
		if (!((areg0).Unify(F(flatten.s14, var1, var2))))
			return UpperPrologMachine.Fail0;
		if (!((areg1).Unify(F(flatten.s8,
				F(flatten.s3, F(flatten.s9, var1.Deref(), var2.Deref()), F(flatten.s3, flatten.s1, flatten.s29)),
				flatten.s57))))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = continuation;
		mach.CUTB = mach.CurrentChoice;
...
class pred_treat_disj_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_treat_disj_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_treat_disj_3__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
		...
		local_aregs[1] = var9;
		local_aregs[2] = F(flatten.s30, var5.Deref(), var10,
				F(flatten.s36, var9.Deref(), var10.Deref(), var11,
						F(flatten.s40, var3.Deref(), var12,
								F(flatten.s10, var4.Deref(), F(flatten.s6, var12.Deref(), var11.Deref()), F(flatten.s39,
										F(flatten.s8, var1.Deref(), var2.Deref()), var4.Deref(), var7.Deref(), var13,
										F(flatten.s56, var6.Deref(), var13.Deref(), var8.Deref(), continuation))))));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
...
class pred_make_dummy_clauses_4 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_make_dummy_clauses_4__1(PrologMachine mach) {
		...
		if (!((areg3).Unify(var6)))
			return UpperPrologMachine.Fail0;
		mach.DoCut(mach.CUTB);
		local_aregs[0] = F(flatten.s23, F(flatten.s7, var3.Deref(), var1.Deref()), var4.Deref(),
				F(flatten.s39, var2.Deref(), var3.Deref(), var5.Deref(), var6.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[4] = local_aregs[3] = local_aregs[2] = null;
		return UpperPrologMachine.Cut2;
	}

	public static Function<PrologMachine, Function> exec_pred_make_dummy_clauses_4__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[4];
		Term areg3 = local_aregs[3].Deref();
...
class pred_find_vars_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_find_vars_2__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
...
class pred_find_vars_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_find_vars_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_find_vars_3__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_find_vars_3__3(PrologMachine mach) {
		...
		if (!((areg2).Unify(var4)))
			return UpperPrologMachine.Fail0;
		mach.DoCut(mach.CUTB);
		local_aregs[0] = F(flatten.s30, var1.Deref(), var3.Deref(), var5,
				F(flatten.s30, var2.Deref(), var5.Deref(), var4.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = local_aregs[2] = null;
		return UpperPrologMachine.Cut2;
	}

	public static Function<PrologMachine, Function> exec_pred_find_vars_3__4(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
...
class pred_intersect_vars_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_intersect_vars_3__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
		...
		local_aregs[0] = var1.Deref();
		local_aregs[1] = var4;
		local_aregs[2] = F(flatten.s50, var2.Deref(), var5,
				F(flatten.s35, var4.Deref(), var5.Deref(), var3.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
...
class pred_make_dummy_name_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_make_dummy_name_2__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
		...
		local_aregs[1] = var3;
		local_aregs[2] = F(flatten.s42, var1.Deref(), var4, F(flatten.s17, var3.Deref(), var4.Deref(), var5,
				F(flatten.s42, var2.Deref(), var5.Deref(), continuation)));
		mach.CUTB = mach.CurrentChoice;
...
class pred_copy_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_copy_2__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
		...
		local_aregs[0] = var1.Deref();
		local_aregs[1] = var3;
		local_aregs[2] = F(flatten.s41, var3.Deref(), var4, F(flatten.s24, var1.Deref(), var2.Deref(), var4.Deref(),
				F(flatten.s0, new HeapChoice(mach.CUTB), continuation)));
		mach.CUTB = mach.CurrentChoice;
...
class pred_copy2_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_copy2_3__1(PrologMachine mach) {
		...
		if (!((areg2).Unify(var3)))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = var1.Deref();
		local_aregs[1] = F(flatten.s0, new HeapChoice(mach.CUTB),
				F(flatten.s46, var1.Deref(), var3.Deref(), var2.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = local_aregs[2] = null;
		return (Function<PrologMachine, Function>) pred_var_1::exec_static;
	}

	public static Function<PrologMachine, Function> exec_pred_copy2_3__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
		...
		local_aregs[0] = var1.Deref();
		local_aregs[1] = F(flatten.s0, new HeapChoice(mach.CUTB),
				F(flatten.s31, var1.Deref(), var4, var5,
						F(flatten.s31, var2.Deref(), var4.Deref(), var5.Deref(), F(flatten.s24, var1.Deref(),
								var2.Deref(), var3.Deref(), flatten.posint1, var5.Deref(), continuation))));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = local_aregs[2] = null;
...
class pred_copy2_5 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_copy2_5__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_copy2_5__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[5];
		Term areg4 = local_aregs[4].Deref();
		...
		local_aregs[2] = F(flatten.s0, new HeapChoice(mach.CUTB),
				F(flatten.s18, var4.Deref(), var1.Deref(), var6,
						F(flatten.s18, var4.Deref(), var2.Deref(), var7,
								F(flatten.s24, var6.Deref(), var7.Deref(), var3.Deref(),
										F(flatten.s37, var8, F(flatten.s2, var4.Deref(), flatten.posint1),
												F(flatten.s24, var1.Deref(), var2.Deref(), var3.Deref(), var8.Deref(),
...
class pred_retrieve_sym_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_retrieve_sym_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_retrieve_sym_3__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
...
class pred_make_sym_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_make_sym_2__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_make_sym_2__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
...
class pred_sym_dcg_arrow_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_sym_dcg_arrow_2__1(PrologMachine mach) {
		...
		if (!((areg0).Unify(F(flatten.s60, var1))))
			return UpperPrologMachine.Fail0;
		if (!((areg1).Unify(F(flatten.s3, F(flatten.s62, F(flatten.s59, var1.Deref())),
				F(flatten.s3, flatten.s1, F(flatten.s6, var1.Deref(), Const.Nil))))))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = continuation;
		mach.CUTB = mach.CurrentChoice;
		local_aregs[2] = local_aregs[1] = null;
	...
	public static Function<PrologMachine, Function> exec_pred_sym_dcg_arrow_2__2(PrologMachine mach) {
		...
		if (!((areg0).Unify(F(flatten.s60, var1))))
			return UpperPrologMachine.Fail0;
		if (!((areg1).Unify(F(flatten.s3,
				F(flatten.s62,
						F(flatten.s3, F(flatten.s43, var1.Deref()),
								F(flatten.s3, flatten.s1, F(flatten.s31, var1.Deref(), var2, var3)))),
				F(flatten.s60, var1.Deref(), flatten.posint1, var3.Deref())))))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = continuation;
		mach.CUTB = mach.CurrentChoice;
		local_aregs[2] = local_aregs[1] = null;
	...
	public static Function<PrologMachine, Function> exec_pred_sym_dcg_arrow_2__4(PrologMachine mach) {
		...
		if (!((areg0).Unify(F(flatten.s60, var1, var2, var3))))
			return UpperPrologMachine.Fail0;
		if (!((areg1).Unify(F(flatten.s3, F(flatten.s62, F(flatten.s11, var2.Deref(), var3.Deref())),
				F(flatten.s3, flatten.s1,
						F(flatten.s3, F(flatten.s62, F(flatten.s18, var2.Deref(), var1.Deref(), var4)),
								F(flatten.s3, F(flatten.s60, var4.Deref()), F(flatten.s3,
										F(flatten.s62,
												F(flatten.s37, var5, F(flatten.s2, var2.Deref(), flatten.posint1))),
										F(flatten.s60, var1.Deref(), var5.Deref(), var3.Deref())))))))))
			return UpperPrologMachine.Fail0;
		local_aregs[0] = continuation;
		mach.CUTB = mach.CurrentChoice;
		local_aregs[2] = local_aregs[1] = null;
...
class pred_inst_vars_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_inst_vars_1__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		...
		local_aregs[0] = var1.Deref();
		local_aregs[1] = var2;
		local_aregs[2] = F(flatten.s58, F(flatten.s6, flatten.posint65, Const.Nil), F(flatten.s6, var3, Const.Nil),
				F(flatten.s34, var2.Deref(), var3.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		return (Function<PrologMachine, Function>) pred_varset_2::exec_static;
	}
}
...
class pred_inst_vars_list_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_inst_vars_list_2__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_inst_vars_list_2__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
		...
		local_aregs[2] = F(flatten.s37, var4, F(flatten.s2, var3.Deref(), flatten.posint1),
				F(flatten.s34, var2.Deref(), var4.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		return (Function<PrologMachine, Function>) pred_name_2::exec_static;
	}
}
...
class pred_sort_vars_2 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_sort_vars_2__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[2];
		Term areg1 = local_aregs[1].Deref();
...
class pred_sort_vars_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_sort_vars_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_sort_vars_3__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
		...
		local_aregs[2] = var5;
		local_aregs[3] = var6;
		local_aregs[4] = F(flatten.s50, var5.Deref(), var3.Deref(), F(flatten.s6, var1.Deref(), var7),
				F(flatten.s50, var6.Deref(), var7.Deref(), var4.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
...
class pred_intersect_sorted_vars_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_intersect_sorted_vars_3__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_intersect_sorted_vars_3__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_intersect_sorted_vars_3__3(PrologMachine mach) {
		...
		local_aregs[1] = var3.Deref();
		local_aregs[2] = F(flatten.s0, new HeapChoice(mach.CUTB),
				F(flatten.s35, var2.Deref(), var4.Deref(), var5.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_termequal_2::exec_static;
	}

	public static Function<PrologMachine, Function> exec_pred_intersect_sorted_vars_3__4(PrologMachine mach) {
		...
		local_aregs[1] = var3.Deref();
		local_aregs[2] = F(flatten.s0, new HeapChoice(mach.CUTB),
				F(flatten.s35, var2.Deref(), F(flatten.s6, var3.Deref(), var4.Deref()), var5.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_termsmallerthan_2::exec_static;
	}

	public static Function<PrologMachine, Function> exec_pred_intersect_sorted_vars_3__5(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
		...
		local_aregs[1] = var3.Deref();
		local_aregs[2] = F(flatten.s0, new HeapChoice(mach.CUTB),
				F(flatten.s35, F(flatten.s6, var1.Deref(), var2.Deref()), var4.Deref(), var5.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[3] = null;
...
class pred_split_vars_4 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_split_vars_4__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_split_vars_4__2(PrologMachine mach) {
		...
		local_aregs[1] = var3.Deref();
		local_aregs[2] = F(flatten.s0, new HeapChoice(mach.CUTB),
				F(flatten.s51, var2.Deref(), var3.Deref(), var4.Deref(), var5.Deref(), continuation));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[4] = local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_termsmallerthan_2::exec_static;
	}

	public static Function<PrologMachine, Function> exec_pred_split_vars_4__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_split_vars_4__4(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[4];
		Term areg3 = local_aregs[3].Deref();
