import java.util.function.Function; class ops8 /*extends CodeFile*/ {static Const s0 = Const.Intern("cut") ;
...
d(_9166+_9168,_9180,_9172+_9174,_9250):-cut(1,d(_9166,_9180,_9172,d(_9168,_9180,_9174,_9250))).
d(_9448-_9450,_9462,_9454-_9456,_9532):-cut(1,d(_9448,_9462,_9454,d(_9450,_9462,_9456,_9532))).
d(_9730*_9732,_9756,_9736*_9732+_9730*_9744,_9826):-cut(1,d(_9730,_9756,_9736,d(_9732,_9756,_9744,_9826))).
d(_10024/_10026,_10062,(_10030*_10026-_10024*_10038)/_10026^2,_10132):-cut(1,d(_10024,_10062,_10030,d(_10026,_10062,_10038,_10132))).
d(_10330^_10332,_10356,_10336*_10332*_10330^_10344,_10440):-cut(1,integer(_10332,is(_10344,_10332-1,d(_10330,_10356,_10336,_10440)))).
d(-_10660,_10670,-_10664,_10726):-cut(1,d(_10660,_10670,_10664,_10726)).
d(exp(_10860),_10876,exp(_10860)*_10870,_10932):-cut(1,d(_10860,_10876,_10870,_10932)).
d(log(_11066),_11078,_11070/_11066,_11134):-cut(1,d(_11066,_11078,_11070,_11134)).
d(_11268,_11268,1,_11312):-cut(1,_11312).
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(ops8.s2,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(ops8.s2,var4,var5)))) return UpperPrologMachine.Fail0 ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(ops8.s3,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(ops8.s3,var4,var5)))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(ops8.s10,var1.Deref(),var3.Deref(),var4.Deref(),F(ops8.s10,var2.Deref(),var3.Deref(),var5.Deref(),continuation)) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(ops8.s1,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(ops8.s2,F(ops8.s1,var4,var2.Deref()),F(ops8.s1,var1.Deref(),var5))))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(ops8.s10,var1.Deref(),var3.Deref(),var4.Deref(),F(ops8.s10,var2.Deref(),var3.Deref(),var5.Deref(),continuation)) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(ops8.s5,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(ops8.s5,F(ops8.s3,F(ops8.s1,var4,var2.Deref()),F(ops8.s1,var1.Deref(),var5)),F(ops8.s7,var2.Deref(),ops8.posint2))))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(ops8.s10,var1.Deref(),var3.Deref(),var4.Deref(),F(ops8.s10,var2.Deref(),var3.Deref(),var5.Deref(),continuation)) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(ops8.s7,var1,var2)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var3))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(ops8.s1,F(ops8.s1,var4,var2.Deref()),F(ops8.s7,var1.Deref(),var5))))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(ops8.s3,var1)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var2))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(ops8.s3,var3)))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(ops8.s11,var1)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var2))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(ops8.s1,F(ops8.s11,var1.Deref()),var3)))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(ops8.s10,var1.Deref(),var2.Deref(),var3.Deref(),continuation) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(ops8.s14,var1)))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var2))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(F(ops8.s5,var3,var1.Deref())))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = F(ops8.s10,var1.Deref(),var2.Deref(),var3.Deref(),continuation) ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
if (!( (areg2).Unify(ops8.posint1))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
...
if (!( (areg0).Unify(var1))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(var2))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(ops8.posint0))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
