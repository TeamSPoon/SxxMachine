import java.util.function.Function; class tak /*extends CodeFile*/ {static Const s0 = Const.Intern("cut") ;
...
public static Function<PrologMachine,Function> exec_pred_tak_0__1(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[0] ;
Var var1 = V(mach) ;
...
tak(_4854,_4856,_4858,_4860,_4924):-smallerorequal(_4854,_4856,unify(_4860,_4858,_4924)).
tak(_5108,_5110,_5112,_5114,_5284):-smallerthan(_5110,_5108,is(_5130,_5108-1,tak(_5130,_5110,_5112,_5142,is(_5152,_5110-1,tak(_5152,_5112,_5108,_5164,is(_5174,_5112-1,tak(_5174,_5108,_5110,_5186,tak(_5142,_5164,_5186,_5114,_5284)))))))).
...
public static Function<PrologMachine,Function> exec_pred_tak_4__1(PrologMachine mach){ mach.FillAlternative(pred_tak_4::exec_pred_tak_4__2) ;
Term local_aregs[] = mach.Areg ;
...
public static Function<PrologMachine,Function> exec_pred_tak_4__2(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[4] ;
Term areg3 = local_aregs[3].Deref() ;
Term areg2 = local_aregs[2].Deref() ;
