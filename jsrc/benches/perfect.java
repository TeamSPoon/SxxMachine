import java.util.function.Function; class perfect /*extends CodeFile*/ {static Const s0 = Const.Intern("cut") ;
...
static Int posint2787593149816327892690784192460327776944128 = Term.Number(2787593149816327892690784192460327776944128) ;
static Int posint44601490397061246283066714178813853366747136 = Term.Number(44601490397061246283066714178813853366747136) ;
static Int posint182687704666362864775460301858080473799697891328 = Term.Number(182687704666362864775460301858080473799697891328) ;
static Int posint46768052394588893382517909811217778170473142550528 = Term.Number(46768052394588893382517909811217778170473142550528) ;
static Int posint191561942608236107294793378084303638130997321548169216 = Term.Number(191561942608236107294793378084303638130997321548169216) ;
static Int posint12554203470773361527671578846336104669690446551334525075456 = Term.Number(12554203470773361527671578846336104669690446551334525075456) ;
static Int posint3213876088517980551083924184681057554444177758164088967397376 = Term.Number(3213876088517980551083924184681057554444177758164088967397376) ;
}
...
divisible(_13668,_13670,_13746):-is(_13680,_13670*_13670,smallerorequal(_13680,_13668,arithequal(0,_13668 mod _13670,_13746))).
divisible(_13964,_13966,_14036):-smallerthan(_13966,_13964,is(_13982,_13966+1,divisible(_13964,_13982,_14036))).
...
public static Function<PrologMachine,Function> exec_pred_divisible_2__1(PrologMachine mach){ mach.FillAlternative(pred_divisible_2::exec_pred_divisible_2__2) ;
Term local_aregs[] = mach.Areg ;
...
public static Function<PrologMachine,Function> exec_pred_divisible_2__2(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
isprime([_14248|_14250],_14248,_14324):-is(_14260,2,smallerthan(1,_14248,not(divisible(_14248,_14260),_14324))).
...
public static Function<PrologMachine,Function> exec_pred_isprime_2__1(PrologMachine mach){ mach.FillAlternative(pred_isprime_2::exec_pred_isprime_2__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(F(perfect.s4,var1,var2)))) return UpperPrologMachine.Fail0 ;
...
mach.CUTB = mach.CurrentChoice ;
return (Function<PrologMachine,Function>)pred_is_2::exec_static ;}
public static Function<PrologMachine,Function> exec_pred_isprime_2__2(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
power(_14818,_14820,_14822,_14906):-is(_14832,_14820-1,power(_14818,_14832,_14842,is(_14822,_14842*_14818,_14906))).
...
public static Function<PrologMachine,Function> exec_pred_power_3__1(PrologMachine mach){ mach.FillAlternative(pred_power_3::exec_pred_power_3__2) ;
Term local_aregs[] = mach.Areg ;
...
Var var1 = V(mach) ;
if (!( (areg0).Unify(var1))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(perfect.posint0))) return UpperPrologMachine.Fail0 ;
if (!( (areg2).Unify(perfect.posint1))) return UpperPrologMachine.Fail0 ;
mach.DoCut(mach.CUTB)  ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[3] = local_aregs[2] = null ;
return UpperPrologMachine.Cut2 ;}
public static Function<PrologMachine,Function> exec_pred_power_3__2(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[3] ;
Term areg2 = local_aregs[2].Deref() ;
Term areg1 = local_aregs[1].Deref() ;
...
calc(2,_15148,_15150,_15254):-power(2,_15148,_15158,is(_15168,_15158-1,power(2,_15148-1,_15184,is(_15150,_15168*_15184,_15254)))).
...
public static Function<PrologMachine,Function> exec_pred_calc_3__1(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[3] ;
Term areg2 = local_aregs[2].Deref() ;
Term areg1 = local_aregs[1].Deref() ;
...
Var var2 = V(mach) ;
Var var1 = V(mach) ;
if (!( (areg0).Unify(perfect.posint2))) return UpperPrologMachine.Fail0 ;
...
public static Function<PrologMachine,Function> exec_pred_listperf_2__1(PrologMachine mach){ mach.FillAlternative(pred_listperf_2::exec_pred_listperf_2__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
public static Function<PrologMachine,Function> exec_pred_listperf_2__2(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
generateList(_16074,[_16068|_16070],_16164):-smallerthan(0,_16074,is(_16068,_16074+1,is(_16104,_16074-1,generateList(_16104,_16070,_16164)))).
...
public static Function<PrologMachine,Function> exec_pred_generateList_2__1(PrologMachine mach){ mach.FillAlternative(pred_generateList_2::exec_pred_generateList_2__2) ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
if (!( (areg0).Unify(perfect.posint0))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(Const.Nil))) return UpperPrologMachine.Fail0 ;
local_aregs[0] = continuation ;
mach.CUTB = mach.CurrentChoice ;
local_aregs[2] = local_aregs[1] = null ;
return UpperPrologMachine.Call1 ;}
public static Function<PrologMachine,Function> exec_pred_generateList_2__2(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
...
Var var1 = V(mach) ;
if (!( (areg0).Unify(var1))) return UpperPrologMachine.Fail0 ;
if (!( (areg1).Unify(F(perfect.s4,var2,var3)))) return UpperPrologMachine.Fail0 ;
...
perfect(_16456,_16458,_16530):-generateList(_16456,_16464,findall(_16470,isprime(_16464,_16470),_16478,listperf(_16478,_16458,_16530))).
...
public static Function<PrologMachine,Function> exec_pred_perfect_2__1(PrologMachine mach){ mach.RemoveChoice() ;
Term local_aregs[] = mach.Areg ;
Term continuation = local_aregs[2] ;
Term areg1 = local_aregs[1].Deref() ;
Term areg0 = local_aregs[0].Deref() ;
