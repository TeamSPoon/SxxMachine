...
class pred_top_0 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_top_0__1(PrologMachine mach) {
		...
		Var var1 = V(mach);
		local_aregs[0] = var1;
		local_aregs[1] = F(crypt.s8, var2, F(crypt.s8, var3, F(crypt.s8, var4, F(crypt.s12,
				F(crypt.s3, var3.Deref(), F(crypt.s3, var2.Deref(), F(crypt.s3, var1.Deref(), Const.Nil))),
				var4.Deref(), F(crypt.s3, var5, F(crypt.s3, var6, F(crypt.s3, var7, F(crypt.s3, var8, var9)))),
				F(crypt.s10, var8.Deref(), F(crypt.s13, var7.Deref(), F(crypt.s8, var6.Deref(),
						F(crypt.s8, var5.Deref(), F(crypt.s16, var9.Deref(), F(crypt.s10, var10, F(crypt.s12,
								F(crypt.s3, var3.Deref(),
										F(crypt.s3, var2.Deref(), F(crypt.s3, var1.Deref(), Const.Nil))),
								var10.Deref(), F(crypt.s3, var11, F(crypt.s3, var12, F(crypt.s3, var13, var14))),
								F(crypt.s10, var13.Deref(),
										F(crypt.s13, var12.Deref(), F(crypt.s8, var11.Deref(), F(crypt.s16,
												var14.Deref(), F(crypt.s14, F(crypt.s3, var5.Deref(),
														F(crypt.s3, var6.Deref(),
																F(crypt.s3, var7.Deref(),
																		F(crypt.s3, var8.Deref(), Const.Nil)))),
														F(crypt.s3, crypt.posint0, F(crypt.s3, var11.Deref(),
																F(crypt.s3, var12.Deref(),
																		F(crypt.s3, var13.Deref(), Const.Nil)))),
														F(crypt.s3, var15,
																F(crypt.s3, var16,
																		F(crypt.s3, var17, F(crypt.s3, var18, var19)))),
														F(crypt.s13, var18.Deref(),
																F(crypt.s13, var17.Deref(), F(crypt.s8, var16.Deref(),
																		F(crypt.s8, var15.Deref(), F(crypt.s16,
																				var19.Deref(),
																				continuation)))))))))))))))))))));
...
class pred_sum_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_sum_3__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
...
class pred_sum_4 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_sum_4__1(PrologMachine mach) {
		...
		local_aregs[0] = F(crypt.s9, var8, F(crypt.s2, F(crypt.s2, var1.Deref(), var3.Deref()), var5.Deref()),
				F(crypt.s9, var6.Deref(), F(crypt.s11, var8.Deref(), crypt.posint10),
						F(crypt.s9, var9, F(crypt.s4, var8.Deref(), crypt.posint10),
								F(crypt.s14, var2.Deref(), var4.Deref(), var9.Deref(), var7.Deref(), continuation))));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[4] = local_aregs[3] = local_aregs[2] = null;
		return UpperPrologMachine.Cut2;
	}

	public static Function<PrologMachine, Function> exec_pred_sum_4__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_sum_4__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_sum_4__4(PrologMachine mach) {
		...
		if (!((areg3).Unify(F(crypt.s3, var4, var5))))
			return UpperPrologMachine.Fail0;
		mach.DoCut(mach.CUTB);
		local_aregs[0] = F(crypt.s9, var6, F(crypt.s2, var1.Deref(), var3.Deref()),
				F(crypt.s9, var7, F(crypt.s4, var6.Deref(), crypt.posint10),
						F(crypt.s9, var4.Deref(), F(crypt.s11, var6.Deref(), crypt.posint10),
								F(crypt.s14, Const.Nil, var2.Deref(), var7.Deref(), var5.Deref(), continuation))));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[4] = local_aregs[3] = local_aregs[2] = null;
		return UpperPrologMachine.Cut2;
	}

	public static Function<PrologMachine, Function> exec_pred_sum_4__5(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_sum_4__6(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[4];
		Term areg3 = local_aregs[3].Deref();
...
class pred_mult_3 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_mult_3__1(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[3];
		Term areg2 = local_aregs[2].Deref();
...
class pred_mult_4 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_mult_4__1(PrologMachine mach) {
		...
		local_aregs[2] = F(crypt.s9, var5.Deref(), F(crypt.s11, var7.Deref(), crypt.posint10),
				F(crypt.s9, var8, F(crypt.s4, var7.Deref(), crypt.posint10),
						F(crypt.s12, var2.Deref(), var3.Deref(), var8.Deref(), var6.Deref(), continuation)));
		mach.CUTB = mach.CurrentChoice;
		local_aregs[4] = local_aregs[3] = null;
		return (Function<PrologMachine, Function>) pred_is_2::exec_static;
	}

	public static Function<PrologMachine, Function> exec_pred_mult_4__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[4];
		Term areg3 = local_aregs[3].Deref();
...
class pred_zero_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_zero_1__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_zero_1__2(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
...
class pred_odd_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_odd_1__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_odd_1__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_odd_1__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_odd_1__4(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_odd_1__5(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
...
class pred_even_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_even_1__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_even_1__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_even_1__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_even_1__4(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_even_1__5(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
...
class pred_lefteven_1 extends Code {
	...
	public static Function<PrologMachine, Function> exec_pred_lefteven_1__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_lefteven_1__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_lefteven_1__3(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_lefteven_1__4(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
