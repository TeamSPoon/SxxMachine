...
public class animal /*extends CodeFile*/ {
	...
	public static class pred_animal_1 extends Code {
		...
		*/
		...
		public static Operation exec_pred_animal_1__1(Prolog mach) {
		...
		public static Operation exec_pred_animal_1__2(Prolog mach) {
		...
		public static Operation exec_pred_animal_1__3(Prolog mach) {
			mach.RemoveChoice();
			Term local_aregs[] = mach.Areg;
			Term continuation = local_aregs[1];
			Term areg0 = local_aregs[0].Deref();
