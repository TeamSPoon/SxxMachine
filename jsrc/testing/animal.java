...
class pred_animal_1 extends Code {
	...
	/*
	 * 
	 * animal(goat,_5346):-call(_5346). animal(elephant,_5420):-call(_5420).
	 * animal(_5472,_5514):-write('please type one more animal name:
	 * ',read(_5472,_5514)).
	 * 
	 * 
	 */
	...
	public static Function<PrologMachine, Function> exec_pred_animal_1__1(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_animal_1__2(PrologMachine mach) {
	...
	public static Function<PrologMachine, Function> exec_pred_animal_1__3(PrologMachine mach) {
		mach.RemoveChoice();
		Term local_aregs[] = mach.Areg;
		Term continuation = local_aregs[1];
		Term areg0 = local_aregs[0].Deref();
