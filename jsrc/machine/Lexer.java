...
public class Lexer extends StreamTokenizer {
	...
	String anonymous = "_".intern();

	String char2string(int c) {
		return "" + (char) c;
	}
	...
	Term Somethingwrong = new Funct("exception".intern(), new Int(666));
	...
	private Term next0() throws Exception {
		...
		case '(':
			T = new Funct("const".intern(), new Const("(".intern()));
			break;
		case ')':
			T = new Funct("const".intern(), new Const(")".intern()));
			break;
...
class StreamTokenizer {
	 ...
	 *
	 * @param flag {@code true} indicates that end-of-line characters are separate
