...
class pred_functor_3 extends Code {
	...
	static boolean DoFunctor3(PrologMachine mach, Term arg1, Term arg2, Term arg3) {
		arg1 = arg1.Deref();
		arg2 = arg2.Deref();
		arg3 = arg3.Deref();
		...
		if (arg1 instanceof Var) {
			...
			if (!(arg1.Unify(new Funct(Name, args))))
				return false;
		} else {
...
class pred_arg_3 extends Code {
	...
	static boolean DoArg3(PrologMachine mach, Term arg1, Term arg2, Term arg3) {
		arg1 = arg1.Deref();
		arg2 = arg2.Deref();
		arg3 = arg3.Deref();
		...
		if (i > l)
			return false;
		Term x = ((Funct) arg2).Arguments[i - 1];
		x = x.Deref();
		return (arg3.Unify(x));
	}
...
class pred_setarg_3 extends Code {
	...
	static boolean DoSetArg3(PrologMachine mach, Term arg1, Term arg2, Term arg3) {
		arg1 = arg1.Deref();
		arg2 = arg2.Deref();
		arg3 = arg3.Deref();
...
class pred_execcontinuation_0 extends Code {
	public static Code entry_code;

	int Arity() {
		return 0;
	}

	static java.util.function.Function<PrologMachine, Function> exec_pred_execcontinuation_0(PrologMachine mach) {
		Term arg1 = mach.Areg[0].Deref();

		if (!(arg1 instanceof Continuation))
			return UpperPrologMachine.Fail0;
		Continuation c = (Continuation) arg1;
		java.util.function.Function<PrologMachine, Function> code = c.code;
		int i = ((Code) code).Arity() + 1;
		while (i-- > 0) {
